...
return cljs.core.chunk_cons(cljs.core.chunk(b__27142),app$views$home_view_$_iter__27139(cljs.core.chunk_rest(s__27140__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27142),null);
}
} else {
var vec__27146 = cljs.core.first(s__27140__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.justify-between.text-xs.border-b.pb-1","div.flex.justify-between.text-xs.border-b.pb-1",1897000404),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.font-semibold.text-gray-600","span.font-semibold.text-gray-600",592107521),k], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-gray-800.font-medium","span.text-gray-800.font-medium",1892640972),v], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)),app$views$home_view_$_iter__27139(cljs.core.rest(s__27140__$2)));
}
} else {
return null;
}
...
var c__5647__auto__ = cljs.core.chunk_first(s__27152__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__27154 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__27153 = (0);
while(true){
if((i__27153 < size__5648__auto__)){
var i = cljs.core._nth(c__5647__auto__,i__27153);
cljs.core.chunk_append(b__27154,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__27153,i,c__5647__auto__,size__5648__auto__,b__27154,s__27152__$2,temp__5825__auto__,map__27150,map__27150__$1,values,set_values,handle_change){
return (function (e){
...
var G__27155 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),new_vec], null);
return (set_values.cljs$core$IFn$_invoke$arity$1 ? set_values.cljs$core$IFn$_invoke$arity$1(G__27155) : set_values.call(null,G__27155));
});})(i__27153,i,c__5647__auto__,size__5648__auto__,b__27154,s__27152__$2,temp__5825__auto__,map__27150,map__27150__$1,values,set_values,handle_change))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27154),app$views$stress_test_form_content_$_iter__27151(cljs.core.chunk_rest(s__27152__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27154),null);
}
} else {
var i = cljs.core.first(s__27152__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i,s__27152__$2,temp__5825__auto__,map__27150,map__27150__$1,values,set_values,handle_change){
return (function (e){
var v = parseFloat(e.target.value);
var new_vec = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778).cljs$core$IFn$_invoke$arity$1(values),i,v);
var G__27156 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),new_vec], null);
return (set_values.cljs$core$IFn$_invoke$arity$1 ? set_values.cljs$core$IFn$_invoke$arity$1(G__27156) : set_values.call(null,G__27156));
});})(i,s__27152__$2,temp__5825__auto__,map__27150,map__27150__$1,values,set_values,handle_change))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(""+"mos-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(i))], null)),app$views$stress_test_form_content_$_iter__27151(cljs.core.rest(s__27152__$2)));
}
} else {
return null;
}
...
})())], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.block.text-sm.font-semibold.text-gray-700","label.block.text-sm.font-semibold.text-gray-700",1892451717),"k Grid (start, stop, step)"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.gap-2.mt-1","div.flex.gap-2.mt-1",-1579391217),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5649__auto__ = (function app$views$stress_test_form_content_$_iter__27157(s__27158){
return (new cljs.core.LazySeq(null,(function (){
var s__27158__$1 = s__27158;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__27158__$1);
if(temp__5825__auto__){
var s__27158__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27158__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__27158__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__27160 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__27159 = (0);
while(true){
if((i__27159 < size__5648__auto__)){
var i = cljs.core._nth(c__5647__auto__,i__27159);
cljs.core.chunk_append(b__27160,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__27159,i,c__5647__auto__,size__5648__auto__,b__27160,s__27158__$2,temp__5825__auto__,map__27150,map__27150__$1,values,set_values,handle_change){
return (function (e){
var v = parseFloat(e.target.value);
...
var G__27161 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),new_vec], null);
return (set_values.cljs$core$IFn$_invoke$arity$1 ? set_values.cljs$core$IFn$_invoke$arity$1(G__27161) : set_values.call(null,G__27161));
});})(i__27159,i,c__5647__auto__,size__5648__auto__,b__27160,s__27158__$2,temp__5825__auto__,map__27150,map__27150__$1,values,set_values,handle_change))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27160),app$views$stress_test_form_content_$_iter__27157(cljs.core.chunk_rest(s__27158__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27160),null);
}
} else {
var i = cljs.core.first(s__27158__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i,s__27158__$2,temp__5825__auto__,map__27150,map__27150__$1,values,set_values,handle_change){
return (function (e){
var v = parseFloat(e.target.value);
var new_vec = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"k-grid","k-grid",-887124116).cljs$core$IFn$_invoke$arity$1(values),i,v);
var G__27163 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),new_vec], null);
...
});})(i,s__27158__$2,temp__5825__auto__,map__27150,map__27150__$1,values,set_values,handle_change))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(""+"k-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(i))], null)),app$views$stress_test_form_content_$_iter__27157(cljs.core.rest(s__27158__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fork.reagent.form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"initial-values","initial-values",1392120293),config,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p__27164){
var map__27165 = p__27164;
var map__27165__$1 = cljs.core.__destructure_map(map__27165);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27165__$1,new cljs.core.Keyword(null,"values","values",372645556));
...
var map__27166 = cljs.core.deref(sort_state);
var map__27166__$1 = cljs.core.__destructure_map(map__27166);
var curr_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27166__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var desc_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27166__$1,new cljs.core.Keyword(null,"desc?","desc?",-713120712));
...
var map__27168 = cljs.core.deref(sort_state);
var map__27168__$1 = cljs.core.__destructure_map(map__27168);
var curr_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27168__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var desc_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27168__$1,new cljs.core.Keyword(null,"desc?","desc?",-713120712));
