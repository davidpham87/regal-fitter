...
return cljs.core.chunk_cons(cljs.core.chunk(b__26713),app$views$home_view_$_iter__26710(cljs.core.chunk_rest(s__26711__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26713),null);
}
} else {
var vec__26717 = cljs.core.first(s__26711__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.justify-between.text-xs.border-b.pb-1","div.flex.justify-between.text-xs.border-b.pb-1",1897000404),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.font-semibold.text-gray-600","span.font-semibold.text-gray-600",592107521),k], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-gray-800.font-medium","span.text-gray-800.font-medium",1892640972),v], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)),app$views$home_view_$_iter__26710(cljs.core.rest(s__26711__$2)));
}
} else {
return null;
}
...
app.views.stress_test_form_content = (function app$views$stress_test_form_content(p__26720){
var map__26721 = p__26720;
var map__26721__$1 = cljs.core.__destructure_map(map__26721);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26721__$1,new cljs.core.Keyword(null,"values","values",372645556));
var set_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26721__$1,new cljs.core.Keyword(null,"set-values","set-values",-928640446));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26721__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.bg-white.p-6.rounded-xl.shadow-sm.border.mb-6","div.bg-white.p-6.rounded-xl.shadow-sm.border.mb-6",-596519574),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2.text-xl.font-bold.mb-4","h2.text-xl.font-bold.mb-4",-988997653),"Configuration"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.grid.grid-cols-1.md:grid-cols-3.gap-4","div.grid.grid-cols-1.md:grid-cols-3.gap-4",888147611),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.block.text-sm.font-semibold.text-gray-700","label.block.text-sm.font-semibold.text-gray-700",1892451717),"mOS Grid (start, stop, step)"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.gap-2.mt-1","div.flex.gap-2.mt-1",-1579391217),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5503__auto__ = (function app$views$stress_test_form_content_$_iter__26722(s__26723){
return (new cljs.core.LazySeq(null,(function (){
var s__26723__$1 = s__26723;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__26723__$1);
if(temp__5825__auto__){
var s__26723__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26723__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__26723__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__26725 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__26724 = (0);
while(true){
if((i__26724 < size__5502__auto__)){
var i = cljs.core._nth(c__5501__auto__,i__26724);
cljs.core.chunk_append(b__26725,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__26724,i,c__5501__auto__,size__5502__auto__,b__26725,s__26723__$2,temp__5825__auto__,map__26721,map__26721__$1,values,set_values,handle_change){
return (function (e){
...
var G__26727 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),new_vec], null);
return (set_values.cljs$core$IFn$_invoke$arity$1 ? set_values.cljs$core$IFn$_invoke$arity$1(G__26727) : set_values.call(null,G__26727));
});})(i__26724,i,c__5501__auto__,size__5502__auto__,b__26725,s__26723__$2,temp__5825__auto__,map__26721,map__26721__$1,values,set_values,handle_change))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26725),app$views$stress_test_form_content_$_iter__26722(cljs.core.chunk_rest(s__26723__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26725),null);
}
} else {
var i = cljs.core.first(s__26723__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i,s__26723__$2,temp__5825__auto__,map__26721,map__26721__$1,values,set_values,handle_change){
return (function (e){
var v = parseFloat(e.target.value);
var new_vec = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778).cljs$core$IFn$_invoke$arity$1(values),i,v);
var G__26728 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),new_vec], null);
return (set_values.cljs$core$IFn$_invoke$arity$1 ? set_values.cljs$core$IFn$_invoke$arity$1(G__26728) : set_values.call(null,G__26728));
});})(i,s__26723__$2,temp__5825__auto__,map__26721,map__26721__$1,values,set_values,handle_change))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["mos-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)),app$views$stress_test_form_content_$_iter__26722(cljs.core.rest(s__26723__$2)));
}
} else {
return null;
}
...
var i = cljs.core._nth(c__5501__auto__,i__26731);
cljs.core.chunk_append(b__26732,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__26731,i,c__5501__auto__,size__5502__auto__,b__26732,s__26730__$2,temp__5825__auto__,map__26721,map__26721__$1,values,set_values,handle_change){
return (function (e){
var v = parseFloat(e.target.value);
...
var G__26733 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),new_vec], null);
return (set_values.cljs$core$IFn$_invoke$arity$1 ? set_values.cljs$core$IFn$_invoke$arity$1(G__26733) : set_values.call(null,G__26733));
});})(i__26731,i,c__5501__auto__,size__5502__auto__,b__26732,s__26730__$2,temp__5825__auto__,map__26721,map__26721__$1,values,set_values,handle_change))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26732),app$views$stress_test_form_content_$_iter__26729(cljs.core.chunk_rest(s__26730__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26732),null);
}
} else {
var i = cljs.core.first(s__26730__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i,s__26730__$2,temp__5825__auto__,map__26721,map__26721__$1,values,set_values,handle_change){
return (function (e){
var v = parseFloat(e.target.value);
var new_vec = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"k-grid","k-grid",-887124116).cljs$core$IFn$_invoke$arity$1(values),i,v);
var G__26735 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),new_vec], null);
return (set_values.cljs$core$IFn$_invoke$arity$1 ? set_values.cljs$core$IFn$_invoke$arity$1(G__26735) : set_values.call(null,G__26735));
});})(i,s__26730__$2,temp__5825__auto__,map__26721,map__26721__$1,values,set_values,handle_change))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["k-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)),app$views$stress_test_form_content_$_iter__26729(cljs.core.rest(s__26730__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fork.reagent.form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"initial-values","initial-values",1392120293),config,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p__26736){
var map__26737 = p__26736;
var map__26737__$1 = cljs.core.__destructure_map(map__26737);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26737__$1,new cljs.core.Keyword(null,"values","values",372645556));
...
var map__26739 = cljs.core.deref(sort_state);
var map__26739__$1 = cljs.core.__destructure_map(map__26739);
var curr_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26739__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var desc_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26739__$1,new cljs.core.Keyword(null,"desc?","desc?",-713120712));
...
var map__26741 = cljs.core.deref(sort_state);
var map__26741__$1 = cljs.core.__destructure_map(map__26741);
var curr_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26741__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var desc_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26741__$1,new cljs.core.Keyword(null,"desc?","desc?",-713120712));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26745),app$views$stress_test_results_view_$_iter__26742(cljs.core.chunk_rest(s__26743__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26745),null);
}
} else {
var r = cljs.core.first(s__26743__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.px-4.py-2","td.px-4.py-2",733994900),new cljs.core.Keyword(null,"mos","mos",1902052264).cljs$core$IFn$_invoke$arity$1(r)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.px-4.py-2","td.px-4.py-2",733994900),new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(r)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.px-4.py-2","td.px-4.py-2",733994900),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(((100) * new cljs.core.Keyword(null,"p_joint","p_joint",1098754735).cljs$core$IFn$_invoke$arity$1(r)).toFixed((2))),"%"].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.px-4.py-2","td.px-4.py-2",733994900),new cljs.core.Keyword(null,"expected_ev_ia","expected_ev_ia",-70245782).cljs$core$IFn$_invoke$arity$1(r).toFixed((1))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.px-4.py-2","td.px-4.py-2",733994900),new cljs.core.Keyword(null,"expected_inc_upd","expected_inc_upd",111886599).cljs$core$IFn$_invoke$arity$1(r).toFixed((1))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.px-4.py-2","td.px-4.py-2",733994900),new cljs.core.Keyword(null,"expected_inc_pr3","expected_inc_pr3",1043830871).cljs$core$IFn$_invoke$arity$1(r).toFixed((1))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.px-4.py-2","td.px-4.py-2",733994900),new cljs.core.Keyword(null,"residual","residual",2138156039).cljs$core$IFn$_invoke$arity$1(r).toFixed((2))], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"mos","mos",1902052264).cljs$core$IFn$_invoke$arity$1(r)),"-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(r))].join('')], null)),app$views$stress_test_results_view_$_iter__26742(cljs.core.rest(s__26743__$2)));
}
} else {
return null;
}
