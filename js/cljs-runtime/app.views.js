...
var c__5501__auto__ = cljs.core.chunk_first(s__27274__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__27276 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__27275 = (0);
while(true){
if((i__27275 < size__5502__auto__)){
var vec__27277 = cljs.core._nth(c__5501__auto__,i__27275);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27276),app$views$home_view_$_iter__27273(cljs.core.chunk_rest(s__27274__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27276),null);
}
} else {
var vec__27280 = cljs.core.first(s__27274__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27280,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27280,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.justify-between.text-xs.border-b.pb-1","div.flex.justify-between.text-xs.border-b.pb-1",1897000404),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.font-semibold.text-gray-600","span.font-semibold.text-gray-600",592107521),k], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.text-gray-800.font-medium","span.text-gray-800.font-medium",1892640972),v], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),k], null)),app$views$home_view_$_iter__27273(cljs.core.rest(s__27274__$2)));
}
} else {
return null;
}
...
app.views.stress_test_form_content = (function app$views$stress_test_form_content(p__27283){
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.bg-white.p-6.rounded-xl.shadow-sm.border.mb-6","div.bg-white.p-6.rounded-xl.shadow-sm.border.mb-6",-596519574),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2.text-xl.font-bold.mb-4","h2.text-xl.font-bold.mb-4",-988997653),"Configuration"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.grid.grid-cols-1.md:grid-cols-3.gap-4","div.grid.grid-cols-1.md:grid-cols-3.gap-4",888147611),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.block.text-sm.font-semibold.text-gray-700","label.block.text-sm.font-semibold.text-gray-700",1892451717),"mOS Grid (start, stop, step)"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.gap-2.mt-1","div.flex.gap-2.mt-1",-1579391217),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5503__auto__ = (function app$views$stress_test_form_content_$_iter__27285(s__27286){
return (new cljs.core.LazySeq(null,(function (){
var s__27286__$1 = s__27286;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__27286__$1);
if(temp__5825__auto__){
var s__27286__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27286__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__27286__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__27288 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__27287 = (0);
while(true){
if((i__27287 < size__5502__auto__)){
var i = cljs.core._nth(c__5501__auto__,i__27287);
cljs.core.chunk_append(b__27288,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"name","name",1843675177),["mos-grid.",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),handle_change], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["mos-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)));

var G__27306 = (i__27287 + (1));
i__27287 = G__27306;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27288),app$views$stress_test_form_content_$_iter__27285(cljs.core.chunk_rest(s__27286__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27288),null);
}
} else {
var i = cljs.core.first(s__27286__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"name","name",1843675177),["mos-grid.",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),handle_change], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["mos-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)),app$views$stress_test_form_content_$_iter__27285(cljs.core.rest(s__27286__$2)));
}
} else {
return null;
}
...
})())], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.block.text-sm.font-semibold.text-gray-700","label.block.text-sm.font-semibold.text-gray-700",1892451717),"k Grid (start, stop, step)"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.gap-2.mt-1","div.flex.gap-2.mt-1",-1579391217),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5503__auto__ = (function app$views$stress_test_form_content_$_iter__27289(s__27290){
return (new cljs.core.LazySeq(null,(function (){
var s__27290__$1 = s__27290;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__27290__$1);
if(temp__5825__auto__){
var s__27290__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27290__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__27290__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__27292 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__27291 = (0);
while(true){
if((i__27291 < size__5502__auto__)){
var i = cljs.core._nth(c__5501__auto__,i__27291);
cljs.core.chunk_append(b__27292,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"name","name",1843675177),["k-grid.",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),handle_change], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["k-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)));

var G__27307 = (i__27291 + (1));
i__27291 = G__27307;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27292),app$views$stress_test_form_content_$_iter__27289(cljs.core.chunk_rest(s__27290__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27292),null);
}
} else {
var i = cljs.core.first(s__27290__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"name","name",1843675177),["k-grid.",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join(''),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),handle_change], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["k-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i)].join('')], null)),app$views$stress_test_form_content_$_iter__27289(cljs.core.rest(s__27290__$2)));
}
} else {
return null;
}
...
return iter__5503__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1((3)));
})())], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.block.text-sm.font-semibold.text-gray-700","label.block.text-sm.font-semibold.text-gray-700",1892451717),"Sims per Combo"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm.mt-1","input.border.w-full.p-1.rounded.text-sm.mt-1",617914370),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"name","name",1843675177),"n-sims",new cljs.core.Keyword(null,"value","value",305978217),(values.cljs$core$IFn$_invoke$arity$1 ? values.cljs$core$IFn$_invoke$arity$1("n-sims") : values.call(null,"n-sims")),new cljs.core.Keyword(null,"on-change","on-change",-732046149),handle_change], null)], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.mt-4.flex.justify-center","div.mt-4.flex.justify-center",-1290712670),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.bg-blue-600.hover:bg-blue-700.text-white","button.bg-blue-600.hover:bg-blue-700.text-white",1989157766),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"font-bold px-6 py-2 rounded-lg shadow",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fork.reagent.form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"initial-values","initial-values",1392120293),config,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p__27294){
var map__27295 = p__27294;
var map__27295__$1 = cljs.core.__destructure_map(map__27295);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27295__$1,new cljs.core.Keyword(null,"values","values",372645556));
...
var map__27296 = cljs.core.deref(sort_state);
var map__27296__$1 = cljs.core.__destructure_map(map__27296);
var curr_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27296__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var desc_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27296__$1,new cljs.core.Keyword(null,"desc?","desc?",-713120712));
...
var map__27300 = cljs.core.deref(sort_state);
var map__27300__$1 = cljs.core.__destructure_map(map__27300);
var curr_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27300__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var desc_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27300__$1,new cljs.core.Keyword(null,"desc?","desc?",-713120712));
