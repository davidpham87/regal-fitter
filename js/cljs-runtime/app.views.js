...
app.views.stress_test_form_content = (function app$views$stress_test_form_content(p__27150){
var map__27151 = p__27150;
var map__27151__$1 = cljs.core.__destructure_map(map__27151);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27151__$1,new cljs.core.Keyword(null,"values","values",372645556));
var set_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27151__$1,new cljs.core.Keyword(null,"set-values","set-values",-928640446));
var handle_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27151__$1,new cljs.core.Keyword(null,"handle-change","handle-change",741134083));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.bg-white.p-6.rounded-xl.shadow-sm.border.mb-6","div.bg-white.p-6.rounded-xl.shadow-sm.border.mb-6",-596519574),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2.text-xl.font-bold.mb-4","h2.text-xl.font-bold.mb-4",-988997653),"Configuration"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.grid.grid-cols-1.md:grid-cols-3.gap-4","div.grid.grid-cols-1.md:grid-cols-3.gap-4",888147611),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label.block.text-sm.font-semibold.text-gray-700","label.block.text-sm.font-semibold.text-gray-700",1892451717),"mOS Grid (start, stop, step)"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.flex.gap-2.mt-1","div.flex.gap-2.mt-1",-1579391217),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5649__auto__ = (function app$views$stress_test_form_content_$_iter__27152(s__27153){
return (new cljs.core.LazySeq(null,(function (){
var s__27153__$1 = s__27153;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__27153__$1);
if(temp__5825__auto__){
var s__27153__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27153__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__27153__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__27155 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__27154 = (0);
while(true){
if((i__27154 < size__5648__auto__)){
var i = cljs.core._nth(c__5647__auto__,i__27154);
cljs.core.chunk_append(b__27155,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__27154,i,c__5647__auto__,size__5648__auto__,b__27155,s__27153__$2,temp__5825__auto__,map__27151,map__27151__$1,values,set_values,handle_change){
return (function (e){
...
});})(i__27154,i,c__5647__auto__,size__5648__auto__,b__27155,s__27153__$2,temp__5825__auto__,map__27151,map__27151__$1,values,set_values,handle_change))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27155),app$views$stress_test_form_content_$_iter__27152(cljs.core.chunk_rest(s__27153__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27155),null);
}
} else {
var i = cljs.core.first(s__27153__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i,s__27153__$2,temp__5825__auto__,map__27151,map__27151__$1,values,set_values,handle_change){
return (function (e){
var v = parseFloat(e.target.value);
var new_vec = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778).cljs$core$IFn$_invoke$arity$1(values),i,v);
var G__27157 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"mos-grid","mos-grid",-116177778),new_vec], null);
return (set_values.cljs$core$IFn$_invoke$arity$1 ? set_values.cljs$core$IFn$_invoke$arity$1(G__27157) : set_values.call(null,G__27157));
});})(i,s__27153__$2,temp__5825__auto__,map__27151,map__27151__$1,values,set_values,handle_change))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(""+"mos-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(i))], null)),app$views$stress_test_form_content_$_iter__27152(cljs.core.rest(s__27153__$2)));
}
} else {
return null;
}
...
while(true){
var temp__5825__auto__ = cljs.core.seq(s__27159__$1);
if(temp__5825__auto__){
var s__27159__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27159__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__27159__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__27161 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__27160 = (0);
while(true){
if((i__27160 < size__5648__auto__)){
var i = cljs.core._nth(c__5647__auto__,i__27160);
cljs.core.chunk_append(b__27161,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__27160,i,c__5647__auto__,size__5648__auto__,b__27161,s__27159__$2,temp__5825__auto__,map__27151,map__27151__$1,values,set_values,handle_change){
return (function (e){
var v = parseFloat(e.target.value);
...
var G__27162 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),new_vec], null);
return (set_values.cljs$core$IFn$_invoke$arity$1 ? set_values.cljs$core$IFn$_invoke$arity$1(G__27162) : set_values.call(null,G__27162));
});})(i__27160,i,c__5647__auto__,size__5648__auto__,b__27161,s__27159__$2,temp__5825__auto__,map__27151,map__27151__$1,values,set_values,handle_change))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27161),app$views$stress_test_form_content_$_iter__27158(cljs.core.chunk_rest(s__27159__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27161),null);
}
} else {
var i = cljs.core.first(s__27159__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.border.w-full.p-1.rounded.text-sm","input.border.w-full.p-1.rounded.text-sm",-431979953),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"number",new cljs.core.Keyword(null,"step","step",1288888124),"0.1",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(values,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),i], null)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i,s__27159__$2,temp__5825__auto__,map__27151,map__27151__$1,values,set_values,handle_change){
return (function (e){
var v = parseFloat(e.target.value);
var new_vec = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"k-grid","k-grid",-887124116).cljs$core$IFn$_invoke$arity$1(values),i,v);
var G__27164 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"k-grid","k-grid",-887124116),new_vec], null);
...
});})(i,s__27159__$2,temp__5825__auto__,map__27151,map__27151__$1,values,set_values,handle_change))
], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),(""+"k-"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(i))], null)),app$views$stress_test_form_content_$_iter__27158(cljs.core.rest(s__27159__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fork.reagent.form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"initial-values","initial-values",1392120293),config,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p__27165){
var map__27166 = p__27165;
var map__27166__$1 = cljs.core.__destructure_map(map__27166);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27166__$1,new cljs.core.Keyword(null,"values","values",372645556));
...
var map__27170 = cljs.core.deref(sort_state);
var map__27170__$1 = cljs.core.__destructure_map(map__27170);
var curr_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27170__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var desc_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27170__$1,new cljs.core.Keyword(null,"desc?","desc?",-713120712));
