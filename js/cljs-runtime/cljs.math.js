...
var vec__27664 = cljs.math.setup_hl(ix,hx__$1,lx);
var hx__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27664,(0),null);
var lx__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27664,(1),null);
var vec__27667 = cljs.math.setup_hl(iy,hy__$1,ly);
var hy__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27667,(0),null);
var ly__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27667,(1),null);
var vec__27670 = (function (){var n = (ix - iy);
var hx__$3 = hx__$2;
var lx__$2 = lx__$1;
while(true){
if((n === (0))){
...
var vec__27685 = (((hz < (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((hx__$3 + hx__$3) + (lx__$2 >>> (31))),(lx__$2 + lx__$2)], null):((((hz | lz) === (0)))?(function (){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Signed zero",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"zero","zero",-858964576),true], null))})():new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((hz + hz) + (lz >>> (31))),(lz + lz)], null)));
var hx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27685,(0),null);
var lx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27685,(1),null);
var G__27848 = (n - (1));
var G__27849 = ((4294967295) & hx__$4);
var G__27850 = ((4294967295) & lx__$3);
n = G__27848;
hx__$3 = G__27849;
lx__$2 = G__27850;
continue;
...
var hx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27670,(0),null);
var lx__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27670,(1),null);
var hz = ((cljs.math.u_LT_(lx__$2,ly__$1))?((hx__$3 - hy__$2) - (1)):(hx__$3 - hy__$2));
var lz = (lx__$2 - ly__$1);
var vec__27673 = (((hz >= (0)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hz,lz], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hx__$3,lx__$2], null));
var hx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27673,(0),null);
var lx__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27673,(1),null);
...
var vec__27676 = (function (){var hx__$5 = hx__$4;
var lx__$4 = lx__$3;
var iy__$1 = iy;
while(true){
if((!((hx__$5 < (1048576))))){
...
var G__27854 = ((hx__$5 + hx__$5) + (lx__$4 >>> (31)));
var G__27855 = (lx__$4 + lx__$4);
var G__27856 = (iy__$1 - (1));
hx__$5 = G__27854;
lx__$4 = G__27855;
iy__$1 = G__27856;
continue;
...
var hx__$5 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27676,(0),null);
var lx__$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27676,(1),null);
var iy__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27676,(2),null);
if((iy__$1 >= (-1022))){
...
var n = ((-1022) - iy__$1);
var vec__27693 = (((n <= (20)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(hx__$5 >> n),((lx__$4 >>> n) | (hx__$5 << ((32) - n)))], null):(((n <= (31)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sx,((hx__$5 << ((32) - n)) | (lx__$4 >>> n))], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [sx,(hx__$5 >> (n - (32)))], null)
));
var hx__$6 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27693,(0),null);
var lx__$5 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27693,(1),null);
(i[cljs.math.HI_x] = (hx__$6 | sx));
...
var vec__27782 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(4294967295),(4294967295)):cljs.math.add64(ht,lt,(0),(1)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27782,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27782,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__27785 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(0),(1)):cljs.math.add64(ht,lt,(4294967295),(4294967295)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27785,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27785,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__27790 = ((((ht & (2147483648)) === (0)))?cljs.math.add64(ht,lt,(0),(1)):cljs.math.add64(ht,lt,(4294967295),(4294967295)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27790,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27790,(1),null);
(i[cljs.math.HI] = hr);
...
var ht = (i[cljs.math.HI]);
var lt = (i[cljs.math.LO]);
var vec__27798 = (((d > (0)))?cljs.math.add64(ht,lt,(4294967295),(4294967295)):cljs.math.add64(ht,lt,(0),(1)));
var hr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27798,(0),null);
var lr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27798,(1),null);
(i[cljs.math.HI] = hr);
...
var vec__27806 = (((scaleFactor < (0)))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [Math.max(scaleFactor,(- cljs.math.MAX_SCALE)),(-512),cljs.math.two_to_the_double_scale_down], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [Math.min(scaleFactor,cljs.math.MAX_SCALE),(512),cljs.math.two_to_the_double_scale_up], null));
var scale_factor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27806,(0),null);
var scale_increment = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27806,(1),null);
var exp_delta = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27806,(2),null);
...
var G__27881 = (d__$1 * exp_delta);
var G__27882 = (scale_factor__$1 - scale_increment);
d__$1 = G__27881;
scale_factor__$1 = G__27882;
continue;
}
break;
}
