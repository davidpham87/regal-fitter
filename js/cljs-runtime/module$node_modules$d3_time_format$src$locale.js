shadow$provide.module$node_modules$d3_time_format$src$locale = function(require, module, exports) {
      ...
      return function(string) {
        ...
        if ("V" in d) {
          ...
          if ("Z" in d) {
            ...
            string = day > 4 || day === 0 ? require$d3_time.utcMonday.ceil(string) : (0,require$d3_time.utcMonday)(string);
            string = require$d3_time.utcDay.offset(string, (d.V - 1) * 7);
            d.y = string.getUTCFullYear();
            d.m = string.getUTCMonth();
            d.d = string.getUTCDate() + (d.w + 6) % 7;
          } else {
            string = localDate(newDate(d.y, 0, 1)), day = string.getDay(), string = day > 4 || day === 0 ? require$d3_time.timeMonday.ceil(string) : (0,require$d3_time.timeMonday)(string), string = require$d3_time.timeDay.offset(string, (d.V - 1) * 7), d.y = string.getFullYear(), d.m = string.getMonth(), d.d = string.getDate() + (d.w + 6) % 7;
          }
  ...
  function dISO(d) {
    var day = d.getDay();
    return day >= 4 || day === 0 ? (0,require$d3_time.timeThursday)(d) : require$d3_time.timeThursday.ceil(d);
  }
  function formatWeekNumberISO(d, p) {
    d = dISO(d);
    return pad(require$d3_time.timeThursday.count((0,require$d3_time.timeYear)(d), d) + ((0,require$d3_time.timeYear)(d).getDay() === 4), p, 2);
  }
  ...
  function formatFullYearISO(d, p) {
    var day = d.getDay();
    d = day >= 4 || day === 0 ? (0,require$d3_time.timeThursday)(d) : require$d3_time.timeThursday.ceil(d);
    return pad(d.getFullYear() % 10000, p, 4);
  }
  ...
  function UTCdISO(d) {
    var day = d.getUTCDay();
    return day >= 4 || day === 0 ? (0,require$d3_time.utcThursday)(d) : require$d3_time.utcThursday.ceil(d);
  }
  function formatUTCWeekNumberISO(d, p) {
    d = UTCdISO(d);
    return pad(require$d3_time.utcThursday.count((0,require$d3_time.utcYear)(d), d) + ((0,require$d3_time.utcYear)(d).getUTCDay() === 4), p, 2);
  }
  ...
  function formatUTCFullYearISO(d, p) {
    var day = d.getUTCDay();
    d = day >= 4 || day === 0 ? (0,require$d3_time.utcThursday)(d) : require$d3_time.utcThursday.ceil(d);
    return pad(d.getUTCFullYear() % 10000, p, 4);
  }
