...
})], null),"Light"], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fork.reagent.form,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"initial-values","initial-values",1392120293),initial_config,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p__27384){
var map__27385 = p__27384;
var map__27385__$1 = cljs.core.__destructure_map(map__27385);
var values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27385__$1,new cljs.core.Keyword(null,"values","values",372645556));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__5649__auto__ = (function app$ui$config__GT_nested_$_iter__27386(s__27387){
return (new cljs.core.LazySeq(null,(function (){
var s__27387__$1 = s__27387;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__27387__$1);
if(temp__5825__auto__){
var s__27387__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27387__$2)){
var c__5647__auto__ = cljs.core.chunk_first(s__27387__$2);
var size__5648__auto__ = cljs.core.count(c__5647__auto__);
var b__27389 = cljs.core.chunk_buffer(size__5648__auto__);
if((function (){var i__27388 = (0);
while(true){
if((i__27388 < size__5648__auto__)){
var vec__27390 = cljs.core._nth(c__5647__auto__,i__27388);
var cat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27390,(0),null);
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27390,(1),null);
cljs.core.chunk_append(b__27389,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cat,cljs.core.select_keys(config,ks)], null));

var G__27413 = (i__27388 + (1));
i__27388 = G__27413;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27389),app$ui$config__GT_nested_$_iter__27386(cljs.core.chunk_rest(s__27387__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27389),null);
}
} else {
var vec__27393 = cljs.core.first(s__27387__$2);
var cat = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27393,(0),null);
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27393,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cat,cljs.core.select_keys(config,ks)], null),app$ui$config__GT_nested_$_iter__27386(cljs.core.rest(s__27387__$2)));
}
} else {
return null;
}
...
try{var nested_27414 = cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(JSON.parse(cljs.core.deref(text_val)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
app.state.update_config_BANG_(app.ui.nested__GT_config(nested_27414));
...
});})(i__27402,vec__27404,page,label,c__5647__auto__,size__5648__auto__,b__27403,s__27401__$2,temp__5825__auto__))
], null),label], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),page], null)));

var G__27416 = (i__27402 + (1));
i__27402 = G__27416;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27403),app$ui$navigation_bar_$_iter__27400(cljs.core.chunk_rest(s__27401__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27403),null);
}
} else {
var vec__27407 = cljs.core.first(s__27401__$2);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27407,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27407,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.px-3.py-2.rounded-lg.text-sm.font-medium.transition-colors","button.px-3.py-2.rounded-lg.text-sm.font-medium.transition-colors",-696574251),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_page,page))?"bg-gray-950 text-white":"text-gray-300 hover:bg-gray-700 hover:text-white"),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__27407,page,label,s__27401__$2,temp__5825__auto__){
return (function (){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null));
});})(vec__27407,page,label,s__27401__$2,temp__5825__auto__))
], null),label], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),page], null)),app$ui$navigation_bar_$_iter__27400(cljs.core.rest(s__27401__$2)));
}
} else {
return null;
}
...
break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27410__$1))));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.min-h-screen.bg-gray-50","div.min-h-screen.bg-gray-50",1856382833),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.ui.navigation_bar,active_page], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.container.mx-auto.p-4","div.container.mx-auto.p-4",-1505263632),(function (){var G__27411 = active_page;
