shadow$provide.module$node_modules$vega_lite$build$index = function(require, module, exports) {
  ...
  function pick(obj, props) {
    ...
    for (const prop of props) {
      (0,require$vega_util.hasOwnProperty)(obj, prop) && (copy[prop] = obj[prop]);
    }
    return copy;
  }
  ...
  function hash(a) {
    if ((0,require$vega_util.isNumber)(a)) {
      return a;
    }
    a = (0,require$vega_util.isString)(a) ? a : stringify(a);
    if (a.length < 250) {
      return a;
    }
    let h = 0;
  ...
  function mergeDeep(dest, ...src$jscomp$0) {
    for (const s of src$jscomp$0) {
      src$jscomp$0 = dest;
      var src = s ?? {};
      for (const property of keys(src)) {
        (0,require$vega_util.writeConfig)(src$jscomp$0, property, src[property], !0);
      }
    }
    return dest;
  }
  ...
  function prefixGenerator(a) {
    ...
    for (const x of a) {
      const wrappedWithAccessors = (0,require$vega_util.splitAccessPath)(x).map((y, i) => i === 0 ? y : `[${y}]`);
  ...
  function isPrimitive(v) {
    return (0,require$vega_util.isString)(v) || (0,require$vega_util.isNumber)(v) || isBoolean(v);
  }
  function varName(s) {
  ...
  function accessPathWithDatum(path, datum = "datum") {
    path = (0,require$vega_util.splitAccessPath)(path);
    const prefixes = [];
    for (let i = 1; i <= path.length; i++) {
      const prefix = `[${path.slice(0, i).map(require$vega_util.stringValue).join("][")}]`;
      prefixes.push(`${datum}${prefix}`);
    }
    return prefixes.join(" \x26\x26 ");
  }
  function flatAccessWithDatum(path, datum = "datum") {
    return `${datum}[${(0,require$vega_util.stringValue)((0,require$vega_util.splitAccessPath)(path).join("."))}]`;
  }
  ...
  function replacePathInField(path) {
    return `${(0,require$vega_util.splitAccessPath)(path).map(escapePathAccess).join("\\.")}`;
  }
  function replaceAll(string, find, replacement) {
    return string.replace(new RegExp(find.replace(/[-/\\^$*+?.()|[\]{}]/g, "\\$\x26"), "g"), replacement);
  }
  function removePathFromField(path) {
    return `${(0,require$vega_util.splitAccessPath)(path).join(".")}`;
  }
  function accessPathDepth(path) {
    return path ? (0,require$vega_util.splitAccessPath)(path).length : 0;
  }
  ...
  function isNumeric(value) {
    return (0,require$vega_util.isNumber)(value) ? !0 : !isNaN(value) && !isNaN(parseFloat(value));
  }
  ...
  function stringify(data) {
    ...
    return function _stringify(node) {
      node?.toJSON && typeof node.toJSON === "function" && (node = node.toJSON());
      if (node !== void 0) {
  ...
  function hasProperty(obj, key) {
    return (0,require$vega_util.isObject)(obj) && (0,require$vega_util.hasOwnProperty)(obj, key) && obj[key] !== void 0;
  }
  ...
  function getVgPositionChannel(channel) {
    if ((0,require$vega_util.hasOwnProperty)(POLAR_POSITION_CHANNEL_INDEX, channel)) {
      switch(channel) {
        case "theta":
          return "startAngle";
        case "theta2":
  ...
  function isXorY(channel) {
    return (0,require$vega_util.hasOwnProperty)(POSITION_SCALE_CHANNEL_INDEX, channel);
  }
  function getPositionScaleChannel(sizeType) {
    return sizeType === "width" ? "x" : "y";
  }
  function isXorYOffset(channel) {
    return (0,require$vega_util.hasOwnProperty)(OFFSET_SCALE_CHANNEL_INDEX, channel);
  }
  function isScaleChannel(channel) {
    return (0,require$vega_util.hasOwnProperty)(SCALE_CHANNEL_INDEX, channel);
  }
  ...
  function isAggregateOp(a) {
    return (0,require$vega_util.isString)(a) && (0,require$vega_util.hasOwnProperty)(AGGREGATE_OP_INDEX, a);
  }
  function isCountingAggregateOp(aggregate) {
    return (0,require$vega_util.isString)(aggregate) && COUNTING_OPS.has(aggregate);
  }
  function binToString(bin) {
    (0,require$vega_util.isBoolean)(bin) && (bin = normalizeBin(bin, void 0));
  ...
  function isBinning(bin) {
    return bin === !0 || isBinParams(bin) && !bin.binned;
  }
  function isBinned(bin) {
    return bin === "binned" || isBinParams(bin) && bin.binned === !0;
  }
  function isBinParams(bin) {
    return (0,require$vega_util.isObject)(bin);
  }
  ...
  function extractTitleConfig(titleConfig) {
    const {anchor, frame, offset, orient, angle, limit, color, subtitleColor, subtitleFont, subtitleFontSize, subtitleFontStyle, subtitleFontWeight, subtitleLineHeight, subtitlePadding, ...rest} = titleConfig, titleMarkConfig = {...rest, ...(color ? {fill:color} : {})}, nonMarkTitleProperties = {...(anchor ? {anchor} : {}), ...(frame ? {frame} : {}), ...(offset ? {offset} : {}), ...(orient ? {orient} : {}), ...(angle !== void 0 ? {angle} : {}), ...(limit !== void 0 ? {limit} : {})}, subtitle = {...(subtitleColor ? 
    {subtitleColor} : {}), ...(subtitleFont ? {subtitleFont} : {}), ...(subtitleFontSize ? {subtitleFontSize} : {}), ...(subtitleFontStyle ? {subtitleFontStyle} : {}), ...(subtitleFontWeight ? {subtitleFontWeight} : {}), ...(subtitleLineHeight ? {subtitleLineHeight} : {}), ...(subtitlePadding ? {subtitlePadding} : {})};
  ...
  function isText(v) {
    return (0,require$vega_util.isString)(v) || (0,require$vega_util.isArray)(v) && (0,require$vega_util.isString)(v[0]);
  }
  ...
  function isDataRefUnionedDomain(domain) {
    return (0,require$vega_util.isArray)(domain) ? !1 : hasProperty(domain, "fields") && !hasProperty(domain, "data");
  }
  function isDataRefDomain(domain) {
    return (0,require$vega_util.isArray)(domain) ? !1 : hasProperty(domain, "field") && hasProperty(domain, "data");
  }
  function signalOrValueRefWithCondition(val) {
    const condition = (0,require$vega_util.isArray)(val.condition) ? val.condition.map(conditionalSignalRefOrValue) : conditionalSignalRefOrValue(val.condition);
  ...
  function signalOrStringValue(v) {
    return isSignalRef(v) ? v.signal : v == null ? null : (0,require$vega_util.stringValue)(v);
  }
  ...
  function getStyleConfig(p, styles, styleConfigIndex) {
    styles = (0,require$vega_util.array)(styles);
    let value;
  ...
  function sortParams(orderDef, fieldRefOption) {
    return (0,require$vega_util.array)(orderDef).reduce((s, orderChannelDef) => {
  ...
  function mergeTitle(title1, title2) {
    return deepEqual(title1, title2) || !title2 ? title1 : title1 ? [...(0,require$vega_util.array)(title1), ...(0,require$vega_util.array)(title2)].join(", ") : title2;
  }
  ...
  function selectionAsScaleDomainWrongEncodings(encodings, encoding, extent, field) {
    return `${encodings.length ? "Multiple " : "No "}matching ${(0,require$vega.stringValue)(encoding)} encoding found for selection ${(0,require$vega.stringValue)(extent.param)}. ` + `Using "field": ${(0,require$vega.stringValue)(field)}.`;
  }
  ...
  function isDateTime(o) {
    if (o && (0,require$vega_util.isObject)(o)) {
  ...
  function normalizeMonth(m) {
    isNumeric(m) && (m = +m);
    if ((0,require$vega_util.isNumber)(m)) {
      return m - 1;
    }
  ...
  function normalizeDay(d) {
    isNumeric(d) && (d = +d);
    if ((0,require$vega_util.isNumber)(d)) {
      return d % 7;
    }
  ...
  function dateTimeParts(d, normalize) {
    ...
    if (d.month !== void 0) {
      ...
      if (normalize) {
        if (month = d.quarter, isNumeric(month) && (month = +month), (0,require$vega_util.isNumber)(month)) {
      ...
      parts.push((0,require$vega_util.isNumber)(month) ? month * 3 : `${month}*3`);
    } else {
      parts.push(0);
    }
    d.date !== void 0 ? parts.push(d.date) : d.day !== void 0 ? (normalize = normalize ? normalizeDay(d.day) : d.day, parts.push((0,require$vega_util.isNumber)(normalize) ? normalize + 1 : `${normalize}+1`)) : parts.push(1);
  ...
  function isBinnedTimeUnit(timeUnit) {
    return (0,require$vega_util.isObject)(timeUnit) ? timeUnit.binned : timeUnit?.startsWith("binned");
  }
  ...
  function fieldExpr(fullTimeUnit, field, {end} = {end:!1}) {
    ...
    for (const part of TIMEUNIT_PARTS) {
      if (containsTimeUnit(fullTimeUnit, part)) {
        ...
        field[part] = lastTimeUnit;
        lastTimeUnit = part;
      }
    }
    end && (field[lastTimeUnit] += "+1");
    fullTimeUnit = dateTimeParts(field, !1).join(", ");
    return field.utc ? `utc(${fullTimeUnit})` : `datetime(${fullTimeUnit})`;
  }
  ...
  function normalizeTimeUnit(timeUnit) {
    if (timeUnit) {
      var params;
      (0,require$vega_util.isString)(timeUnit) ? params = timeUnit?.startsWith("binned") ? {unit:timeUnit.substring(6), binned:!0} : {unit:timeUnit} : (0,require$vega_util.isObject)(timeUnit) && (params = {...timeUnit, ...(timeUnit.unit ? {unit:timeUnit.unit} : {})});
  ...
  function durationExpr(timeUnit, wrap = x => x) {
    ...
    const smallestUnitPart = getSmallestTimeUnitPart(timeUnit.unit);
    if (smallestUnitPart && smallestUnitPart !== "day") {
      const startDate = {year:2001, month:1, date:1, hours:0, minutes:0, seconds:0, milliseconds:0}, {step, part} = getDateTimePartAndStep(smallestUnitPart, timeUnit.step);
  ...
  function getDateTimePartAndStep(timeUnit, step = 1) {
    if ((0,require$vega.hasOwnProperty)(DATE_PARTS, timeUnit)) {
  ...
  function isFieldRangePredicate(predicate) {
    return predicate?.field && ((0,require$vega_util.isArray)(predicate.range) && predicate.range.length === 2 || isSignalRef(predicate.range)) ? !0 : !1;
  }
  function isFieldOneOfPredicate(predicate) {
    return !!predicate?.field && ((0,require$vega_util.isArray)(predicate.oneOf) || (0,require$vega_util.isArray)(predicate.in));
  }
  ...
  function fieldFilterExpression(predicate, useInRange = !0) {
    var {field} = predicate, normalizedTimeUnit = normalizeTimeUnit(predicate.timeUnit);
    ...
    if (isFieldRangePredicate(predicate)) {
      ({range:normalizedTimeUnit} = replaceExprRef(predicate));
      predicate = isSignalRef(normalizedTimeUnit) ? {signal:`${normalizedTimeUnit.signal}[0]`} : normalizedTimeUnit[0];
      normalizedTimeUnit = isSignalRef(normalizedTimeUnit) ? {signal:`${normalizedTimeUnit.signal}[1]`} : normalizedTimeUnit[1];
      if (predicate !== null && normalizedTimeUnit !== null && useInRange) {
        return `inrange(${field}, [${predicateValueExpr(predicate, unit)}, ${predicateValueExpr(normalizedTimeUnit, unit)}])`;
      }
      useInRange = [];
      predicate !== null && useInRange.push(`${field} >= ${predicateValueExpr(predicate, unit)}`);
  ...
  function fieldValidPredicate(fieldExpr, valid = !0) {
    return valid ? `isValid(${fieldExpr}) && isFinite(+${fieldExpr})` : `!isValid(${fieldExpr}) || !isFinite(+${fieldExpr})`;
  }
  ...
  function channelSupportScaleType(channel, scaleType, hasNestedOffsetScale = !1) {
  ...
  function normalizeInvalidDataMode(mode, {isPath}) {
    return mode === void 0 || mode === "break-paths-show-path-domains" ? isPath ? "break-paths-show-domains" : "filter" : mode === null ? "show" : mode;
  }
  function getScaleInvalidDataMode({markDef, config, scaleChannel, scaleType, isCountAggregate}) {
    ...
    markDef = normalizeInvalidDataMode(getMarkPropOrConfig("invalid", markDef, config), {isPath:isPathMark(markDef.type)});
    return config.scale?.invalid?.[scaleChannel] !== void 0 ? "show" : markDef;
  }
  function scaledZeroOrMinOrMax({scaleName, scale, mode}) {
    const domain = `domain('${scaleName}')`;
    if (scale && scaleName) {
      var min = `${domain}[0]`, max = `peek(${domain})`;
      scale = scale.domainHasZero();
      return scale === "definitely" ? {scale:scaleName, value:0} : scale === "maybe" ? {signal:`scale('${scaleName}', inrange(0, ${domain}) ? 0 : ${mode === "zeroOrMin" ? min : max})`} : {signal:`scale('${scaleName}', ${mode === "zeroOrMin" ? min : max})`};
    }
  }
  function getConditionalValueRefForIncludingInvalidValue({scaleChannel, channelDef, scale, scaleName, markDef, config}) {
    const scaleType = scale?.get("type");
    channelDef = getFieldDef(channelDef);
    const isCountAggregate = isCountingAggregateOp(channelDef?.aggregate);
    markDef = getScaleInvalidDataMode({scaleChannel, markDef, config, scaleType, isCountAggregate});
    if (channelDef && markDef === "show") {
      return config = config.scale.invalid?.[scaleChannel] ?? "zero-or-min", scaleChannel = fieldValidPredicate(vgField(channelDef, {expr:"datum"}), !1), (0,require$vega_util.isObject)(config) && "value" in config ? ({value:scale} = config, scale = isSignalRef(scale) ? {signal:scale.signal} : {value:scale}) : scale = scaledZeroOrMinOrMax({scale, scaleName, mode:"zeroOrMin"}), {test:scaleChannel, ...scale};
    }
  }
  ...
  function interpolatedSignalRef({scaleName, fieldOrDatumDef, fieldOrDatumDef2, offset, startSuffix, endSuffix = "end", bandPosition = 0.5}) {
    ...
    startSuffix = vgField(fieldOrDatumDef, {expr, suffix:startSuffix});
    fieldOrDatumDef2 = fieldOrDatumDef2 !== void 0 ? vgField(fieldOrDatumDef2, {expr}) : vgField(fieldOrDatumDef, {suffix:endSuffix, expr});
    fieldOrDatumDef = {};
    bandPosition === 0 || bandPosition === 1 ? (fieldOrDatumDef.scale = scaleName, fieldOrDatumDef.field = bandPosition === 0 ? startSuffix : fieldOrDatumDef2) : (bandPosition = isSignalRef(bandPosition) ? `(1-${bandPosition.signal}) * ${startSuffix} + ${bandPosition.signal} * ${fieldOrDatumDef2}` : `${1 - bandPosition} * ${startSuffix} + ${bandPosition} * ${fieldOrDatumDef2}`, fieldOrDatumDef.signal = `scale("${scaleName}", ${bandPosition})`);
    offset && (fieldOrDatumDef.offset = offset);
    return fieldOrDatumDef;
  }
  function binSizeExpr({scaleName, fieldDef}) {
    const start = vgField(fieldDef, {expr:"datum"});
    fieldDef = vgField(fieldDef, {expr:"datum", suffix:"end"});
    return `abs(scale("${scaleName}", ${fieldDef}) - scale("${scaleName}", ${start}))`;
  }
      ...
      if (isFieldOrDatumDef(channelDef)) {
        ...
        if (isTypedFieldDef(channelDef)) {
          ...
          if (isBinning(bin) || bandPosition && timeUnit && type === "temporal") {
            return stack?.impute ? valueRefForFieldOrDatumDef(channelDef, scaleName, {binSuffix:"mid"}, {offset}) : bandPosition && !hasDiscreteDomain(scale) ? interpolatedSignalRef({scaleName, fieldOrDatumDef:channelDef, bandPosition, offset}) : valueRefForFieldOrDatumDef(channelDef, scaleName, binRequiresRange(channelDef, channel) ? {binSuffix:"range"} : {}, {offset});
          }
          if (isBinned(bin)) {
        ...
        return valueRefForFieldOrDatumDef(channelDef, scaleName, hasDiscreteDomain(scale) ? {binSuffix:"range"} : {}, {offset, band:scale === "band" ? bandPosition ?? channelDef.bandPosition ?? 0.5 : void 0});
      }
      if (isValueDef(channelDef)) {
        return channel2Def = offset ? {offset} : {}, {...widthHeightValueOrSignalRef(channel, channelDef.value), ...channel2Def};
      }
    }
    (0,require$vega_util.isFunction)(defaultRef) && (defaultRef = defaultRef());
  ...
  function formatSignalRef({fieldOrDatumDef, format, formatType, expr, normalizeStack, config}) {
    if (isCustomFormatType(formatType)) {
      return formatCustomType({fieldOrDatumDef, format, formatType, expr, config});
    }
    const field = fieldToFormat(fieldOrDatumDef, expr, normalizeStack), type = fieldOrDatumDef?.type;
    ...
    if (isFieldOrDatumDefForTimeFormat(fieldOrDatumDef)) {
      formatType = isFieldDef(fieldOrDatumDef) ? normalizeTimeUnit(fieldOrDatumDef.timeUnit) || {} : {unit:void 0, utc:void 0};
      const {unit:timeUnit, utc:isUTCUnit} = formatType;
      return (format = timeFormatExpression({field, timeUnit, format, formatType:config.timeFormatType, rawTimeFormat:config.timeFormat, isUTCScale:isUTCUnit || isScaleFieldDef(fieldOrDatumDef) && fieldOrDatumDef.scale?.type === ScaleType.UTC})) ? {signal:format} : void 0;
    }
    format = numberFormat({type, specifiedFormat:format, config, normalizeStack});
    return isFieldDef(fieldOrDatumDef) && isBinning(fieldOrDatumDef.bin) ? (fieldOrDatumDef = vgField(fieldOrDatumDef, {expr, binSuffix:"end"}), {signal:binFormatExpression(field, fieldOrDatumDef, format, formatType, config)}) : format || fieldOrDatumDef?.type === "quantitative" ? {signal:`${`format(${field}, "${format || ""}")`}`} : {signal:`isValid(${field}) ? ${field} : ""+${field}`};
  }
  ...
  function formatCustomType({fieldOrDatumDef, format, formatType, expr, normalizeStack, config, field}) {
    ...
    return field !== "datum.value" && isFieldDef(fieldOrDatumDef) && isBinning(fieldOrDatumDef.bin) ? (fieldOrDatumDef = vgField(fieldOrDatumDef, {expr, binSuffix:"end"}), {signal:binFormatExpression(field, fieldOrDatumDef, format, formatType, config)}) : {signal:`${formatType}(${field}${format ? `, ${stringify(format)}` : ""})`};
  }
  function guideFormat(fieldOrDatumDef, type, format, formatType, config, omitTimeFormatConfig) {
    if (!(0,require$vega_util.isString)(formatType) || !isCustomFormatType(formatType)) {
      if (format !== void 0 || formatType !== void 0 || !config.customFormatTypes || fieldOrDatumDef?.type !== "quantitative" || !(config.normalizedNumberFormatType && isPositionFieldOrDatumDef(fieldOrDatumDef) && fieldOrDatumDef.stack === "normalize" || config.numberFormatType)) {
        return isPositionFieldOrDatumDef(fieldOrDatumDef) && fieldOrDatumDef.stack === "normalize" && config.normalizedNumberFormat ? numberFormat({type:"quantitative", config, normalizeStack:!0}) : isFieldOrDatumDefForTimeFormat(fieldOrDatumDef) ? (fieldOrDatumDef = isFieldDef(fieldOrDatumDef) ? normalizeTimeUnit(fieldOrDatumDef.timeUnit)?.unit : void 0, fieldOrDatumDef === void 0 && config.customFormatTypes && config.timeFormatType ? void 0 : timeFormat({specifiedFormat:format, timeUnit:fieldOrDatumDef, 
        config, omitTimeFormatConfig})) : numberFormat({type, specifiedFormat:format, config});
      }
    }
  }
  ...
  function numberFormat({type, specifiedFormat, config, normalizeStack}) {
    if ((0,require$vega_util.isString)(specifiedFormat)) {
  ...
  function timeFormat({specifiedFormat, timeUnit, config, omitTimeFormatConfig}) {
    return specifiedFormat ? specifiedFormat : timeUnit ? {signal:timeUnitSpecifierExpression(timeUnit)} : omitTimeFormatConfig ? void 0 : config.timeFormat;
  }
  function binNumberFormatExpr(field, format, formatType, config) {
    if (isCustomFormatType(formatType)) {
      return `${formatType}(${field}${format ? `, ${stringify(format)}` : ""})`;
    }
    format = ((0,require$vega_util.isString)(format) ? format : void 0) ?? config.numberFormat;
  ...
  function timeFormatExpression({field, timeUnit, format, formatType, rawTimeFormat, isUTCScale}) {
    if (!timeUnit || format) {
      ...
      format = (0,require$vega_util.isString)(format) ? format : rawTimeFormat;
      return `${isUTCScale ? "utc" : "time"}Format(${field}, ${stringify(format)})`;
    }
    timeUnit ? (format = timeUnitSpecifierExpression(timeUnit), field = `${isUTCScale || timeUnit.startsWith("utc") ? "utc" : "time"}Format(${field}, ${format})`) : field = void 0;
    return field;
  }
  ...
  function isSortArray(sort) {
    return sort && (0,require$vega_util.isArray)(sort);
  }
  ...
  function getBandSize({channel, fieldDef, fieldDef2, markDef:mark, config, scaleType, useVlSizeChannel}) {
    channel = getSizeChannel(channel);
    useVlSizeChannel = getMarkPropOrConfig(useVlSizeChannel ? "size" : channel, mark, config, {vgChannel:channel});
    if (useVlSizeChannel !== void 0) {
      return useVlSizeChannel;
    }
    if (isFieldDef(fieldDef)) {
      const {timeUnit, bin} = fieldDef;
      if (timeUnit && !fieldDef2) {
  ...
  function hasConditionalFieldDef(channelDef) {
    ...
    return !!channelDef && !(0,require$vega_util.isArray)(channelDef) && isFieldDef(channelDef);
  }
  function hasConditionalFieldOrDatumDef(channelDef) {
    channelDef = channelDef?.condition;
    return !!channelDef && !(0,require$vega_util.isArray)(channelDef) && isFieldOrDatumDef(channelDef);
  }
  ...
  function isNumericDataDef(cd) {
    return isDatumDef(cd) && (0,require$vega_util.isNumber)(cd.datum);
  }
  ...
  function title(fieldOrDatumDef, config, {allowDisabling, includeDefault = !0}) {
    ...
    return allowDisabling ? getFirstDefined(guideTitle, fieldOrDatumDef.title, config) : guideTitle ?? fieldOrDatumDef.title ?? config;
  }
  ...
  function defaultType$2(fieldDef, channel) {
    ...
    if (hasProperty(fieldDef, "sort") && (0,require$vega_util.isArray)(fieldDef.sort)) {
      return "ordinal";
    }
  ...
  function initChannelDef(channelDef, channel, config, opt = {}) {
    return isPrimitive(channelDef) ? (config = (0,require$vega_util.isString)(channelDef) ? "string" : (0,require$vega_util.isNumber)(channelDef) ? "number" : "boolean", warn(`Channel ${channel} is a ${config}. Converted to {value: ${stringify(channelDef)}}.`), {value:channelDef}) : isFieldOrDatumDef(channelDef) ? initFieldOrDatumDef(channelDef, channel, config, opt) : hasConditionalFieldOrDatumDef(channelDef) ? {...channelDef, condition:initFieldOrDatumDef(channelDef.condition, channel, config, 
    opt)} : channelDef;
  }
  function initFieldOrDatumDef(fd, channel, config, opt) {
    ...
    channel = fd.type;
    channel || ({datum:channel} = fd, channel = (0,require$vega_util.isNumber)(channel) ? "quantitative" : (0,require$vega_util.isString)(channel) ? "nominal" : isDateTime(channel) ? "temporal" : void 0, fd = {...fd, type:channel});
    return fd;
  }
  function initFieldDef(fd, channel, {compositeMark = !1} = {}) {
    const {aggregate, timeUnit, bin, field} = fd;
    fd = {...fd};
    compositeMark || !aggregate || isAggregateOp(aggregate) || isArgmaxDef(aggregate) || isArgminDef(aggregate) || (warn(`Invalid aggregation operator "${aggregate}".`), delete fd.aggregate);
    timeUnit && (fd.timeUnit = normalizeTimeUnit(timeUnit));
    field && (fd.field = `${field}`);
    isBinning(bin) && (fd.bin = normalizeBin(bin, channel));
    isBinned(bin) && !isXorY(channel) && warn(`Channel ${channel} should not be used with "binned" bin.`);
    if (isTypedFieldDef(fd)) {
      ({type:compositeMark} = fd);
      const fullType = getFullName(compositeMark);
      compositeMark !== fullType && (fd.type = fullType);
      compositeMark !== "quantitative" && isCountingAggregateOp(aggregate) && (warn(`Invalid field type "${compositeMark}" for aggregate: "${aggregate}", using "quantitative" instead.`), fd.type = "quantitative");
    } else {
      isSecondaryRangeChannel(channel) || (compositeMark = defaultType$2(fd, channel), fd.type = compositeMark);
    }
    if (isTypedFieldDef(fd)) {
      const {compatible, warning} = channelCompatibility(fd, channel) || {};
      compatible === !1 && warn(warning);
    }
    if (hasProperty(fd, "sort") && (0,require$vega_util.isString)(fd.sort)) {
      ({sort:channel} = fd);
      if ((0,require$vega_util.hasOwnProperty)(SORT_BY_CHANNEL_INDEX, channel)) {
        return {...fd, sort:{encoding:channel}};
      }
      compositeMark = channel.substring(1);
      if (channel.charAt(0) === "-" && (0,require$vega_util.hasOwnProperty)(SORT_BY_CHANNEL_INDEX, compositeMark)) {
        return {...fd, sort:{encoding:compositeMark, order:"descending"}};
      }
    }
    if (hasProperty(fd, "header") && ({header:channel} = fd, channel)) {
      const {orient, ...rest} = channel;
      if (orient) {
        return {...fd, header:{...rest, labelOrient:channel.labelOrient || orient, titleOrient:channel.titleOrient || orient}};
      }
    }
    return fd;
  }
  function normalizeBin(bin, channel) {
    return (0,require$vega_util.isBoolean)(bin) ? {maxbins:autoMaxBins(channel)} : bin === "binned" ? {binned:!0} : bin.maxbins || bin.step ? bin : {...bin, maxbins:autoMaxBins(channel)};
  }
  ...
  function valueExpr(v, {timeUnit, type, wrapTime, undefinedIfExprNotRequired}) {
    type = (timeUnit = timeUnit && normalizeTimeUnit(timeUnit)?.unit) || type === "temporal";
    let expr;
    hasProperty(v, "expr") ? expr = v.expr : isSignalRef(v) ? expr = v.signal : isDateTime(v) ? (type = !0, expr = dateTimeToExpr(v)) : ((0,require$vega_util.isString)(v) || (0,require$vega_util.isNumber)(v)) && type && (expr = `datetime(${stringify(v)})`, (0,require$vega.hasOwnProperty)(LOCAL_SINGLE_TIMEUNIT_INDEX, timeUnit) && ((0,require$vega_util.isNumber)(v) && v < 10000 || (0,require$vega_util.isString)(v) && isNaN(Date.parse(v))) && (expr = dateTimeToExpr({[timeUnit]:v})));
    return expr ? wrapTime && type ? `time(${expr})` : expr : undefinedIfExprNotRequired ? void 0 : stringify(v);
  }
  ...
  function channelHasField(encoding, channel) {
    return (encoding = encoding?.[channel]) ? (0,require$vega_util.isArray)(encoding) ? some(encoding, fieldDef => !!fieldDef.field) : isFieldDef(encoding) || hasConditionalFieldDef(encoding) : !1;
  }
  function channelHasFieldOrDatum(encoding, channel) {
    return (encoding = encoding?.[channel]) ? (0,require$vega_util.isArray)(encoding) ? some(encoding, fieldDef => !!fieldDef.field) : isFieldDef(encoding) || isDatumDef(encoding) || hasConditionalFieldOrDatumDef(encoding) : !1;
  }
  ...
  function isAggregate$1(encoding) {
    return some(CHANNELS, channel => channelHasField(encoding, channel) ? (channel = encoding[channel], (0,require$vega_util.isArray)(channel) ? some(channel, fieldDef => !!fieldDef.aggregate) : (channel = getFieldDef(channel)) && !!channel.aggregate) : !1);
  }
  ...
  function initEncoding(encoding, mark, filled, config) {
    ...
    for (var key of keys(encoding)) {
      (0,require$vega_util.hasOwnProperty)(CHANNEL_INDEX, key) || warn(`${key}-encoding is dropped as ${key} is not a valid encoding channel.`);
    }
        ...
        if (markChannelCompatible(encoding, channel, mark)) {
          if (channel === "size" && mark === "line" && getFieldDef(encoding[channel])?.aggregate) {
            ...
            if (channel === "color" && (filled ? "fill" in encoding : "stroke" in encoding)) {
              ...
              if (channel === "detail" || channel === "order" && !(0,require$vega_util.isArray)(key) && !isValueDef(key) || channel === "tooltip" && (0,require$vega_util.isArray)(key)) {
                if (key) {
                  ...
                  normalizedEncoding[channel] = (0,require$vega_util.array)(key).reduce((defs, fieldDef) => {
  ...
  function fieldDefs(encoding) {
    ...
    for (const channel of keys(encoding)) {
      if (channelHasField(encoding, channel)) {
        const channelDefArray = (0,require$vega_util.array)(encoding[channel]);
  ...
  function forEach(mapping, f, thisArg) {
    if (mapping) {
      for (const channel of keys(mapping)) {
        ...
        if ((0,require$vega_util.isArray)(el)) {
  ...
  function reduce(mapping, f, init, thisArg) {
    return mapping ? keys(mapping).reduce((r, channel) => {
      ...
      return (0,require$vega_util.isArray)(map) ? map.reduce((r1, channelDef) => f.call(thisArg, r1, channelDef, channel), r) : f.call(thisArg, r, map, channel);
    }, init) : init;
  }
      ...
      switch(channel) {
        ...
        case "yOffset":
          if (mark === "line" || mark === "area" || mark === "trail") {
            var offsetDef = encoding[channel];
            isFieldDef(offsetDef) && (channel = encoding[channel === "xOffset" ? "x" : "y"], !isFieldDef(channel) || channel.aggregate || offsetDef.aggregate || (channel = vgField(channel, {}), offsetDef = vgField(offsetDef, {}), channel && offsetDef && channel !== offsetDef && details.push(channel)));
          }
          return details;
        case "theta":
        case "theta2":
        ...
        case "key":
          ...
          if ((0,require$vega_util.isArray)(channel) || isFieldDef(channel)) {
            for (offsetDef of (0,require$vega_util.array)(channel)) {
              offsetDef.aggregate || details.push(vgField(offsetDef, {}));
            }
          }
          return details;
        case "size":
        ...
        case "strokeDash":
        case "strokeWidth":
          return (offsetDef = getFieldDef(encoding[channel])) && !offsetDef.aggregate && details.push(vgField(offsetDef, {})), details;
      }
    }, []);
  }
  function getCompositeMarkTooltip(tooltipSummary, continuousAxisChannelDef, encodingWithoutContinuousAxis, withFieldName = !0) {
    if ("tooltip" in encodingWithoutContinuousAxis) {
      return {tooltip:encodingWithoutContinuousAxis.tooltip};
    }
    tooltipSummary = tooltipSummary.map(({fieldPrefix, titlePrefix}) => {
      const mainTitle = withFieldName ? ` of ${getTitle(continuousAxisChannelDef)}` : "";
      return {field:fieldPrefix + continuousAxisChannelDef.field, type:continuousAxisChannelDef.type, title:isSignalRef(titlePrefix) ? {signal:`${titlePrefix}"${escape(mainTitle)}"`} : titlePrefix + mainTitle};
    });
    encodingWithoutContinuousAxis = fieldDefs(encodingWithoutContinuousAxis).map(toStringFieldDef);
    return {tooltip:[...tooltipSummary, ...unique(encodingWithoutContinuousAxis, hash)]};
  }
  ...
  function makeCompositeAggregatePartFactory(compositeMarkDef, continuousAxis, continuousAxisChannelDef, sharedEncoding, compositeMarkConfig) {
    ...
    return ({partName, mark, positionPrefix, endPositionPrefix, extraEncoding = {}}) => {
      const title = getTitle(continuousAxisChannelDef);
      return partLayerMixins(compositeMarkDef, partName, compositeMarkConfig, {mark, encoding:{[continuousAxis]:{field:`${positionPrefix}_${continuousAxisChannelDef.field}`, type:continuousAxisChannelDef.type, ...(title !== void 0 ? {title} : {}), ...(scale !== void 0 ? {scale} : {}), ...(axis !== void 0 ? {axis} : {})}, ...((0,require$vega_util.isString)(endPositionPrefix) ? {[`${continuousAxis}2`]:{field:`${endPositionPrefix}_${continuousAxisChannelDef.field}`}} : {}), ...sharedEncoding, ...extraEncoding}});
    };
  }
  function partLayerMixins(markDef, part, compositeMarkConfig, partBaseSpec) {
    const {clip, color, opacity} = markDef, mark = markDef.type;
    return markDef[part] || markDef[part] === void 0 && compositeMarkConfig[part] ? [{...partBaseSpec, mark:{...compositeMarkConfig[part], ...(clip ? {clip} : {}), ...(color ? {color} : {}), ...(opacity ? {opacity} : {}), ...(isMarkDef(partBaseSpec.mark) ? partBaseSpec.mark : {type:partBaseSpec.mark}), style:`${mark}-${String(part)}`, ...((0,require$vega_util.isBoolean)(markDef[part]) ? {} : markDef[part])}}] : [];
  }
  ...
  function normalizeBoxPlot(spec$jscomp$0, {config}) {
    spec$jscomp$0 = {...spec$jscomp$0, encoding:normalizeEncoding(spec$jscomp$0.encoding, config)};
    ...
    var extent = markDef.extent ?? config.boxplot.extent, sizeValue = getMarkPropOrConfig("size", markDef, config), invalid = markDef.invalid, boxPlotType = (0,require$vega_util.isNumber)(extent) ? "tukey" : extent, spec = spec$jscomp$0;
    ...
    const boxPlotType$jscomp$0 = (0,require$vega_util.isNumber)(extent) ? "tukey" : extent;
    ...
    const {[continuousAxis]:oldContinuousAxisChannelDef, ...oldEncodingWithoutContinuousAxis} = spec.encoding;
    {
      ...
      if (tooltip) {
        ...
        if ((0,require$vega_util.isArray)(tooltip)) {
        ...
        (0,require$vega_util.isArray)(customTooltipWithoutAggregatedField) && customTooltipWithoutAggregatedField.length === 1 && (customTooltipWithoutAggregatedField = customTooltipWithoutAggregatedField[0]);
    ...
    const {customTooltipWithoutAggregatedField:customTooltipWithoutAggregatedField$jscomp$0, filteredEncoding} = JSCompiler_inline_result, {bins, timeUnits, aggregate, groupby, encoding:encodingWithoutContinuousAxis} = extractTransformsFromEncoding(filteredEncoding, config);
    ...
    JSCompiler_inline_result = makeCompositeAggregatePartFactory(markDef, continuousAxis$jscomp$0, continuousAxisChannelDef$jscomp$0, encodingWithoutSizeColorAndContinuousAxis, config.boxplot);
    customTooltipWithoutAggregatedField = makeCompositeAggregatePartFactory(markDef, continuousAxis$jscomp$0, continuousAxisChannelDef$jscomp$0, encodingWithoutContinuousAxis$jscomp$0, config.boxplot);
    t = ((0,require$vega_util.isObject)(config.boxplot.box) ? config.boxplot.box.color : config.mark.color) || "#4c78a8";
    ...
    t = makeCompositeAggregatePartFactory(markDef, continuousAxis$jscomp$0, continuousAxisChannelDef$jscomp$0, t, config.boxplot);
    ...
    config ? config = {transform:markDef, layer:[config, spec$jscomp$0]} : (config = spec$jscomp$0, config.transform.unshift(...markDef));
    return {...outerSpec, layer:[config, {transform, layer:sizeValue}]};
  }
  ...
  function normalizeErrorBar(spec, {config}) {
    spec = {...spec, encoding:normalizeEncoding(spec.encoding, config)};
    ...
    spec = makeCompositeAggregatePartFactory(markDef, continuousAxis, continuousAxisChannelDef, encodingWithoutContinuousAxis, config.errorbar);
    config = markDef.thickness;
    var size = markDef.size;
    size = {type:"tick", orient:ticksOrient, aria:!1, ...(config !== void 0 ? {thickness:config} : {}), ...(size !== void 0 ? {size} : {})};
    spec = [...spec({partName:"ticks", mark:size, positionPrefix:"lower", extraEncoding:tooltipEncoding}), ...spec({partName:"ticks", mark:size, positionPrefix:"upper", extraEncoding:tooltipEncoding}), ...spec({partName:"rule", mark:{type:"rule", ariaRoleDescription:"errorbar", ...(config !== void 0 ? {size:config} : {})}, positionPrefix:"lower", endPositionPrefix:"upper", extraEncoding:tooltipEncoding})];
  ...
  function errorBarParams(spec, compositeMark, config) {
    ...
    "x" ? "xError2" : "yError2"]:oldContinuousAxisChannelDefError2, ...oldEncodingWithoutContinuousAxis} = encoding, {bins, timeUnits, aggregate:oldAggregate, groupby:oldGroupBy, encoding:encodingWithoutContinuousAxis} = extractTransformsFromEncoding(oldEncodingWithoutContinuousAxis, config);
  ...
  function normalizeErrorBand(spec, {config}) {
    ...
    config = makeCompositeAggregatePartFactory(markDef, continuousAxis, continuousAxisChannelDef, encodingWithoutContinuousAxis, config.errorband);
    ...
    return {...outerSpec, transform, layer:[...config({partName:"band", mark:bandMark, positionPrefix:"lower", endPositionPrefix:"upper", extraEncoding:tooltipEncoding}), ...config({partName:"borders", mark:bordersMark, positionPrefix:"lower", extraEncoding:tooltipEncoding}), ...config({partName:"borders", mark:bordersMark, positionPrefix:"upper", extraEncoding:tooltipEncoding})]};
  }
  ...
  function isLegendStreamBinding(bind) {
    return isLegendBinding(bind) && (0,require$vega_util.isObject)(bind);
  }
  ...
  function colorSignalConfig(color = {}) {
    return {signals:[{name:"color", value:(0,require$vega_util.isObject)(color) ? {...DEFAULT_COLOR, ...color} : DEFAULT_COLOR}], mark:{color:{signal:"color.blue"}}, rule:{color:{signal:"color.gray0"}}, text:{color:{signal:"color.gray0"}}, style:{"guide-label":{fill:{signal:"color.gray0"}}, "guide-title":{fill:{signal:"color.gray0"}}, "group-title":{fill:{signal:"color.gray0"}}, "group-subtitle":{fill:{signal:"color.gray0"}}, cell:{stroke:{signal:"color.gray8"}}}, axis:{domainColor:{signal:"color.gray13"}, 
    gridColor:{signal:"color.gray8"}, tickColor:{signal:"color.gray13"}}, range:{category:[{signal:"color.blue"}, {signal:"color.orange"}, {signal:"color.red"}, {signal:"color.teal"}, {signal:"color.green"}, {signal:"color.yellow"}, {signal:"color.purple"}, {signal:"color.pink"}, {signal:"color.brown"}, {signal:"color.grey8"}]}};
  }
  ...
  function initConfig(specifiedConfig = {}) {
    ...
    specifiedConfig = (0,require$vega_util.mergeConfig)({}, duplicate(defaultConfig), font ? {text:{font}, style:{"guide-label":{font}, "guide-title":{font}, "group-title":{font}, "group-subtitle":{font}}} : {}, color ? colorSignalConfig(color) : {}, fontSize ? {signals:[{name:"fontSize", value:(0,require$vega_util.isObject)(fontSize) ? {...DEFAULT_FONT_SIZE, ...fontSize} : DEFAULT_FONT_SIZE}], text:{fontSize:{signal:"fontSize.text"}}, style:{"guide-label":{fontSize:{signal:"fontSize.guideLabel"}}, 
    "guide-title":{fontSize:{signal:"fontSize.guideTitle"}}, "group-title":{fontSize:{signal:"fontSize.groupTitle"}}, "group-subtitle":{fontSize:{signal:"fontSize.groupSubtitle"}}}} : {}, restConfig || {});
    selection && (0,require$vega_util.writeConfig)(specifiedConfig, "selection", selection, !0);
    const outputConfig = omit(specifiedConfig, configPropsWithExpr);
    for (var prop$jscomp$0 of ["background", "lineBreak", "padding"]) {
      specifiedConfig[prop$jscomp$0] && (outputConfig[prop$jscomp$0] = signalRefOrValue(specifiedConfig[prop$jscomp$0]));
    }
    for (var markConfigType of MARK_CONFIGS) {
      specifiedConfig[markConfigType] && (outputConfig[markConfigType] = replaceExprRef(specifiedConfig[markConfigType]));
    }
    for (var axisConfigType of AXIS_CONFIGS) {
      specifiedConfig[axisConfigType] && (outputConfig[axisConfigType] = getAxisConfigInternal(specifiedConfig[axisConfigType]));
    }
    for (const headerConfigType of HEADER_CONFIGS) {
      specifiedConfig[headerConfigType] && (outputConfig[headerConfigType] = replaceExprRef(specifiedConfig[headerConfigType]));
    }
    specifiedConfig.legend && (outputConfig.legend = replaceExprRef(specifiedConfig.legend));
    if (specifiedConfig.scale) {
      const {invalid, ...otherScaleConfig} = specifiedConfig.scale;
    ...
    if (specifiedConfig.style) {
      prop$jscomp$0 = specifiedConfig.style;
    ...
    specifiedConfig.title && (outputConfig.title = replaceExprRef(specifiedConfig.title));
    specifiedConfig.view && (outputConfig.view = replaceExprRef(specifiedConfig.view));
    return outputConfig;
  }
  function stripAndRedirectConfig(config) {
    ...
    if (config.mark) {
      ...
      config.mark.tooltip && (0,require$vega_util.isObject)(config.mark.tooltip) && delete config.mark.tooltip;
    }
    ...
    for (const prop in config) {
      (0,require$vega_util.isObject)(config[prop]) && isEmpty(config[prop]) && delete config[prop];
    }
  ...
  function potentialStackedChannel(encoding, x, {orient, type:mark}) {
    ...
    mark = x === "x" && ["bar", "area"].includes(mark);
    var xDef = encoding[x];
    encoding = encoding[y];
    if (isFieldDef(xDef) && isFieldDef(encoding)) {
      ...
      if (isUnbinnedQuantitative(xDef)) {
        return mark && orient === "vertical" ? void 0 : x;
      }
      if (isUnbinnedQuantitative(encoding)) {
        return mark && orient === "horizontal" ? void 0 : y;
      }
    }
  }
  ...
  function stack(m, encoding) {
    ...
    stackedField = NONPOSITION_CHANNELS.reduce((sc, channel) => {
      if (channel !== "tooltip" && channelHasField(encoding, channel)) {
        ...
        for (const cDef of (0,require$vega_util.array)(channelDef)) {
    ...
    let offset;
    stackedFieldDef.stack !== void 0 ? offset = (0,require$vega_util.isBoolean)(stackedFieldDef.stack) ? stackedFieldDef.stack ? "zero" : null : stackedFieldDef.stack : STACK_BY_DEFAULT_MARKS.has(m) && (offset = "zero");
    if (!offset || !(0,require$vega_util.hasOwnProperty)(STACK_OFFSET_INDEX, offset) || isAggregate$1(encoding) && stackedField.length === 0) {
      return null;
    }
  ...
  function getPointOverlay(markDef, markConfig = {}, encoding) {
    ...
    if (markDef.point) {
      return (0,require$vega_util.isObject)(markDef.point) ? markDef.point : {};
    }
    if (markDef.point !== void 0) {
      return null;
    }
    if (markConfig.point || encoding.shape) {
      return (0,require$vega_util.isObject)(markConfig.point) ? markConfig.point : {};
    }
  }
  ...
  function replaceRepeatInProp(prop, o, repeater) {
    const val = o[prop];
    if (!(0,require$vega_util.isString)(val) && hasProperty(val, "repeat")) {
  ...
  function replaceRepeaterInMapping(mapping, repeater) {
    ...
    for (const channel in mapping) {
      if (hasProperty(mapping, channel)) {
        ...
        (0,require$vega_util.isArray)(channelDef) ? out[channel] = channelDef.map(cd => replaceRepeaterInChannelDef(cd, repeater)).filter(cd => cd) : (channelDef = replaceRepeaterInChannelDef(channelDef, repeater), channelDef !== void 0 && (out[channel] = channelDef));
      }
    }
    return out;
  }
    ...
    if (parentEncoding) {
      ...
      for (const channel of channels) {
        ...
        if (isFieldOrDatumDef(channels)) {
          merged[channel] = {...parentChannelDef, ...channels};
        } else if (hasConditionalFieldOrDatumDef(channels)) {
          merged[channel] = {...channels, condition:{...parentChannelDef, ...channels.condition}};
        } else if (channels || channels === null) {
          merged[channel] = channels;
        } else if (layer || isValueDef(parentChannelDef) || isSignalRef(parentChannelDef) || isFieldOrDatumDef(parentChannelDef) || (0,require$vega_util.isArray)(parentChannelDef)) {
  ...
  function normalizeTransforms(spec, normParams) {
    ...
    return tx ? (spec = tx.map(t => {
      ...
      if (hasProperty(t, "bin") && isBinParams(t.bin)) {
  ...
  function normalizeChannelDef(obj, normParams) {
    obj = duplicate(obj);
    isFieldDef(obj) && isBinParams(obj.bin) && (obj.bin = normalizeBinExtent(obj.bin));
    ...
    if (isConditionalDef(obj)) {
      if ((0,require$vega_util.isArray)(obj.condition)) {
  ...
  function normalizePredicate(op, normParams) {
    const normalizeSelectionComposition = o => normalizeLogicalComposition(o, param => {
      ...
      let $jscomp$logical$assign$tmpm285488632$0;
      ($jscomp$logical$assign$tmpm285488632$0 = normParams.selectionPredicates)[param] ?? ($jscomp$logical$assign$tmpm285488632$0[param] = []);
  ...
  function normalizeGenericSpec(spec, config = {}) {
    config = {config};
    return topLevelSelectionNormalizer.map(coreNormalizer.map(selectionCompatNormalizer.map(spec, config), config), config);
  }
  function _normalizeAutoSize(autosize) {
    return (0,require$vega_util.isString)(autosize) ? {type:autosize} : autosize ?? {};
  }
  ...
  function offsetExpr({timeUnit, field, reverse}) {
    const {unit, utc} = timeUnit, smallestUnit = getSmallestTimeUnitPart(unit), {part, step} = getDateTimePartAndStep(smallestUnit, timeUnit.step);
  ...
  function offsetedRectFormulas([startField, endField], rectBandPosition, timeUnit) {
    if (rectBandPosition !== void 0 && rectBandPosition !== 0.5) {
      ...
      endField = accessWithDatumToUnescapedPath(endField);
      return [{type:"formula", expr:interpolateExpr([offsetExpr({timeUnit, field:startField, reverse:!0}), startExpr], rectBandPosition + 0.5), as:`${startField}_${"offsetted_rect_start"}`}, {type:"formula", expr:interpolateExpr([startExpr, endField], rectBandPosition + 0.5), as:`${startField}_${"offsetted_rect_end"}`}];
    }
    return [];
  }
  ...
  function assembleInit(init, isExpr = !0, wrap = require$vega_util.identity) {
    return (0,require$vega_util.isArray)(init) ? (init = init.map(v => assembleInit(v, isExpr, wrap)), isExpr ? `[${init.join(", ")}]` : init) : isDateTime(init) ? isExpr ? wrap(dateTimeToExpr(init)) : wrap(dateTimeToTimestamp(init)) : isExpr ? wrap(stringify(init)) : init;
  }
  function assembleFacetSignals(model, signals) {
    model.component.selection && keys(model.component.selection).length && (model = (0,require$vega_util.stringValue)(model.getName("cell")), signals.unshift({name:"facet", value:{}, on:[{events:(0,require$vega_event_selector.parseSelector)("pointermove", "scope"), update:`isTuple(facet) ? facet : group(${model}).datum`}]}));
  ...
  function assembleTopLevelSignals(model, signals) {
    ...
    for (const selCmpt of vals(model.component.selection ?? {})) {
      ...
      hasSelections = (0,require$vega_util.stringValue)(name + "_store");
      if (signals.filter(s => s.name === name).length === 0) {
        const isPoint = selCmpt.type === "point" ? ", true, true)" : ")";
        signals.push({name:selCmpt.name, update:`${"vlSelectionResolve"}(${hasSelections}, ${(0,require$vega_util.stringValue)(selCmpt.resolve === "global" ? "union" : selCmpt.resolve)}${isPoint}`});
      }
      hasSelections = !0;
  ...
  function domain(model, channel) {
    return `domain(${(0,require$vega_util.stringValue)(model.scaleName(channel))})`;
  }
  ...
  function channelSignals(model, selCmpt, proj, init) {
    ...
    const vname = proj.signals.visual, scaleName = (0,require$vega_util.stringValue)(scaledInterval ? model.scaleName(channel) : model.projectionName());
  ...
  function wrapCondition({model, channelDef, vgChannel, invalidValueRef, mainRefFn}) {
    ...
    let valueRefs = [];
    condition && (valueRefs = (0,require$vega_util.array)(condition).map(c => {
    ...
    invalidValueRef !== void 0 && valueRefs.push(invalidValueRef);
    channelDef = mainRefFn(channelDef);
    channelDef !== void 0 && valueRefs.push(channelDef);
    return valueRefs.length > 1 || valueRefs.length === 1 && valueRefs[0].test ? {[vgChannel]:valueRefs} : valueRefs.length === 1 ? {[vgChannel]:valueRefs[0]} : {};
  }
  ...
  function tooltip(model, opt = {}) {
    ...
    if ((0,require$vega_util.isArray)(channelDef)) {
    ...
    return wrapCondition({model, channelDef, vgChannel:"tooltip", mainRefFn:cDef => {
      ...
      if (cDef !== null) {
        ...
        if ((0,require$vega_util.isString)(cDef)) {
          return {value:cDef};
        }
        if ((0,require$vega_util.isObject)(cDef)) {
  ...
  function tooltipData(encoding, stack, config, {reactiveGeom} = {}) {
    function add(fDef, channel) {
      ...
      mainChannel = (0,require$vega_util.array)(mainChannel).join(", ").replaceAll(/"/g, '\\"');
      if (isXorY(channel)) {
      ...
      value ??= addLineBreaksToTooltip(fDef, formatConfig, expr).signal;
    ...
    for (const {channel, key, value} of tuples) {
      toSkip.has(channel) || config[key] || (config[key] = value);
    }
    return config;
  }
  function tooltipRefForEncoding(encoding, stack, config, {reactiveGeom} = {}) {
    encoding = tooltipData(encoding, stack, config, {reactiveGeom});
    encoding = entries$1(encoding).map(([key, value]) => `"${key}": ${value}`);
    return encoding.length > 0 ? {signal:`{${encoding.join(", ")}}`} : void 0;
  }
  function addLineBreaksToTooltip(channelDef, config, expr = "datum") {
    return !isFieldDef(channelDef) || !isDiscrete$1(channelDef.type) || channelDef.timeUnit || getFormatMixins(channelDef).format || getFormatMixins(channelDef).formatType ? textRef(channelDef, config, expr) : (channelDef = `${expr}["${channelDef.field}"]`, {signal:`isValid(${channelDef}) ? isArray(${channelDef}) ? join(${channelDef}, '\\n') : ${channelDef} : ""+${channelDef}`});
  }
  function description(model) {
    ...
    if (!isEmpty(channelDef)) {
      return {description:{signal:entries$1(channelDef).filter(([key]) => !key.startsWith("_")).map(([key, value]) => [key, value.replaceAll("\\n", " ")]).map(([key, value], index) => `"${index > 0 ? "; " : ""}${key}: " + (${value})`).join(" + ")}};
    }
  }
  ...
  function positionOffset({channel:baseChannel, markDef, encoding = {}, model, bandPosition}) {
    baseChannel = `${baseChannel}Offset`;
    const defaultValue = markDef[baseChannel];
    encoding = encoding[baseChannel];
    return baseChannel !== "xOffset" && baseChannel !== "yOffset" || !encoding ? (markDef = markDef[baseChannel]) ? {offsetType:"visual", offset:markDef} : {} : {offsetType:"encoding", offset:midPoint({channel:baseChannel, channelDef:encoding, markDef, config:model?.config, scaleName:model.scaleName(baseChannel), scale:model.getScaleComponent(baseChannel), stack:null, defaultRef:signalOrValueRef(defaultValue), bandPosition})};
  }
  function pointPosition(channel$jscomp$0, model, {defaultPos, vgChannel}) {
    const {encoding, markDef:markDef$jscomp$0, config, stack:stack$jscomp$0} = model, channelDef$jscomp$0 = encoding[channel$jscomp$0], channel2Def = encoding[getSecondaryRangeChannel(channel$jscomp$0)], scaleName$jscomp$0 = model.scaleName(channel$jscomp$0), scale = model.getScaleComponent(channel$jscomp$0), {offset:offset$jscomp$0, offsetType} = positionOffset({channel:channel$jscomp$0, markDef:markDef$jscomp$0, encoding, model, bandPosition:0.5});
    defaultPos = pointPositionDefaultRef({model, defaultPos, channel:channel$jscomp$0, scaleName:scaleName$jscomp$0, scale});
    if (!channelDef$jscomp$0 && isXorY(channel$jscomp$0) && (encoding.latitude || encoding.longitude)) {
      model = {field:model.getName(channel$jscomp$0)};
    } else {
      a: {
        model = {channel:channel$jscomp$0, channelDef:channelDef$jscomp$0, channel2Def, markDef:markDef$jscomp$0, config, scaleName:scaleName$jscomp$0, scale, stack:stack$jscomp$0, offset:offset$jscomp$0, defaultRef:defaultPos, bandPosition:offsetType === "encoding" ? 0 : void 0};
  ...
  function zeroOrMinOrMaxPosition({mainChannel, config, ...otherProps}) {
    config = scaledZeroOrMinOrMax(otherProps);
    ({mode:otherProps} = otherProps);
    if (config) {
      return config;
    }
    switch(mainChannel) {
      case "radius":
        if (otherProps === "zeroOrMin") {
          return {value:0};
        }
        const {widthSignal, heightSignal} = otherProps.zeroOrMax;
        return {signal:`min(${widthSignal},${heightSignal})/2`};
      case "theta":
        return otherProps === "zeroOrMin" ? {value:0} : {signal:"2*PI"};
      case "x":
        return otherProps === "zeroOrMin" ? {value:0} : {field:{group:"width"}};
      case "y":
        return otherProps === "zeroOrMin" ? {field:{group:"height"}} : {value:0};
    }
  }
  function vgAlignedPositionChannel(channel, markDef, config, defaultAlign = "middle") {
    ...
    markDef = getMarkPropOrConfig(alignChannel, markDef, config);
    isSignalRef(markDef) ? (warn(`The ${alignChannel} for range marks cannot be an expression`), alignChannel = void 0) : alignChannel = markDef;
  ...
  function rangePosition(channel, model, {defaultPos, defaultPos2}) {
    const {markDef, config} = model;
    var channel2 = getSecondaryRangeChannel(channel), sizeChannel = getSizeChannel(channel);
    {
      const {encoding, mark, markDef, stack, config} = model;
      var baseChannel = getMainRangeChannel(channel2), sizeChannel$jscomp$0 = getSizeChannel(channel2);
      const vgChannel = getVgPositionChannel(channel2);
      var channelDef = encoding[baseChannel];
      const scaleName = model.scaleName(baseChannel), scale = model.getScaleComponent(baseChannel);
      ({offset:baseChannel} = channel2 in encoding || channel2 in markDef ? positionOffset({channel:channel2, markDef, encoding, model}) : positionOffset({channel:baseChannel, markDef, encoding, model}));
      channelDef || channel2 !== "x2" && channel2 !== "y2" || !encoding.latitude && !encoding.longitude ? (channelDef = position2Ref({channel:channel2, channelDef, channel2Def:encoding[channel2], markDef, config, scaleName, scale, stack, offset:baseChannel, defaultRef:void 0}), channel2 = channelDef !== void 0 ? {[vgChannel]:channelDef} : position2orSize(channel2, markDef) || position2orSize(channel2, {[channel2]:getMarkStyleConfig(channel2, markDef, config.style), [sizeChannel$jscomp$0]:getMarkStyleConfig(sizeChannel$jscomp$0, 
      markDef, config.style)}) || position2orSize(channel2, config[mark]) || position2orSize(channel2, config.mark) || {[vgChannel]:pointPositionDefaultRef({model, defaultPos:defaultPos2, channel:channel2, scaleName, scale})()}) : (defaultPos2 = getSizeChannel(channel2), sizeChannel$jscomp$0 = model.markDef[defaultPos2], channel2 = sizeChannel$jscomp$0 != null ? {[defaultPos2]:{value:sizeChannel$jscomp$0}} : {[vgChannel]:{field:model.getName(channel2)}});
    }
    sizeChannel = channel2[sizeChannel] ? vgAlignedPositionChannel(channel, markDef, config) : getVgPositionChannel(channel);
    return {...pointPosition(channel, model, {defaultPos, vgChannel:sizeChannel}), ...channel2};
  }
  function position2Ref({channel, channelDef, channel2Def, markDef, config, scaleName, scale, stack, offset, defaultRef}) {
    return isFieldOrDatumDef(channelDef) && stack && channel.charAt(0) === stack.fieldChannel.charAt(0) ? valueRefForFieldOrDatumDef(channelDef, scaleName, {suffix:"start"}, {offset}) : midPointRefWithPositionInvalidTest({channel, channelDef:channel2Def, scaleName, scale, stack, markDef, config, offset, defaultRef});
  }
  ...
  function rectPosition(model, channel) {
    ...
    var mark = markDef.type, channel2 = getSecondaryRangeChannel(channel), sizeChannel = getSizeChannel(channel);
    ...
    mark = mark === "bar" && (channel === "x" ? orient === "vertical" : orient === "horizontal") || mark === "tick" && (channel === "y" ? orient === "vertical" : orient === "horizontal");
    if (!isFieldDef(channelDef) || !(isBinning(channelDef.bin) || isBinned(channelDef.bin) || channelDef.timeUnit && !channel2) || sizeChannel && !isRelativeBandSize(sizeChannel) || encoding[offsetScaleChannel] || hasDiscreteDomain(scale)) {
      if ((isFieldOrDatumDef(channelDef) && hasDiscreteDomain(scale) || mark) && !channel2) {
        var JSCompiler_inline_result;
        {
          ...
          offsetScaleChannel = markDef.orient;
          scale = model.scaleName(channel);
          sizeChannel = model.getScaleComponent(channel);
          mark = getSizeChannel(channel);
          channel2 = getSecondaryRangeChannel(channel);
          orient = getOffsetChannel(channel);
          orient = model.scaleName(orient);
          var offsetScale = model.getScaleComponent(getOffsetScaleChannel(channel));
          offsetScaleChannel = markDef.type === "tick" || offsetScaleChannel === "horizontal" && channel === "y" || offsetScaleChannel === "vertical" && channel === "x";
          if (encoding.size || markDef.size) {
            offsetScaleChannel ? JSCompiler_inline_result = nonPosition("size", model, {vgChannel:mark, defaultRef:signalOrValueRef(markDef.size)}) : warn(`Cannot apply size to non-oriented mark "${markDef.type}".`);
          }
          const hasSizeFromMarkOrEncoding = !!JSCompiler_inline_result;
          offsetScaleChannel = getBandSize({channel, fieldDef:channelDef, markDef, config, scaleType:(sizeChannel || offsetScale)?.get("type"), useVlSizeChannel:offsetScaleChannel});
          JSCompiler_inline_result = JSCompiler_inline_result || {[mark]:defaultSizeRef(mark, orient || scale, offsetScale || sizeChannel, config, offsetScaleChannel, !!channelDef, markDef.type)};
          orient = (sizeChannel || offsetScale)?.get("type") === "band" && isRelativeBandSize(offsetScaleChannel) && !hasSizeFromMarkOrEncoding ? "top" : "middle";
          orient = vgAlignedPositionChannel(channel, markDef, config, orient);
          offsetScale = orient === "xc" || orient === "yc";
          const {offset, offsetType} = positionOffset({channel, markDef, encoding, model, bandPosition:offsetScale ? 0.5 : 0});
          offsetScaleChannel = (offsetScale && offsetType !== "encoding" && isFieldDef(channelDef) && channelDef.timeUnit && !encoding[channel2] ? getBandPosition({fieldDef:channelDef, markDef, config}) : void 0) ?? (offsetScale ? offsetType === "encoding" ? 0 : 0.5 : isSignalRef(offsetScaleChannel) ? {signal:`(1-${offsetScaleChannel})/2`} : isRelativeBandSize(offsetScaleChannel) ? (1 - offsetScaleChannel.band) / 2 : 0);
          model = midPointRefWithPositionInvalidTest({channel, channelDef, markDef, config, scaleName:scale, scale:sizeChannel, stack, offset, defaultRef:pointPositionDefaultRef({model, defaultPos:"mid", channel, scaleName:scale, scale:sizeChannel}), bandPosition:offsetScaleChannel});
          mark ? JSCompiler_inline_result = {[orient]:model, ...JSCompiler_inline_result} : (channel = getVgPositionChannel(channel2), JSCompiler_inline_result = JSCompiler_inline_result[mark], JSCompiler_inline_result = offset ? {...JSCompiler_inline_result, offset} : JSCompiler_inline_result, JSCompiler_inline_result = {[orient]:model, [channel]:(0,require$vega_util.isArray)(model) ? [model[0], {...model[1], offset:JSCompiler_inline_result}] : {...model, offset:JSCompiler_inline_result}});
        }
        return JSCompiler_inline_result;
      }
      return rangePosition(channel, model, {defaultPos:"zeroOrMax", defaultPos2:"zeroOrMin"});
    }
    return rectBinPosition({fieldDef:channelDef, fieldDef2:channel2, channel, model});
  }
  function defaultSizeRef(sizeChannel, scaleName, scale, config, bandSize, hasFieldDef, mark) {
    ...
    if (scale && (bandSize = scale.get("range"), isVgRangeStep(bandSize) && (0,require$vega_util.isNumber)(bandSize.step))) {
    ...
    if (!hasFieldDef) {
      ...
      if ((0,require$vega_util.isNumber)(mark)) {
  ...
  function rectBinPosition({fieldDef, fieldDef2, channel, model}) {
    ...
    var scaleType = scale ? scale.get("type") : void 0, reverse = scale.get("reverse"), bandSize = getBandSize({channel, fieldDef, markDef, config, scaleType}), axisTranslate = model.component.axes[channel]?.[0]?.get("translate") ?? 0.5;
    const spacing = isXorY(channel) ? getMarkPropOrConfig("binSpacing", markDef, config) ?? 0 : 0, channel2 = getSecondaryRangeChannel(channel);
    scaleType = getVgPositionChannel(channel);
    scale = getVgPositionChannel(channel2);
    const minBandSize = getMarkConfig("minBandSize", markDef, config), {offset} = positionOffset({channel, markDef, encoding, model, bandPosition:0});
    ({offset:model} = positionOffset({channel:channel2, markDef, encoding, model, bandPosition:0}));
    const bandSizeExpr = binSizeExpr({fieldDef, scaleName});
    channel = getBinSpacing(channel, spacing, reverse, axisTranslate, offset, minBandSize, bandSizeExpr);
    reverse = getBinSpacing(channel2, spacing, reverse, axisTranslate, model ?? offset, minBandSize, bandSizeExpr);
    bandSize = isSignalRef(bandSize) ? {signal:`(1-${bandSize.signal})/2`} : isRelativeBandSize(bandSize) ? (1 - bandSize.band) / 2 : 0.5;
    axisTranslate = getBandPosition({fieldDef, fieldDef2, markDef, config});
    if (isBinning(fieldDef.bin) || fieldDef.timeUnit) {
      return fieldDef2 = fieldDef.timeUnit && axisTranslate !== 0.5, {[scale]:rectBinRef({fieldDef, scaleName, bandPosition:bandSize, offset:reverse, useRectOffsetField:fieldDef2}), [scaleType]:rectBinRef({fieldDef, scaleName, bandPosition:isSignalRef(bandSize) ? {signal:`1-${bandSize.signal}`} : 1 - bandSize, offset:channel, useRectOffsetField:fieldDef2})};
    }
    if (isBinned(fieldDef.bin)) {
      reverse = valueRefForFieldOrDatumDef(fieldDef, scaleName, {}, {offset:reverse});
      if (isFieldDef(fieldDef2)) {
        return {[scale]:reverse, [scaleType]:valueRefForFieldOrDatumDef(fieldDef2, scaleName, {}, {offset:channel})};
      }
      if (isBinParams(fieldDef.bin) && fieldDef.bin.step) {
        return {[scale]:reverse, [scaleType]:{signal:`scale("${scaleName}", ${vgField(fieldDef, {expr:"datum"})} + ${fieldDef.bin.step})`, offset:channel}};
      }
    }
      ...
      if (enableAria === !1) {
      ...
      } else {
        {
          ...
          if (config.aria === !1) {
            ...
            JSCompiler_inline_result = getMarkPropOrConfig("ariaRoleDescription", markDef, config), JSCompiler_inline_result = JSCompiler_inline_result != null ? {ariaRoleDescription:{value:JSCompiler_inline_result}} : (0,require$vega_util.hasOwnProperty)(VG_MARK_INDEX, mark) ? {} : {ariaRoleDescription:{value:mark}};
          }
        }
  ...
  function onDelta$1(model, selCmpt, proj, size, signals) {
    ...
    model = model.getScaleComponent(channel);
    signals = model?.get("type");
    var reversed = model?.get("reverse");
  ...
  function onDelta(model, selCmpt, proj, size, signals) {
    ...
    selCmpt = signals.find(s => s.name === proj.signals[boundScales ? "data" : "visual"]);
    size = model.getSizeSignalRef(size).signal;
    signals = model.getScaleComponent(channel);
    const scaleType = signals?.get("type"), base = boundScales ? domain(model, channel) : selCmpt.name;
  ...
  function unitName(model, {escape} = {escape:!0}) {
    escape = escape ? (0,require$vega_util.stringValue)(model.name) : model.name;
    for (model = model.parent; model && !isFacetModel(model);) {
      model = model.parent;
    }
    if (model) {
      const {facet} = model;
      for (const channel of FACET_CHANNELS) {
        facet[channel] && (escape += ` + '__facet_${channel}_' + (facet[${(0,require$vega_util.stringValue)(model.vgField(channel))}])`);
      }
    }
    return escape;
  }
  ...
  function disableDirectManipulation(selCmpt, selDef) {
    !(0,require$vega.isString)(selDef.select) && selDef.select.on || delete selCmpt.events;
    !(0,require$vega.isString)(selDef.select) && selDef.select.clear || delete selCmpt.clear;
    !(0,require$vega.isString)(selDef.select) && selDef.select.toggle || delete selCmpt.toggle;
  }
  ...
  function getDependentFields(expression) {
    expression = (0,require$vega_expression.parseExpression)(expression);
  ...
  function parseSelectionPredicate(model, pred, dfnode, datum = "datum") {
    const name = (0,require$vega_util.isString)(pred) ? pred : pred.param, vname = varName(name);
    var store = (0,require$vega_util.stringValue)(vname + "_store");
    try {
      var selCmpt = model.getSelectionComponent(vname, name);
    } catch {
      return `!!${vname}`;
    }
    selCmpt.project.timeUnit && (model = dfnode ?? model.component.data.raw, dfnode = selCmpt.project.timeUnit.clone(), model.parent ? dfnode.insertAsParentOf(model) : model.parent = dfnode);
    model = selCmpt.project.hasSelectionId ? "vlSelectionIdTest(" : "vlSelectionTest(";
    selCmpt = selCmpt.resolve === "global" ? ")" : `, ${(0,require$vega_util.stringValue)(selCmpt.resolve)})`;
    datum = `${model}${store}, ${datum}${selCmpt}`;
  ...
  function parseSelectionExtent(model, name, extent) {
    ...
    encoding || field ? encoding && !field && (model = selCmpt.project.items.filter(p => p.channel === encoding), !model.length || model.length > 1 ? (field = selCmpt.project.items[0].field, warn(selectionAsScaleDomainWrongEncodings(model, encoding, extent, field))) : field = model[0].field) : (field = selCmpt.project.items[0].field, selCmpt.project.items.length > 1 && warn('A "field" or "encoding" must be specified when using a selection as a scale domain. ' + `Using "field": ${(0,require$vega.stringValue)(field)}.`));
    return `${selCmpt.name}[${(0,require$vega_util.stringValue)(replacePathInField(field))}]`;
  }
  function expression(model, filterOp, node) {
    return logicalExpr(filterOp, predicate => (0,require$vega_util.isString)(predicate) ? predicate : hasProperty(predicate, "param") ? parseSelectionPredicate(model, predicate, node) : fieldFilterExpression(predicate));
  }
  function assembleTitle(title, config) {
    if (title) {
      return (0,require$vega_util.isArray)(title) && !isText(title) ? title.map(fieldDef => titleFormatter(fieldDef, config)).join(", ") : title;
    }
  }
  function setAxisEncode(axis, part, vgProp, vgRef) {
    axis.encode ?? (axis.encode = {});
    let $jscomp$logical$assign$tmpm285488632$2;
    ($jscomp$logical$assign$tmpm285488632$2 = axis.encode)[part] ?? ($jscomp$logical$assign$tmpm285488632$2[part] = {});
    let $jscomp$logical$assign$tmpm285488632$3;
    ($jscomp$logical$assign$tmpm285488632$3 = axis.encode[part]).update ?? ($jscomp$logical$assign$tmpm285488632$3.update = {});
    axis.encode[part].update[vgProp] = vgRef;
  }
  function assembleAxis(axisCmpt, kind, config, opt = {header:!1}) {
    ...
    if (!disable) {
      for (const p in axis) {
        ...
        if (propType && propType !== kind && propType !== "both") {
          ...
          propValue = (0,require$vega_util.array)(condition);
          if (propType = CONDITIONAL_AXIS_PROP_INDEX[prop]) {
            ...
            propType === null && (propValue = {signal:propValue.map(c => {
              const {test, ...valueOrSignalCRef} = c;
              return `${expression(null, test)} ? ${isSignalRef(valueOrSignalCRef) ? valueOrSignalCRef.signal : (0,require$vega_util.stringValue)(valueOrSignalCRef.value)} : `;
            }).join("") + (isSignalRef(valueOrSignalRef) ? valueOrSignalRef.signal : (0,require$vega_util.stringValue)(valueOrSignalRef.value))}, axis[prop] = propValue);
          }
      ...
      if (kind === "grid") {
        if (axis.grid) {
          return axis.encode && ({grid:config} = axis.encode, axis.encode = {...(config ? {grid:config} : {})}, isEmpty(axis.encode) && delete axis.encode), {scale, orient, ...axis, domain:!1, labels:!1, aria:!1, maxExtent:0, minExtent:0, ticks:!1, zindex:getFirstDefined(zindex, 0)};
        }
      } else {
        if (opt.header || !axisCmpt.mainExtracted) {
          labelExpr !== void 0 && (kind = labelExpr, axis.encode?.labels?.update && isSignalRef(axis.encode.labels.update.text) && (kind = replaceAll(labelExpr, "datum.label", axis.encode.labels.update.text.signal)), setAxisEncode(axis, "labels", "text", {signal:kind}));
          axis.labelAlign === null && delete axis.labelAlign;
          if (axis.encode) {
            for (const part of AXIS_PARTS) {
              axisCmpt.hasAxisPart(part) || delete axis.encode[part];
            }
            isEmpty(axis.encode) && delete axis.encode;
          }
          axisCmpt = assembleTitle(title, config);
          return {scale, orient, grid:!1, ...(axisCmpt ? {title:axisCmpt} : {}), ...axis, ...(config.aria === !1 ? {aria:!1} : {}), zindex:getFirstDefined(zindex, 0)};
        }
      }
    }
  }
  ...
  function getAxisConfigStyle(axisConfigTypes, config) {
    ...
    for (const configType of axisConfigTypes) {
      if (axisConfigTypes = config[configType]?.style) {
        axisConfigTypes = (0,require$vega_util.array)(axisConfigTypes);
  ...
  function getAxisConfig(property, styleConfigIndex, style, axisConfigs = {}) {
    styleConfigIndex = getStyleConfig(property, style, styleConfigIndex);
    if (styleConfigIndex !== void 0) {
      return {configFrom:"style", configValue:styleConfigIndex};
    }
  ...
  function defaultLabelAlign(angle, orient, channel) {
    if (angle !== void 0) {
      ...
      angle < 180 + startAngle ? "\x3d\x3d\x3d" : "!\x3d\x3d"} "${mainOrient}"`} ? "left" : "right"`} : (startAngle < angle && angle < 180 + startAngle) === (orient === mainOrient) ? "left" : "right";
    }
  }
  ...
  function defaultTickMinStep({format, fieldOrDatumDef}) {
    ...
    if (isFieldDef(fieldOrDatumDef) && ({timeUnit:format} = fieldOrDatumDef, format && (format = durationExpr(format)))) {
  ...
  function defaultHeaderGuideAlign(headerChannel, angle, anchor = "middle") {
    ...
    return (headerChannel = defaultLabelAlign(angle, headerChannel === "row" ? "left" : "top", headerChannel === "row" ? "y" : "x")) ? {align:headerChannel} : {};
  }
  ...
  function getConditionValue(channelDef, reducer) {
    ...
    if (condition && ((0,require$vega_util.isArray)(condition) || isValueDef(condition))) {
      return (0,require$vega_util.array)(channelDef.condition).reduce(reducer, channelDef.value);
    }
    if (isValueDef(channelDef)) {
  ...
  function selectedCondition(model, legendCmpt, fieldDef) {
    ...
    if (model?.length) {
      var field = (0,require$vega_util.stringValue)(fieldDef.field);
      return model.map(name => `(!length(data(${(0,require$vega_util.stringValue)(varName(name) + "_store")})) || (${name}[${field}] && indexof(${name}[${field}], datum.value) >= 0))`).join(" || ");
    }
  }
  ...
  function getDirection({legendConfig, legendType, orient, legend}) {
    if ((legendConfig = legend.direction ?? legendConfig[legendType ? "gradientDirection" : "symbolDirection"]) != null) {
      legendType = legendConfig;
    } else {
      a: {
        switch(orient) {
          case "top":
          ...
          case void 0:
            ...
            break a;
          default:
            legendType = legendType === "gradient" ? "horizontal" : void 0;
        }
      }
    }
    return legendType;
  ...
  function defaultGradientLength({legendConfig, model, direction, orient, scaleType}) {
    ...
    if (CONTINUOUS_TO_CONTINUOUS_SCALES.has(scaleType)) {
      return direction === "horizontal" ? orient === "top" || orient === "bottom" ? {signal:`clamp(${model.getSizeSignalRef("width").signal}, ${gradientHorizontalMinLength}, ${gradientHorizontalMaxLength})`} : gradientHorizontalMinLength : {signal:`clamp(${model.getSizeSignalRef("height").signal}, ${gradientVerticalMinLength}, ${gradientVerticalMaxLength})`};
    }
  }
  function parseLegend(model) {
    if (isUnitModel(model)) {
        ...
        if (def && model.getScaleComponent(JSCompiler_temp) && (JSCompiler_temp !== "shape" || !isFieldDef(def) || def.type !== "geojson")) {
          {
            var JSCompiler_inline_result;
            def = model;
            var legend = def.legend(JSCompiler_temp);
            ...
            scale = legend !== void 0 ? !legend : legendConfig.disable;
            JSCompiler_inline_result$jscomp$0.set("disable", scale, legend !== void 0);
            if (scale) {
              ...
              JSCompiler_inline_result = {legend, channel:JSCompiler_temp, timeUnit:JSCompiler_inline_result, scaleType:legendSelections};
              var {legend:legend$jscomp$0} = JSCompiler_inline_result;
              JSCompiler_inline_result = getFirstDefined(legend$jscomp$0.type, defaultType$1(JSCompiler_inline_result));
              legend$jscomp$0 = getDirection({legend, legendType:JSCompiler_inline_result, orient, legendConfig});
              legendConfig = {legend, channel:JSCompiler_temp, model:def, markDef, encoding, fieldOrDatumDef:scale, legendConfig, config, scaleType:legendSelections, orient, legendType:JSCompiler_inline_result, direction:legend$jscomp$0};
              for (const property of LEGEND_COMPONENT_PROPERTIES) {
                if (!(JSCompiler_inline_result === "gradient" && property.startsWith("symbol") || JSCompiler_inline_result === "symbol" && property.startsWith("gradient")) && (legendSelections = property in legendRules ? legendRules[property](legendConfig) : legend[property], legendSelections !== void 0)) {
                  b: {
                    orient = legendSelections;
                    legend$jscomp$0 = property;
                    var legend$jscomp$1 = legend, fieldDef = def.fieldDef(JSCompiler_temp);
                    switch(legend$jscomp$0) {
                      case "disable":
                        orient = legend$jscomp$1 !== void 0;
                        break b;
                      case "values":
                        orient = !!legend$jscomp$1?.values;
                        break b;
                      case "title":
                        if (legend$jscomp$0 === "title" && orient === fieldDef?.title) {
                          orient = !0;
                          break b;
                        }
                    }
                    orient = orient === (legend$jscomp$1 || {})[legend$jscomp$0];
                  }
                  (orient || config.legend[property] === void 0) && JSCompiler_inline_result$jscomp$0.set(property, legendSelections, orient);
                }
              }
              legendConfig = legend?.encoding ?? {};
              ...
              for (const part of "labels legend title symbols gradient entries".split(" ")) {
                legend$jscomp$0 = guideEncodeEntry(legendConfig[part] ?? {}, def), legend$jscomp$0 = part in legendEncodeRules ? legendEncodeRules[part](legend$jscomp$0, JSCompiler_inline_result) : legend$jscomp$0, legend$jscomp$0 === void 0 || isEmpty(legend$jscomp$0) || (orient[part] = {...(legendSelections?.length && isFieldDef(scale) ? {name:`${varName(scale.field)}_legend_${part}`} : {}), ...(legendSelections?.length ? {interactive:!0} : {}), update:legendSelections?.length ? {...legend$jscomp$0, 
                cursor:{value:"pointer"}} : legend$jscomp$0});
              }
              isEmpty(orient) || JSCompiler_inline_result$jscomp$0.set("encode", orient, !!legend?.encoding);
              def = JSCompiler_inline_result$jscomp$0;
            }
          }
      ...
      for (def of keys(legends)) {
        for (legend of model.children) {
          legend.component.legends[def] && resolve.legend[def] === "shared" && delete legend.component.legends[def];
        }
      }
  ...
  function createBinComponent(t, bin, model) {
    let as;
    as = "as" in t ? (0,require$vega_util.isString)(t.as) ? [t.as, `${t.as}_end`] : [t.as[0], t.as[1]] : [vgField(t, {forAs:!0}), vgField(t, {binSuffix:"end", forAs:!0})];
    bin = {...normalizeBin(bin, void 0)};
  ...
  function getImplicitFromFilterTransform(transform) {
    ...
    forEachLeaf(transform.filter, filter => {
      if (isFieldPredicate(filter)) {
        ...
        filter.in)[0]);
        val && (isDateTime(val) ? implicit[filter.field] = "date" : (0,require$vega_util.isNumber)(val) ? implicit[filter.field] = "number" : (0,require$vega_util.isString)(val) && (implicit[filter.field] = "string"));
    ...
    function add(fieldDef) {
      if (isFieldOrDatumDefForTimeFormat(fieldDef)) {
        ...
        if (JSCompiler_temp = fieldDef.type === "quantitative") {
          JSCompiler_temp = fieldDef.aggregate, JSCompiler_temp = (0,require$vega_util.isString)(JSCompiler_temp) && contains(["min", "max"], JSCompiler_temp);
        }
  ...
  function isValidAsArray(as) {
    return (0,require$vega_util.isArray)(as) && as.every(s => (0,require$vega_util.isString)(s)) && as.length > 1;
  }
  ...
  function parseUnitScaleDomain(model$jscomp$0) {
    ...
    for (const channel of keys(localScaleComponents)) {
      ...
      encoding = isBinParams(encoding) && hasProperty(encoding.extent, "param") ? encoding.extent : void 0;
  ...
  function parseSingleChannelDomain(scaleType, domain, model, channel) {
    ...
    if (isBinning(fieldOrDatumDef.bin)) {
      if (hasDiscreteDomain(scaleType)) {
        return scaleType === "bin-ordinal" ? makeImplicit([]) : makeImplicit([{data:isBoolean(sort) ? model.requestDataName(dataSourceTypeForScaleDomain) : model.requestDataName(DataSourceType.Raw), field:model.vgField(channel, binRequiresRange(fieldOrDatumDef, channel) ? {binSuffix:"range"} : {}), sort:sort !== !0 && (0,require$vega_util.isObject)(sort) ? sort : {field:model.vgField(channel, {}), op:"min"}}]);
      }
    ...
    if (uniqueDomains.length !== 0) {
      if (uniqueDomains.length === 1) {
        ...
        if (isDataRefDomain(uniqueDomains) && sorts.length > 0) {
          var sort = sorts[0];
          sorts.length > 1 ? (warn("Domains that should be unioned has conflicting sort properties. Sort will be set to true."), sort = sorts.filter(s => (0,require$vega_util.isObject)(s) && "op" in s && s.op !== "min"), sort = sorts.every(s => (0,require$vega_util.isObject)(s) && "op" in s) && sort.length === 1 ? sort[0] : !0) : (0,require$vega_util.isObject)(sort) && "field" in sort && uniqueDomains.field === sort.field && (sort = sort.order ? {order:sort.order} : !0);
          return {...uniqueDomains, sort};
        }
        return uniqueDomains;
      }
      sorts = unique(sorts.map(s => {
        if (isBoolean(s) || !("op" in s) || (0,require$vega_util.isString)(s.op) && (0,require$vega_util.hasOwnProperty)(MULTIDOMAIN_SORT_OP_INDEX, s.op)) {
          return s;
        }
  ...
  function getFieldFromDomain(domain) {
    if (isDataRefDomain(domain) && (0,require$vega_util.isString)(domain.field)) {
      return domain.field;
    }
    if (isDataRefUnionedDomain(domain)) {
      for (const nonUnionDomain of domain.fields) {
        if (isDataRefDomain(nonUnionDomain) && (0,require$vega_util.isString)(nonUnionDomain.field)) {
          if (!field) {
            var field = nonUnionDomain.field;
    ...
    field = (0,require$vega_util.isArray)(domain) ? !1 : hasProperty(domain, "fields") && hasProperty(domain, "data");
    if (field) {
      return warn("Detected faceted independent scales that union domain of multiple fields from the same data source. We will use the first field. The result view size may be incorrect."), domain = domain.fields[0], (0,require$vega_util.isString)(domain) ? domain : void 0;
    }
  }
  ...
  function getFieldKeyForChannel(model, channel) {
    ...
    model = (model.children ?? []).map(child => getFieldKeyForChannel(child, channel)).filter(f => !!f);
    if (model.length > 0 && (model = unique(model, hash), model.length === 1)) {
      return model[0];
    }
  }
  function legendsAreMergeCompatible(model, channelA, channelB) {
    ...
    channelA = model.getScaleType(channelA);
    model = model.getScaleType(channelB);
    if (!channelA || !model) {
      return !1;
    }
    channelB = hasDiscreteDomain(channelA);
    model = hasDiscreteDomain(model);
    return channelB === model;
  }
  function extractDiscreteValuesFromDomain(domain) {
    if ((0,require$vega_util.isArray)(domain)) {
      return domain = domain.filter(isPrimitive), domain.length > 0 ? domain : null;
    }
    if (isDataRefUnionedDomain(domain)) {
      const values = [];
      values.push(...domain.fields.flatMap(f => (0,require$vega_util.isArray)(f) ? f.filter(isPrimitive) : []));
      if (values.length > 0) {
  ...
  function unionDiscreteValuesForChannels(model, channelA, channelB) {
    channelA = getDiscreteValuesForChannel(model, channelA);
    model = getDiscreteValuesForChannel(model, channelB);
    return channelA && model ? unique([...channelA, ...model], hash) : null;
  }
  function setImplicitLegendValues(cmpt, values, warnMessage) {
    values && values.length > 0 && !cmpt.getWithExplicit("values")?.explicit && (warnMessage && warn(warnMessage), cmpt.set("values", values, !1));
  }
  function domainsExplicitAndEqual(model, channelA, channelB) {
    var scA = model.getScaleComponent(channelA), scB = model.getScaleComponent(channelB);
    if (!scA || !scB) {
      return !1;
    }
    scA = scA.getWithExplicit("domains");
    scB = scB.getWithExplicit("domains");
    if (!scA?.explicit || !scB?.explicit) {
      return !1;
    }
    channelA = assembleDomain(model, channelA);
    model = assembleDomain(model, channelB);
    return hash(channelA) === hash(model);
  }
  function assembleLegends(model) {
    const legendComponentIndex = model.component.legends, legendsByGroup = {};
    for (const channel of keys(legendComponentIndex)) {
      var fieldKey = getFieldKeyForChannel(model, channel);
      fieldKey = fieldKey ? `field:${fieldKey}` : `channel:${String(channel)}`;
      if (legendsByGroup[fieldKey]) {
        var mergedIntoExisting = !1;
        for (const existing of legendsByGroup[fieldKey]) {
          if (legendsAreMergeCompatible(model, existing.channel, channel) && mergeLegendComponent(existing.cmpt, legendComponentIndex[channel])) {
            mergedIntoExisting = model.getScaleType(existing.channel);
            const typeB = model.getScaleType(channel);
            mergedIntoExisting && typeB && hasDiscreteDomain(mergedIntoExisting) && hasDiscreteDomain(typeB) && (domainsExplicitAndEqual(model, existing.channel, channel) ? setImplicitLegendValues(existing.cmpt, getDiscreteValuesForChannel(model, existing.channel)) : setImplicitLegendValues(existing.cmpt, unionDiscreteValuesForChannels(model, existing.channel, channel), `Unioning discrete legend values from ${existing.channel} and ${channel}.`));
            mergedIntoExisting = !0;
            break;
          }
        }
        mergedIntoExisting || legendsByGroup[fieldKey].push({channel, cmpt:legendComponentIndex[channel].clone()});
      } else {
        legendsByGroup[fieldKey] = [{channel, cmpt:legendComponentIndex[channel].clone()}];
      }
    }
    return vals(legendsByGroup).flat().map(entry => {
      {
        var config = model.config;
        const {disable, labelExpr, selections, ...legend} = entry.cmpt.combine();
        if (disable) {
          var JSCompiler_inline_result = void 0;
        } else {
          config.aria === !1 && legend.aria == void 0 && (legend.aria = !1);
          if (legend.encode?.symbols) {
            entry = legend.encode.symbols.update;
            !entry.fill || entry.fill.value === "transparent" || entry.stroke || legend.stroke || (entry.stroke = {value:"transparent"});
            for (var property of LEGEND_SCALE_CHANNELS) {
              legend[property] && delete entry[property];
            }
          }
          legend.title || delete legend.title;
          if (labelExpr !== void 0) {
            entry = labelExpr;
            legend.encode?.labels?.update && isSignalRef(legend.encode.labels.update.text) && (entry = replaceAll(labelExpr, "datum.label", legend.encode.labels.update.text.signal));
            property = legend;
            entry = {signal:entry};
            property.encode ?? (property.encode = {});
            (JSCompiler_inline_result = property.encode).labels ?? (JSCompiler_inline_result.labels = {});
            let $jscomp$inline_6911;
            ($jscomp$inline_6911 = property.encode.labels).update ?? ($jscomp$inline_6911.update = {});
            property.encode.labels.update.text = entry;
          }
  ...
  function mergeIfNoConflict(first, second) {
    const allPropertiesShared = every(PROJECTION_PROPERTIES, prop => !(0,require$vega_util.hasOwnProperty)(first.explicit, prop) && !(0,require$vega_util.hasOwnProperty)(second.explicit, prop) || (0,require$vega_util.hasOwnProperty)(first.explicit, prop) && (0,require$vega_util.hasOwnProperty)(second.explicit, prop) && deepEqual(first.get(prop), second.get(prop)) ? !0 : !1);
  ...
  function assembleScalesForModel(model) {
    return keys(model.component.scales).reduce((scales, channel) => {
      ...
      scale = scale.range;
      isXorY(channel) ? isVgRangeStep(scale) && (scale = {step:{signal:`${name}_step`}}) : (0,require$vega_util.isObject)(scale) && isDataRefDomain(scale) && (scale = {...scale, data:model.lookupDataSource(scale.data)});
      channel = assembleDomain(model, channel);
      if (selectionExtent) {
        const parsedExtent = parseSelectionExtent(model, selectionExtent.param, selectionExtent);
        scaleComponent = {signal:hasContinuousDomain(scaleComponent.get("type")) && (0,require$vega_util.isArray)(channel) && channel[0] > channel[1] ? `isValid(${parsedExtent}) && reverse(${parsedExtent})` : parsedExtent};
      } else {
        scaleComponent = null;
      }
  ...
  function getBinStepSignal(model, channel) {
    ...
    if (fieldDef?.bin) {
      ...
      if ((0,require$vega_util.isObject)(bin) && bin.binned && bin.step !== void 0) {
  ...
  function parseRangeForChannel(channel, model) {
          ...
          if (channelIncompatability) {
            ...
            switch(property) {
              case "range":
                ...
                if ((0,require$vega_util.isArray)(scaleType)) {
                  if (isXorY(channel)) {
                ...
                } else if ((0,require$vega_util.isObject)(scaleType)) {
    ...
    if (isStep(size)) {
      ...
      } else if (isXorYOffset(channel) && model.getScaleComponent(channel === "xOffset" ? "x" : "y").get("type") === "band" && (size = getOffsetStep(size, scaleType))) {
        return makeExplicit(size);
      }
    }
    const {rangeMin, rangeMax} = specifiedScale;
    channel = defaultRange(channel, model);
    return (rangeMin !== void 0 || rangeMax !== void 0) && scaleTypeSupportProperty(scaleType, "rangeMin") && (0,require$vega_util.isArray)(channel) && channel.length === 2 ? makeExplicit([rangeMin ?? channel[0], rangeMax ?? channel[1]]) : makeImplicit(channel);
  }
  function parseScheme(scheme) {
    return !(0,require$vega_util.isString)(scheme) && hasProperty(scheme, "name") ? {scheme:scheme.name, ...omit(scheme, ["name"])} : {scheme};
  }
  ...
  function getPositionStep(step, model, channel) {
    ...
    mergedScaleCmpt = mergedScaleCmpt.get("paddingInner") ?? mergedScaleCmpt.get("padding"), step = step.step, mergedScaleCmpt = isSignalRef(mergedScaleCmpt) ? mergedScaleCmpt.signal : (0,require$vega_util.stringValue)(mergedScaleCmpt), {signal:`${step} * ${model} / (1-${mergedScaleCmpt})`}) : step.step;
  }
  ...
  function getDiscretePositionSize(channel, size, viewConfig) {
    ...
    size = size[channel];
    return size !== void 0 ? size : getViewConfigDiscreteSize(viewConfig, channel);
  }
  function defaultContinuousToDiscreteCount(scaleType, config, domain, channel) {
    switch(scaleType) {
      ...
      case "threshold":
        if (domain !== void 0 && (0,require$vega_util.isArray)(domain)) {
  ...
  function sizeRangeMax(mark, size, model, config) {
    ...
    switch(mark) {
      ...
      case "tick":
        ...
        return (0,require$vega_util.isNumber)(min) ? min - 1 : new SignalRefWrapper(() => `${min.signal} - 1`);
      case "line":
      case "trail":
      case "rule":
      ...
      case "circle":
        ...
        return (0,require$vega_util.isNumber)(pointStep) ? Math.pow(0.95 * pointStep, 2) : new SignalRefWrapper(() => `pow(${0.95} * ${pointStep.signal}, 2)`);
    }
    throw Error(incompatibleChannel("size", mark));
  }
  ...
  function bins(model, fieldDef) {
    ...
    if (isBinned(bin) && isBinParams(bin) && bin.step !== void 0) {
      return {step:bin.step};
    }
  }
  function paddingInner(paddingValue, channel, mark, scaleType, scaleConfig, hasNestedOffsetScale = !1) {
    if (paddingValue === void 0) {
      ...
      if (isXorYOffset(channel) && scaleType === ScaleType.BAND) {
        return scaleConfig.offsetBandPaddingInner;
      }
    }
  }
  function paddingOuter(paddingValue, channel, scaleType, paddingInnerValue, scaleConfig, hasNestedOffsetScale = !1) {
    if (paddingValue === void 0) {
      if (isXorY(channel)) {
  ...
  function scaleType(specifiedScale, channel, fieldDef, mark, hasNestedOffsetScale = !1) {
    mark = defaultType(channel, fieldDef, mark, hasNestedOffsetScale);
    ({type:specifiedScale} = specifiedScale);
    if (!isScaleChannel(channel)) {
      return null;
    }
    if (specifiedScale !== void 0) {
      if (!channelSupportScaleType(channel, specifiedScale)) {
        return warn(`Channel "${channel}" does not work with "${specifiedScale}" scale. We are using "${mark}" scale instead.`), mark;
      }
      if (channel = isFieldDef(fieldDef)) {
        fieldDef = fieldDef.type, channel = !(contains(["ordinal", "nominal"], fieldDef) ? specifiedScale === void 0 || hasDiscreteDomain(specifiedScale) : fieldDef === "temporal" ? contains([ScaleType.TIME, ScaleType.UTC, void 0], specifiedScale) : fieldDef === "quantitative" ? QUANTITATIVE_SCALES.has(specifiedScale) || CONTINUOUS_TO_DISCRETE_SCALES.has(specifiedScale) || specifiedScale === void 0 : 1);
      }
      return channel ? (warn(`FieldDef does not work with "${specifiedScale}" scale. We are using "${mark}" scale instead.`), mark) : specifiedScale;
    }
    return mark;
  }
    ...
    if (isUnitModel(model)) {
      ...
      for (hasNestedOffsetScale of model.children) {
        ...
        for (var channel$jscomp$0 of keys(hasNestedOffsetScale.component.scales)) {
          let $jscomp$inline_5300, $jscomp$inline_5301;
          ($jscomp$inline_5300 = resolve.scale)[$jscomp$inline_5301 = channel$jscomp$0] ?? ($jscomp$inline_5300[$jscomp$inline_5301] = defaultScaleResolve(channel$jscomp$0, model));
    ...
    if (child.component.axes[channel]) {
      ...
      if (resolve.axis[channel] === "shared") {
        ...
        for (const axisComponent of child.component.axes[channel]) {
          ...
          let $jscomp$logical$assign$tmpm285488632$8, $jscomp$logical$assign$tmpindexm285488632$8;
          ($jscomp$logical$assign$tmpm285488632$8 = layoutHeader)[$jscomp$logical$assign$tmpindexm285488632$8 = channel] ?? ($jscomp$logical$assign$tmpm285488632$8[$jscomp$logical$assign$tmpindexm285488632$8] = [makeHeaderComponent(model, headerChannel, !1)]);
  ...
  function parseAxis(channel, model) {
    ...
    for (const property of AXIS_COMPONENT_PROPERTIES) {
      if (orient = property in axisRules ? axisRules[property](fieldOrDatumDef) : (0,require$vega_util.hasOwnProperty)(AXIS_PROPERTIES_INDEX, property) ? axis[property] : void 0, scaleType = orient !== void 0, disable = isExplicit(orient, property, axis, model, channel), scaleType && disable) {
        axisComponent.set(property, orient, disable);
      } else {
        const {configValue, configFrom} = (0,require$vega_util.hasOwnProperty)(AXIS_PROPERTIES_INDEX, property) && property !== "values" ? getAxisConfig(property, config.style, axis.style, axisConfigs) : {};
  ...
  function initLayoutSize({encoding, size}) {
    for (const channel of POSITION_SCALE_CHANNELS) {
      ...
      isStep(size[sizeType]) && isContinuousFieldOrDatumDef(encoding[channel]) && (delete size[sizeType], warn(stepDropped(sizeType)));
    }
    return size;
  }
  ...
  function getGroupsForStackedBarWithCornerRadius(model) {
    const [mark] = getMarkGroup(model, {fromPrefix:"stack_group_"}), fieldScale = model.scaleName(model.stack.fieldChannel), stackField = (opt = {}) => model.vgField(model.stack.fieldChannel, opt);
    ...
    model.stack.fieldChannel === "x" ? (stackFieldGroup = {...pick(mark.encode.update, ["y", "yc", "y2", "height", ...VG_CORNERRADIUS_CHANNELS]), x:{signal:stackFieldGroup("min", "datum")}, x2:{signal:stackFieldGroup("max", "datum")}, clip:{value:!0}}, innerGroupUpdate = {x:{field:{group:"x"}, mult:-1}, height:{field:{group:"height"}}}, mark.encode.update = {...omit(mark.encode.update, ["y", "yc", "y2"]), height:{field:{group:"height"}}}) : (stackFieldGroup = {...pick(mark.encode.update, ["x", "xc", 
    "x2", "width"]), y:{signal:stackFieldGroup("min", "datum")}, y2:{signal:stackFieldGroup("max", "datum")}, clip:{value:!0}}, innerGroupUpdate = {y:{field:{group:"y"}, mult:-1}, width:{field:{group:"width"}}}, mark.encode.update = {...omit(mark.encode.update, ["x", "xc", "x2"]), width:{field:{group:"width"}}});
  ...
  function getSort(model) {
    ...
    if (!(!(0,require$vega_util.isArray)(model) && isValueDef(model) && isNullOrFalse(model.value) || !model && isNullOrFalse(getMarkPropOrConfig("order", markDef, config)))) {
      if (((0,require$vega_util.isArray)(model) || isFieldDef(model)) && !stack) {
        return sortParams(model, {expr:"datum"});
      }
      if (isPathMark(mark) && (model = markDef.orient === "horizontal" ? "y" : "x", isFieldDef(encoding[model]))) {
        return {field:model};
      }
    }
  }
  function getMarkGroup(model, opt = {fromPrefix:""}) {
    const {mark, markDef, encoding, config} = model, clip = getFirstDefined(markDef.clip, scaleClip(model), projectionClip(model)), style = [].concat(markDef.type, markDef.style ?? []), key = encoding.key, sort = getSort(model), interactive = interactiveFlag(model);
    if (interactive && Object.values(model.component.selection).some(s => s.type === "point" && !s.bind && s.on !== "pointerover")) {
      var $jscomp$logical$assign$tmpm285488632$9;
      ($jscomp$logical$assign$tmpm285488632$9 = model.markDef).cursor ?? ($jscomp$logical$assign$tmpm285488632$9.cursor = "pointer");
    }
    $jscomp$logical$assign$tmpm285488632$9 = getMarkPropOrConfig("aria", markDef, config);
    const postEncodingTransform = markCompiler[mark].postEncodingTransform ? markCompiler[mark].postEncodingTransform(model) : null;
    return [{name:model.getName("marks"), type:markCompiler[mark].vgMark, ...(clip ? {clip} : {}), ...(style ? {style} : {}), ...(key ? {key:key.field} : {}), ...(sort ? {sort} : {}), ...(interactive ? interactive : {}), ...($jscomp$logical$assign$tmpm285488632$9 === !1 ? {aria:$jscomp$logical$assign$tmpm285488632$9} : {}), from:{data:opt.fromPrefix + model.requestDataName(DataSourceType.Main)}, encode:{update:markCompiler[mark].encodeEntry(model)}, ...(postEncodingTransform ? {transform:postEncodingTransform} : 
    {})}];
  }
  function scaleClip(model) {
    const xScale = model.getScaleComponent("x");
    model = model.getScaleComponent("y");
    return xScale?.get("selectionExtent") || model?.get("selectionExtent") ? !0 : void 0;
  }
  function projectionClip(model) {
    return (model = model.component.projection) && !model.isFit ? !0 : void 0;
  }
  function interactiveFlag(model) {
    ...
    let parentCount = unitCount, parent = model.parent;
    for (; parent && parentCount === 0;) {
      parentCount = keys(parent.component.selection).length, parent = parent.parent;
    }
    return parentCount ? {interactive:unitCount > 0 || model.mark === "geoshape" || !!model.encoding.tooltip || !!model.markDef.tooltip} : null;
  }
  ...
  function compile(inputSpec, opt = {}) {
    ...
    try {
      const config = initConfig((0,require$vega_util.mergeConfig)(opt.config, inputSpec.config)), spec = normalize(inputSpec, config), model = buildModel(spec, null, "", void 0, config);
      model.parse();
      var data = model.component.data;
      checkLinks(data.sources);
      let firstPassCounter = 0, secondPassCounter = 0;
      ...
      data = assembleTopLevelModel;
      var autosize = spec.autosize, width = model.component.layoutSize.get("width"), height = model.component.layoutSize.get("height");
      autosize === void 0 ? (autosize = {type:"pad"}, model.hasAxisOrientSignalRef() && (autosize.resize = !0)) : (0,require$vega_util.isString)(autosize) && (autosize = {type:autosize});
      if (width && height && ["fit", "fit-x", "fit-y"].includes(autosize.type)) {
        if (width === "step" && height === "step") {
          warn(droppingFit()), autosize.type = "pad";
        } else if (width === "step" || height === "step") {
          height = width === "step" ? "width" : "height";
          warn(droppingFit(getPositionScaleChannel(height)));
          width = autosize;
          var JSCompiler_inline_result = (height = height === "width" ? "height" : "width", `fit-${getPositionScaleChannel(height)}`);
          width.type = JSCompiler_inline_result;
        }
      }
      ...
      return {spec:data(model, JSCompiler_inline_result$jscomp$0, inputSpec.datasets, inputSpec.usermeta), normalized:spec};
    } finally {
  ...
  function assembleTopLevelModel(model, topLevelProperties, datasets = {}, usermeta) {
    ...
    return {$schema:"https://vega.github.io/schema/vega/v6.json", ...(model.description ? {description:model.description} : {}), ...otherTopLevelProps, ...(title ? {title} : {}), ...(style ? {style} : {}), ...(encodeEntry ? {encode:{update:encodeEntry}} : {}), data:datasets, ...(projections.length > 0 ? {projections} : {}), ...model.assembleGroup([...layoutSignals, ...model.assembleSelectionTopLevelSignals([]), ...assembleParameterSignals(params)]), ...(vgConfig ? {config:vgConfig} : {}), ...(usermeta ? 
    {usermeta} : {})};
  }
  Object.defineProperties(exports, {__esModule:{enumerable:!0, value:!0}, accessPathDepth:{enumerable:!0, get:function() {
    return accessPathDepth;
  }}, accessPathWithDatum:{enumerable:!0, get:function() {
    return accessPathWithDatum;
  }}, accessWithDatumToUnescapedPath:{enumerable:!0, get:function() {
    return accessWithDatumToUnescapedPath;
  }}, compile:{enumerable:!0, get:function() {
    return compile;
  }}, contains:{enumerable:!0, get:function() {
    return contains;
  }}, deepEqual:{enumerable:!0, get:function() {
    return deepEqual;
  }}, deleteNestedProperty:{enumerable:!0, get:function() {
    return deleteNestedProperty;
  }}, duplicate:{enumerable:!0, get:function() {
    return duplicate;
  }}, entries:{enumerable:!0, get:function() {
    return entries$1;
  }}, every:{enumerable:!0, get:function() {
    return every;
  }}, fieldIntersection:{enumerable:!0, get:function() {
    return fieldIntersection;
  }}, flatAccessWithDatum:{enumerable:!0, get:function() {
    return flatAccessWithDatum;
  }}, getFirstDefined:{enumerable:!0, get:function() {
    return getFirstDefined;
  }}, hasIntersection:{enumerable:!0, get:function() {
    return hasIntersection;
  }}, hasProperty:{enumerable:!0, get:function() {
    return hasProperty;
  }}, hash:{enumerable:!0, get:function() {
    return hash;
  }}, internalField:{enumerable:!0, get:function() {
    ...
    return isEqual;
  }}, isInternalField:{enumerable:!0, get:function() {
    return isInternalField;
  }}, isNullOrFalse:{enumerable:!0, get:function() {
    return isNullOrFalse;
  }}, isNumeric:{enumerable:!0, get:function() {
    return isNumeric;
  }}, isPrimitive:{enumerable:!0, get:function() {
    return isPrimitive;
  }}, keys:{enumerable:!0, get:function() {
    return keys;
  }}, logicalExpr:{enumerable:!0, get:function() {
    return logicalExpr;
  }}, mergeDeep:{enumerable:!0, get:function() {
    return mergeDeep;
  }}, never:{enumerable:!0, get:function() {
    return never;
  }}, normalize:{enumerable:!0, get:function() {
    return normalize;
  }}, normalizeAngle:{enumerable:!0, get:function() {
    return normalizeAngle;
  }}, omit:{enumerable:!0, get:function() {
    return omit;
  }}, pick:{enumerable:!0, get:function() {
    return pick;
  }}, prefixGenerator:{enumerable:!0, get:function() {
    return prefixGenerator;
  }}, removePathFromField:{enumerable:!0, get:function() {
    return removePathFromField;
  }}, replaceAll:{enumerable:!0, get:function() {
    return replaceAll;
  }}, replacePathInField:{enumerable:!0, get:function() {
    return replacePathInField;
  }}, resetIdCounter:{enumerable:!0, get:function() {
    return resetIdCounter;
  }}, setEqual:{enumerable:!0, get:function() {
    return setEqual;
  }}, some:{enumerable:!0, get:function() {
    return some;
  }}, stringify:{enumerable:!0, get:function() {
    return stringify;
  }}, titleCase:{enumerable:!0, get:function() {
    return titleCase;
  }}, unescapeSingleQuoteAndPathDot:{enumerable:!0, get:function() {
    return unescapeSingleQuoteAndPathDot;
  }}, unique:{enumerable:!0, get:function() {
    return unique;
  }}, uniqueId:{enumerable:!0, get:function() {
    return uniqueId;
  }}, vals:{enumerable:!0, get:function() {
    return vals;
  }}, varName:{enumerable:!0, get:function() {
    return varName;
  }}, version:{enumerable:!0, get:function() {
    return "6.4.3";
  }}});
  var require$vega_util = require("module$node_modules$vega_util$build$index"), require$vega = require("module$node_modules$vega$build$vega_module"), require$vega_event_selector = require("module$node_modules$vega_event_selector$build$vega_event_selector"), require$vega_expression = require("module$node_modules$vega_expression$build$vega_expression");
  ...
  lineHeight:1, cursor:1, href:1, tooltip:1, cornerRadius:1, cornerRadiusTopLeft:1, cornerRadiusTopRight:1, cornerRadiusBottomLeft:1, cornerRadiusBottomRight:1, aspect:1, width:1, height:1, url:1, smooth:1}), VG_MARK_INDEX = {arc:1, area:1, group:1, image:1, line:1, path:1, rect:1, rule:1, shape:1, symbol:1, text:1, trail:1}, VG_CORNERRADIUS_CHANNELS = ["cornerRadius", "cornerRadiusTopLeft", "cornerRadiusTopRight", "cornerRadiusBottomLeft", "cornerRadiusBottomRight"], main = (0,require$vega_util.logger)(require$vega_util.Warn);
  let current = main;
  ...
  {"year-month":"%b %Y ", "year-month-date":"%b %d, %Y "}, DATE_PARTS = {year:1, month:1, date:1, hours:1, minutes:1, seconds:1, milliseconds:1}, ScaleType = {LINEAR:"linear", LOG:"log", POW:"pow", SQRT:"sqrt", TIME:"time", UTC:"utc", POINT:"point", BAND:"band"}, SCALE_CATEGORY_INDEX = {linear:"numeric", log:"numeric", pow:"numeric", sqrt:"numeric", symlog:"numeric", identity:"numeric", sequential:"numeric", time:"time", utc:"time", ordinal:"ordinal", "bin-ordinal":"bin-ordinal", point:"ordinal-position", 
  band:"ordinal-position", quantile:"discretizing", quantize:"discretizing", threshold:"discretizing"}, SCALE_PRECEDENCE_INDEX = {linear:0, log:1, pow:1, sqrt:1, symlog:1, identity:1, sequential:1, time:0, utc:0, point:10, band:11, ordinal:0, "bin-ordinal":0, quantile:0, quantize:0, threshold:0}, QUANTITATIVE_SCALES = new Set(["linear", "log", "pow", "sqrt", "symlog"]), CONTINUOUS_TO_CONTINUOUS_SCALES = new Set([...QUANTITATIVE_SCALES, "time", "utc"]), CONTINUOUS_TO_DISCRETE_SCALES = new Set(["quantile", 
  "quantize", "threshold"]), CONTINUOUS_DOMAIN_SCALES = new Set([...CONTINUOUS_TO_CONTINUOUS_SCALES, ...CONTINUOUS_TO_DISCRETE_SCALES, "sequential", "identity"]), DISCRETE_DOMAIN_SCALES = new Set(["ordinal", "bin-ordinal", "point", "band"]), {type, domain:domain$1, range, rangeMax, rangeMin, scheme, ...NON_TYPE_DOMAIN_RANGE_VEGA_SCALE_PROPERTY_INDEX} = {type:1, domain:1, domainMax:1, domainMin:1, domainMid:1, domainRaw:1, align:1, range:1, rangeMax:1, rangeMin:1, scheme:1, bins:1, reverse:1, round:1, 
  ...
  Mark.line, POINT = Mark.point, RECT = Mark.rect, RULE = Mark.rule, TEXT = Mark.text, TICK = Mark.tick, TRAIL = Mark.trail, CIRCLE = Mark.circle, SQUARE = Mark.square, GEOSHAPE = Mark.geoshape, PRIMITIVE_MARKS = new Set(keys(Mark)), FILL_STROKE_CONFIG = "stroke strokeWidth strokeDash strokeDashOffset strokeOpacity strokeJoin strokeMiterLimit fill fillOpacity".split(" "), VL_ONLY_MARK_CONFIG_PROPERTIES = keys({color:1, filled:1, invalid:1, order:1, radius2:1, theta2:1, timeUnitBandSize:1, timeUnitBandPosition:1}), 
  VL_ONLY_RECT_CONFIG = ["binSpacing", "continuousBandSize", "discreteBandSize", "minBandSize"], VL_ONLY_MARK_SPECIFIC_CONFIG_PROPERTY_INDEX = {area:["line", "point"], bar:VL_ONLY_RECT_CONFIG, rect:VL_ONLY_RECT_CONFIG, line:["point"], tick:["bandSize", "thickness", ...VL_ONLY_RECT_CONFIG]}, MARK_CONFIGS = keys({mark:1, arc:1, area:1, bar:1, circle:1, image:1, line:1, point:1, rect:1, rule:1, square:1, text:1, tick:1, trail:1, geoshape:1}), BAR_CORNER_RADIUS_INDEX = {horizontal:["cornerRadiusTopRight", 
  ...
  COMMON_AXIS_PROPERTIES_INDEX = {orient:1, aria:1, bandPosition:1, description:1, domain:1, domainCap:1, domainColor:1, domainDash:1, domainDashOffset:1, domainOpacity:1, domainWidth:1, format:1, formatType:1, grid:1, gridCap:1, gridColor:1, gridDash:1, gridDashOffset:1, gridOpacity:1, gridWidth:1, labelAlign:1, labelAngle:1, labelBaseline:1, labelBound:1, labelColor:1, labelFlush:1, labelFlushOffset:1, labelFont:1, labelFontSize:1, labelFontStyle:1, labelFontWeight:1, labelLimit:1, labelLineHeight:1, 
  labelOffset:1, labelOpacity:1, labelOverlap:1, labelPadding:1, labels:1, labelSeparation:1, maxExtent:1, minExtent:1, offset:1, position:1, tickBand:1, tickCap:1, tickColor:1, tickCount:1, tickDash:1, tickDashOffset:1, tickExtra:1, tickMinStep:1, tickOffset:1, tickOpacity:1, tickRound:1, ticks:1, tickSize:1, tickWidth:1, title:1, titleAlign:1, titleAnchor:1, titleAngle:1, titleBaseline:1, titleColor:1, titleFont:1, titleFontSize:1, titleFontStyle:1, titleFontWeight:1, titleLimit:1, titleLineHeight:1, 
  titleOpacity:1, titlePadding:1, titleX:1, titleY:1, translate:1, values:1, zindex:1}, AXIS_PROPERTIES_INDEX = {...COMMON_AXIS_PROPERTIES_INDEX, style:1, labelExpr:1, encoding:1}, AXIS_CONFIGS = keys({axis:1, axisBand:1, axisBottom:1, axisDiscrete:1, axisLeft:1, axisPoint:1, axisQuantitative:1, axisRight:1, axisTemporal:1, axisTop:1, axisX:1, axisXBand:1, axisXDiscrete:1, axisXPoint:1, axisXQuantitative:1, axisXTemporal:1, axisY:1, axisYBand:1, axisYDiscrete:1, axisYPoint:1, axisYQuantitative:1, 
  axisYTemporal:1});
  ...
  headerColumn:1, headerFacet:1}), LEGEND_SCALE_CHANNELS = "size shape fill stroke strokeDash strokeWidth opacity".split(" "), COMPOSITION_LAYOUT_PROPERTIES = keys({align:1, bounds:1, center:1, columns:1, spacing:1}), defaultConfig = {background:"white", padding:5, timeFormat:"%b %d, %Y", countTitle:"Count of Records", view:{continuousWidth:300, continuousHeight:300, step:20}, mark:{color:"#4c78a8", invalid:"break-paths-show-path-domains", timeUnitBandSize:1}, arc:{}, area:{}, bar:defaultBarConfig, 
  ...
  class PathOverlayNormalizer {
    ...
    run(spec, normParams, normalize) {
      ...
      var JSCompiler_inline_result = {...(markDef.type === "area" && getMarkPropOrConfig("opacity", markDef, config) == void 0 && getMarkPropOrConfig("fillOpacity", markDef, config) == void 0 ? {opacity:0.7} : {}), ...markDef};
      const {point:_point, line:_line, ...mark$jscomp$0} = JSCompiler_inline_result;
      JSCompiler_inline_result = keys(mark$jscomp$0).length > 1 ? mark$jscomp$0 : mark$jscomp$0.type;
  ...
  class RuleForRangedLineNormalizer {
    ...
    run(spec, params, normalize) {
      ...
      return normalize({...spec, mark:(0,require$vega_util.isObject)(mark) ? {...mark, type:"rule"} : "rule"}, params);
    }
  }
  class CoreNormalizer extends SpecMapper {
    ...
    mapRepeat(spec, params) {
      return !(0,require$vega_util.isArray)(spec.repeat) && hasProperty(spec.repeat, "layer") ? this.mapLayerRepeat(spec, params) : this.mapNonLayerRepeat(spec, params);
    }
    ...
    mapNonLayerRepeat(spec, params) {
      ...
      !(0,require$vega_util.isArray)(repeat) && spec.columns && (spec = omit(spec, ["columns"]), warn(columnsNotSupportByRowCol("repeat")));
      const concat = [], {repeater = {}, repeaterPrefix = ""} = params, row = !(0,require$vega_util.isArray)(repeat) && repeat.row || [repeater ? repeater.row : null], column = !(0,require$vega_util.isArray)(repeat) && repeat.column || [repeater ? repeater.column : null];
      var repeatValues = (0,require$vega_util.isArray)(repeat) && repeat || [repeater ? repeater.repeat : null];
      for (const repeatValue of repeatValues) {
        for (const rowValue of row) {
          for (const columnValue of column) {
            var childRepeater = {repeat:repeatValue, row:rowValue, column:columnValue, layer:repeater.layer};
            repeatValues = `${(childSpec.name ? `${childSpec.name}_` : "") + repeaterPrefix}child__${(0,require$vega_util.isArray)(repeat) ? `${varName(repeatValue)}` : (repeat.row ? `row_${varName(rowValue)}` : "") + (repeat.column ? `column_${varName(columnValue)}` : "")}`;
      ...
      spec = (0,require$vega_util.isArray)(repeat) ? spec.columns : repeat.column ? repeat.column.length : 1;
        ...
        for (const channel of ["row", "column"]) {
          ...
          if (def) {
            ...
            for (const prop of ["align", "center", "spacing"]) {
              if (def[prop] !== void 0) {
                let $jscomp$logical$assign$tmpm285488632$10, $jscomp$logical$assign$tmpindexm285488632$10;
                ($jscomp$logical$assign$tmpm285488632$10 = layout)[$jscomp$logical$assign$tmpindexm285488632$10 = prop] ?? ($jscomp$logical$assign$tmpm285488632$10[$jscomp$logical$assign$tmpindexm285488632$10] = {});
    ...
    mapLayer(spec, {parentEncoding, parentProjection, ...otherParams}) {
      ...
      parentEncoding = {...otherParams, parentEncoding:mergeEncoding({parentEncoding, encoding, layer:!0}), parentProjection:mergeProjection({parentProjection, projection})};
      return super.mapLayer({...rest, ...(spec.name ? {name:[parentEncoding.repeaterPrefix, spec.name].filter(n => n).join("_")} : {})}, parentEncoding);
    }
  }
  class SelectionCompatibilityNormalizer extends SpecMapper {
    ...
    mapUnit(spec, normParams) {
      ...
      return selection ? {...rest, params:entries$1(selection).map(([name, selDef]) => {
      ...
      for (const selection of selections) {
        if (selection.views && selection.views.length) {
          for (const view of selection.views) {
            ((0,require$vega_util.isString)(view) && (view === spec.name || path.includes(view)) || (0,require$vega_util.isArray)(view) && view.map(v => path.indexOf(v)).every((v, i, arr) => v !== -1 && (i === 0 || v > arr[i - 1]))) && normParams.push(selection);
          }
        } else {
  ...
  class AncestorParse extends Split {
    ...
    implicit;
    parseNothing;
    constructor(explicit = {}, implicit = {}, parseNothing = !1) {
    ...
    assemble() {
      ...
      for (const f of vals(this.timeUnits)) {
        ...
        if (f.as !== void 0) {
          ...
          ({field:startEnd} = f);
          startEnd = unescapeSingleQuoteAndPathDot(startEnd);
  ...
  selCmpt.bind && selCmpt.bind === "scales", parse:(model, selCmpt) => {
    ...
    if (update.includes("vlSelectionResolve")) {
      model.update = `{${bound.map(proj => `${(0,require$vega_util.stringValue)(replacePathInField(proj.field))}: ${proj.signals.data}`).join(", ")}}`;
    } else {
      for (const proj of bound) {
        const mapping = `${(0,require$vega_util.stringValue)(replacePathInField(proj.field))}: ${proj.signals.data}`;
    ...
    selCmpt = {name:model.getName("voronoi"), type:"path", interactive:!0, aria:!1, from:{data:model.getName("marks")}, encode:{update:{fill:{value:"transparent"}, strokeWidth:{value:0.35}, stroke:{value:"transparent"}, isVoronoi:{value:!0}, ...tooltip(model, {reactiveGeom:!0})}}, transform:[{type:"voronoi", x:{expr:x || !y ? "datum.datum.x || 0" : "0"}, y:{expr:y || !x ? "datum.datum.y || 0" : "0"}, size:[model.getSizeSignalRef("width"), model.getSizeSignalRef("height")]}]};
    ...
    const bind = selCmpt.bind, init = selCmpt.init?.[0], datum = nearest.defined(selCmpt) ? "(item().isVoronoi ? datum.datum : datum)" : "datum";
    model.items.forEach((p, i) => {
      const sgname = varName(`${name}_${p.field}`);
      signals.filter(s => s.name === sgname).length || signals.unshift({name:sgname, ...(init ? {init:assembleInit(init[i])} : {value:null}), on:selCmpt.events ? [{events:selCmpt.events, update:`datum && item().mark.marktype !== 'group' ? ${datum}[${(0,require$vega_util.stringValue)(p.field)}] : null`}] : [], bind:bind[p.field] ?? bind[p.channel] ?? bind});
    });
    return signals;
  }, signals:(model, selCmpt, signals) => {
    const name = selCmpt.name;
    ...
    model.select = (0,require$vega_util.isString)(model.select) ? {type:model.select, toggle:selCmpt.toggle} : {...model.select, toggle:selCmpt.toggle};
    disableDirectManipulation(selCmpt, model);
    if ((0,require$vega.isObject)(selDef.select) && (selDef.select.on || selDef.select.clear)) {
      for (const evt of selCmpt.events) {
        evt.filter = (0,require$vega_util.array)(evt.filter ?? []), evt.filter.includes('event.item \x26\x26 indexof(event.item.mark.role, "legend") \x3c 0') || evt.filter.push('event.item \x26\x26 indexof(event.item.mark.role, "legend") \x3c 0');
      }
    }
    selDef = isLegendStreamBinding(selCmpt.bind) ? selCmpt.bind.legend : "click";
    selDef = (0,require$vega_util.isString)(selDef) ? (0,require$vega_event_selector.parseSelector)(selDef, "view") : (0,require$vega_util.array)(selDef);
    ...
    selCmpt.project.hasSelectionId ? update += `${"_vgsid_"}: ${"(item().isVoronoi ? datum.datum : datum)"}[${(0,require$vega_util.stringValue)("_vgsid_")}]` : isTimerSelection(selCmpt) ? update += `fields: ${fieldsSg}, values: [${"anim_value"} ? ${"anim_value"} : ${"min_extent"}]` : (project = project.items.map(p => model.fieldDef(p.channel)?.bin ? `[${"(item().isVoronoi ? datum.datum : datum)"}[${(0,require$vega_util.stringValue)(model.vgField(p.channel, {}))}], ` + `${"(item().isVoronoi ? datum.datum : datum)"}[${(0,require$vega_util.stringValue)(model.vgField(p.channel, 
    {binSuffix:"end"}))}]]` : `${"(item().isVoronoi ? datum.datum : datum)"}[${(0,require$vega_util.stringValue)(p.field)}]`).join(", "), update += `fields: ${fieldsSg}, values: [${project}]`);
    ...
    model.hasProjection && (model = {...((0,require$vega.isObject)(selDef.select) ? selDef.select : {}), fields:["_vgsid_"]}, model.encodings || (model.encodings = selDef.value ? keys(selDef.value) : ["longitude", "latitude"]), selDef.select = {type:"interval", ...model});
    if (selCmpt.translate && !scaleBindings.defined(selCmpt)) {
      selDef = `!event.item || event.item.mark.name !== ${(0,require$vega_util.stringValue)(selCmpt.name + "_brush")}`;
      for (const evt of selCmpt.events) {
        if (!evt.between) {
          warn(`${evt} is not an ordered event stream for interval selections.`);
          continue;
        }
        let $jscomp$logical$assign$tmpm285488632$14;
        selCmpt = (0,require$vega_util.array)(($jscomp$logical$assign$tmpm285488632$14 = evt.between[0]).filter ?? ($jscomp$logical$assign$tmpm285488632$14.filter = []));
    ...
    if (model.hasProjection) {
      var projection = (0,require$vega_util.stringValue)(model.projectionName());
      const centerSg = model.projectionName() + "_center", {x, y} = selCmpt.project.hasChannel;
      var xvname = x?.signals.visual;
      const yvname = y?.signals.visual;
      var xinit = x ? init?.[x.index] : `${centerSg}[0]`;
      ...
      name = `intersect(${xvname}, {markname: ${(0,require$vega_util.stringValue)(model.getName("marks"))}}, unit.mark)`;
    ...
    scaleBindings.defined(selCmpt) || (projection = name + "_scale_trigger", xinit = channels.map(proj => {
      ...
      proj = (0,require$vega_util.stringValue)(model.scaleName(channel));
    ...
    const name = selCmpt.name, {x, y} = selCmpt.project.hasChannel, xvname = x?.signals.visual, yvname = y?.signals.visual, store = `data(${(0,require$vega_util.stringValue)(selCmpt.name + "_store")})`;
    ...
    const init = selDef.value !== void 0 ? (0,require$vega_util.array)(selDef.value) : null;
    let {fields, encodings} = (0,require$vega_util.isObject)(selDef.select) ? selDef.select : {};
    if (!fields && !encodings && init) {
      for (var initVal of init) {
        if ((0,require$vega_util.isObject)(initVal)) {
          for (const key of keys(initVal)) {
            (0,require$vega_util.hasOwnProperty)(SINGLE_DEF_UNIT_CHANNEL_INDEX, key) ? (encodings ||= []).push(key) : type === "interval" ? (warn('Interval selections should be initialized using "x", "y", "longitude", or "latitude" keys.'), encodings = cfg.encodings) : (fields ??= []).push(key);
          }
        }
      }
    }
    ...
    for (const channel of encodings ?? []) {
      ...
      "R" : cfg.bin ? "R-RE" : "E", cfg = {field:selDef, channel, type:cfg, index:proj.items.length}, cfg.signals = {...signalName(cfg, "data"), ...signalName(cfg, "visual")}, proj.items.push(parsed[selDef] = cfg), proj.hasField[selDef] = parsed[selDef], proj.hasSelectionId = proj.hasSelectionId || selDef === "_vgsid_", (0,require$vega_util.hasOwnProperty)(GEO_POSIITON_CHANNEL_INDEX, channel) ? (cfg.geoChannel = channel, cfg.channel = getPositionChannelFromLatLong(channel), proj.hasChannel[cfg.channel] = 
      parsed[selDef]) : proj.hasChannel[channel] = parsed[selDef])) : warn(cannotProjectOnChannelWithoutField(channel))) : warn(cannotProjectOnChannelWithoutField(channel));
    }
    ...
    init && (selCmpt.init = init.map(v => proj.items.map(p => (0,require$vega_util.isObject)(v) ? v[p.geoChannel || p.channel] !== void 0 ? v[p.geoChannel || p.channel] : v[p.field] : v)));
    ...
    selCmpt.clear && (selCmpt.clear = (0,require$vega_util.isString)(selCmpt.clear) ? (0,require$vega_event_selector.parseSelector)(selCmpt.clear, "view") : selCmpt.clear);
  }, topLevelSignals:(model, selCmpt, signals) => {
    ...
    let events = (0,require$vega_event_selector.parseSelector)(selCmpt.translate, "scope");
    ...
    const name = selCmpt.name, boundScales = scaleBindings.defined(selCmpt), delta = name + "_zoom_delta", {x, y} = selCmpt.project.hasChannel, sx = (0,require$vega_util.stringValue)(model.scaleName("x")), sy = (0,require$vega_util.stringValue)(model.scaleName("y"));
    let events = (0,require$vega_event_selector.parseSelector)(selCmpt.zoom, "scope");
  ...
  const axisRules = {scale:({model, channel}) => model.scaleName(channel), format:({format}) => format, formatType:({formatType}) => formatType, grid:({fieldOrDatumDef, axis, scaleType}) => {
    var JSCompiler_temp;
    ...
    channel = channel === "x" ? "y" : "x";
    model = model.getScaleComponent(channel) ? model.scaleName(channel) : void 0;
    return model;
  }, labelAlign:({axis, labelAngle, orient, channel}) => axis.labelAlign || defaultLabelAlign(labelAngle, orient, channel), labelAngle:({labelAngle}) => labelAngle, labelBaseline:({axis, labelAngle, orient, channel}) => axis.labelBaseline || defaultLabelBaseline(labelAngle, orient, channel), labelFlush:({axis, fieldOrDatumDef, channel}) => {
    fieldOrDatumDef = (axis = axis.labelFlush) != null ? axis : channel === "x" && contains(["quantitative", "temporal"], fieldOrDatumDef.type) ? !0 : void 0;
    return fieldOrDatumDef;
  }, labelOverlap:({axis, fieldOrDatumDef, scaleType}) => {
    if ((axis = axis.labelOverlap) != null) {
      scaleType = axis;
    } else {
      axis = fieldOrDatumDef.type;
      var hasTimeUnit = isFieldDef(fieldOrDatumDef) && !!fieldOrDatumDef.timeUnit;
      fieldOrDatumDef = isFieldDef(fieldOrDatumDef) ? fieldOrDatumDef.sort : void 0;
      scaleType = hasTimeUnit && !(0,require$vega_util.isObject)(fieldOrDatumDef) || axis !== "nominal" && axis !== "ordinal" ? scaleType === "log" || scaleType === "symlog" ? "greedy" : !0 : void 0;
    }
    return scaleType;
  }, orient:({orient}) => orient, tickCount:({channel, model, axis, fieldOrDatumDef, scaleType}) => {
    model = (channel = channel === "x" ? "width" : channel === "y" ? "height" : void 0) ? model.getSizeSignalRef(channel) : void 0;
    return axis.tickCount ?? defaultTickCount({fieldOrDatumDef, scaleType, size:model, values:axis.values});
  }, tickMinStep:({axis, format, fieldOrDatumDef}) => axis.tickMinStep ?? defaultTickMinStep({format, fieldOrDatumDef}), title:({axis, model, channel}) => {
    if (axis.title !== void 0) {
      return axis.title;
    }
    axis = getFieldDefTitle(model, channel);
    if (axis !== void 0) {
      return axis;
    }
    axis = model.typedFieldDef(channel);
    model = model.fieldDef(channel === "x" ? "x2" : "y2");
    return mergeTitleFieldDefs(axis ? [toFieldDefBase(axis)] : [], isFieldDef(model) ? [toFieldDefBase(model)] : []);
  }, values:({axis, fieldOrDatumDef}) => {
    axis = axis.values;
    fieldOrDatumDef = (0,require$vega_util.isArray)(axis) ? valueArray(fieldOrDatumDef, axis) : isSignalRef(axis) ? axis : void 0;
    return fieldOrDatumDef;
  }, zindex:({axis, fieldOrDatumDef, mark}) => {
    fieldOrDatumDef = (axis = axis.zindex) != null ? axis : mark === "rect" && isDiscrete(fieldOrDatumDef) ? 1 : 0;
    return fieldOrDatumDef;
  }};
  ...
  const legendEncodeRules = {symbols:function(symbolsSpec, {fieldOrDatumDef, model, channel, legendCmpt, legendType}) {
    if (legendType === "symbol") {
      var {markDef, encoding, config, mark} = model;
      legendType = markDef.filled && mark !== "trail";
      var e = {};
      for (var property of FILL_STROKE_CONFIG) {
        var value = getMarkConfig(property, model.markDef, model.config);
        value !== void 0 && (e[property] = signalOrValueRef(value));
      }
      property = {...e, ...color(model, {filled:legendType})};
      ...
      property.fill && (channel === "fill" || legendType && channel === "color" ? delete property.fill : hasProperty(property.fill, "field") ? symbolFillColor ? delete property.fill : (property.fill = signalOrValueRef(config.legend.symbolBaseFillColor ?? "black"), property.fillOpacity = signalOrValueRef(e ?? 1)) : (0,require$vega_util.isArray)(property.fill) && (symbolFillColor = getFirstConditionValue(encoding.fill ?? encoding.color) ?? markDef.fill ?? (legendType && markDef.color)) && (property.fill = 
      signalOrValueRef(symbolFillColor)));
      property.stroke && (channel === "stroke" || !legendType && channel === "color" ? delete property.stroke : hasProperty(property.stroke, "field") || value ? delete property.stroke : (0,require$vega_util.isArray)(property.stroke) && (legendType = getFirstDefined(getFirstConditionValue(encoding.stroke || encoding.color), markDef.stroke, legendType ? markDef.color : void 0)) && (property.stroke = {value:legendType}));
      channel !== "opacity" && ((fieldOrDatumDef = isFieldDef(fieldOrDatumDef) && selectedCondition(model, legendCmpt, fieldOrDatumDef)) ? property.opacity = [{test:fieldOrDatumDef, ...signalOrValueRef(e ?? 1)}, signalOrValueRef(config.legend.unselectedOpacity)] : e && (property.opacity = signalOrValueRef(e)));
      property = {...property, ...symbolsSpec};
      return isEmpty(property) ? void 0 : property;
    }
  }, gradient:function(gradientSpec, {model, legendType, legendCmpt}) {
    if (legendType === "gradient") {
      var {config, markDef, encoding} = model;
      model = {};
      if (legendCmpt = (legendCmpt.get("gradientOpacity") ?? config.legend.gradientOpacity) === void 0 ? getMaxValue(encoding.opacity) || markDef.opacity : void 0) {
        model.opacity = signalOrValueRef(legendCmpt);
      }
      model = {...model, ...gradientSpec};
      return isEmpty(model) ? void 0 : model;
    }
  }, labels:function(specifiedlabelsSpec, {fieldOrDatumDef, model, channel, legendCmpt}) {
    var legend = model.legend(channel) || {};
    channel = model.config;
    model = (model = isFieldDef(fieldOrDatumDef) ? selectedCondition(model, legendCmpt, fieldOrDatumDef) : void 0) ? [{test:model, value:1}, {value:channel.legend.unselectedOpacity}] : void 0;
    const {format, formatType} = legend;
    legend = void 0;
    isCustomFormatType(formatType) ? legend = formatCustomType({fieldOrDatumDef, field:"datum.value", format, formatType, config:channel}) : format === void 0 && formatType === void 0 && channel.customFormatTypes && (fieldOrDatumDef.type === "quantitative" && channel.numberFormatType ? legend = formatCustomType({fieldOrDatumDef, field:"datum.value", format:channel.numberFormat, formatType:channel.numberFormatType, config:channel}) : fieldOrDatumDef.type === "temporal" && channel.timeFormatType && 
    isFieldDef(fieldOrDatumDef) && fieldOrDatumDef.timeUnit === void 0 && (legend = formatCustomType({fieldOrDatumDef, field:"datum.value", format:channel.timeFormat, formatType:channel.timeFormatType, config:channel})));
    specifiedlabelsSpec = {...(model ? {opacity:model} : {}), ...(legend ? {text:legend} : {}), ...specifiedlabelsSpec};
    return isEmpty(specifiedlabelsSpec) ? void 0 : specifiedlabelsSpec;
  }, entries:function(entriesSpec, {legendCmpt}) {
    return legendCmpt.get("selections")?.length ? {...entriesSpec, fill:{value:"transparent"}} : entriesSpec;
  }}, legendRules = {direction:({direction}) => direction, format:({fieldOrDatumDef, legend, config}) => {
    const {format, formatType} = legend;
    ...
    ({formatType:legend} = legend);
    return guideFormatType(legend, fieldOrDatumDef, scaleType);
    ...
    scaleType = (legend = legend.labelOverlap ?? legendConfig.labelOverlap) != null ? legend : contains(["quantile", "threshold", "log", "symlog"], scaleType) ? "greedy" : void 0;
    return scaleType;
  }, symbolType:({legend, markDef, channel, encoding}) => {
    if ((legend = legend.symbolType) != null) {
      channel = legend;
    } else {
      a: {
        legend = markDef.type;
        encoding = encoding.shape;
        markDef = markDef.shape;
        if (channel !== "shape" && (channel = getFirstConditionValue(encoding) ?? markDef)) {
          break a;
        }
        switch(legend) {
          case "bar":
    ...
    return channel;
  }, title:({fieldOrDatumDef, config}) => title(fieldOrDatumDef, config, {allowDisabling:!0}), type:({legendType, scaleType, channel}) => {
    ...
    return legendType;
  }, values:({fieldOrDatumDef, legend}) => {
    legend = legend.values;
    fieldOrDatumDef = (0,require$vega_util.isArray)(legend) ? valueArray(fieldOrDatumDef, legend) : isSignalRef(legend) ? legend : void 0;
    return fieldOrDatumDef;
  }};
  ...
  class AggregateNode extends DataFlowNode {
      ...
      model.forEachFieldDef((fieldDef, channel) => {
        ...
        if (aggregate) {
          ...
          if (isTypedFieldDef(fieldDef) && isUnitModel(model) && hasBandEnd(fieldDef, argField, model.markDef, model.config)) {
            ...
            (0,require$vega_util.hasOwnProperty)(GEO_POSIITON_CHANNEL_INDEX, channel) ? (channel = getPositionChannelFromLatLong(channel), dims.add(model.getName(channel))) : dims.add(vgField(fieldDef));
          }
          if (channel = isScaleFieldDef(fieldDef)) {
            channel = fieldDef.scale?.range, channel = (0,require$vega_util.isObject)(channel) && "field" in channel;
          }
    ...
    static makeFromTransform(parent, t) {
      ...
      for (const s of t.aggregate) {
        ...
        if (op) {
          if (op === "count") {
            let $jscomp$logical$assign$tmpm285488632$19;
            ($jscomp$logical$assign$tmpm285488632$19 = meas)["*"] ?? ($jscomp$logical$assign$tmpm285488632$19["*"] = {});
            meas["*"].count = new Set([as ? as : vgField(s, {forAs:!0})]);
          } else {
            let $jscomp$logical$assign$tmpm285488632$20, $jscomp$logical$assign$tmpindexm285488632$20;
            ($jscomp$logical$assign$tmpm285488632$20 = meas)[$jscomp$logical$assign$tmpindexm285488632$20 = field] ?? ($jscomp$logical$assign$tmpm285488632$20[$jscomp$logical$assign$tmpindexm285488632$20] = {});
            let $jscomp$logical$assign$tmpm285488632$21, $jscomp$logical$assign$tmpindexm285488632$21;
            ($jscomp$logical$assign$tmpm285488632$21 = meas[field])[$jscomp$logical$assign$tmpindexm285488632$21 = op] ?? ($jscomp$logical$assign$tmpm285488632$21[$jscomp$logical$assign$tmpindexm285488632$21] = new Set());
    ...
    merge(other) {
      ...
      current.debug("different dimensions, cannot merge");
      return !1;
    }
    ...
    constructor(parent, model, name, data) {
      ...
      for (const channel of FACET_CHANNELS) {
        if (parent = model.facet[channel]) {
          ...
          this[channel] = {name:model.getName(`${channel}_domain`), fields:[vgField(parent), ...(isBinning(bin) ? [vgField(parent, {binSuffix:"end"})] : [])], ...(isSortField(sort) ? {sortField:sort} : (0,require$vega_util.isArray)(sort) ? {sortIndexField:sortArrayIndexField(parent, channel)} : {})};
        }
      }
    ...
    assembleFacetHeaderData(childIndependentFieldsWithStep) {
      ...
      for (const headerChannel of HEADER_CHANNELS) {
        for (const headerType of HEADER_TYPES) {
          var headers = layoutHeaders[headerChannel]?.[headerType] ?? [];
  ...
  class ParseNode extends DataFlowNode {
    ...
    assembleTransforms(onlyNested = !1) {
  ...
  class StackNode extends DataFlowNode {
    ...
    static makeFromTransform(parent, stackTransform) {
      ...
      stackTransform = isValidAsArray(as) ? as : (0,require$vega_util.isString)(as) ? [as, `${as}_end`] : [`${stackTransform.stack}_start`, `${stackTransform.stack}_end`];
    ...
    static makeFromEncoding(parent, model) {
      ...
      if ((0,require$vega_util.isArray)(orderDef) || isFieldDef(orderDef)) {
  ...
  const PROJECTION_PROPERTIES = "type clipAngle clipExtent center rotate precision reflectX reflectY coefficient distance fraction lobes parallel radius ratio spacing tilt".split(" ");
    ...
    domainHasZero() {
      ...
      if (domains.length > 0) {
        ...
        for (const d of domains) {
          if ((0,require$vega_util.isArray)(d)) {
            domains = d[0];
            const last = d[d.length - 1];
            if ((0,require$vega_util.isNumber)(domains) && (0,require$vega_util.isNumber)(last)) {
  ...
  const RANGE_PROPERTIES = ["range", "scheme"], scaleRules = {bins:({model, fieldOrDatumDef}) => isFieldDef(fieldOrDatumDef) ? bins(model, fieldOrDatumDef) : void 0, interpolate:({channel, fieldOrDatumDef}) => {
    fieldOrDatumDef = fieldOrDatumDef.type;
    channel = contains(["color", "fill", "stroke"], channel) && fieldOrDatumDef !== "nominal" ? "hcl" : void 0;
    return channel;
  }, nice:({scaleType, channel, domain, domainMin, domainMax, fieldOrDatumDef}) => {
    scaleType = getFieldDef(fieldOrDatumDef)?.bin || (0,require$vega_util.isArray)(domain) || domainMax != null || domainMin != null || contains([ScaleType.TIME, ScaleType.UTC], scaleType) ? void 0 : isXorY(channel) ? !0 : void 0;
    return scaleType;
      ...
      if (isXorY(channel)) {
        if (CONTINUOUS_TO_CONTINUOUS_SCALES.has(scaleType)) {
          if (scaleConfig.continuousPadding !== void 0) {
            channel = scaleConfig.continuousPadding;
            break a;
          }
          ...
          if (type === "bar" && (!isFieldDef(fieldOrDatumDef) || !fieldOrDatumDef.bin && !fieldOrDatumDef.timeUnit) && (orient === "vertical" && channel === "x" || orient === "horizontal" && channel === "y")) {
            channel = config.continuousBandSize;
            break a;
          }
        }
        if (scaleType === ScaleType.POINT) {
          channel = scaleConfig.pointPadding;
          break a;
        }
      }
      channel = void 0;
    ...
    return channel;
  }, paddingInner:({scalePadding, channel, markDef, scaleType, config, hasNestedOffsetScale}) => paddingInner(scalePadding, channel, markDef.type, scaleType, config.scale, hasNestedOffsetScale), paddingOuter:({scalePadding, channel, scaleType, scalePaddingInner, config, hasNestedOffsetScale}) => paddingOuter(scalePadding, channel, scaleType, scalePaddingInner, config.scale, hasNestedOffsetScale), reverse:({fieldOrDatumDef, scaleType, channel, config}) => {
    fieldOrDatumDef = isFieldDef(fieldOrDatumDef) ? fieldOrDatumDef.sort : void 0;
    config = config.scale;
    scaleType = channel === "x" && config.xReverse !== void 0 ? hasContinuousDomain(scaleType) && fieldOrDatumDef === "descending" ? isSignalRef(config.xReverse) ? {signal:`!${config.xReverse.signal}`} : !config.xReverse : config.xReverse : hasContinuousDomain(scaleType) && fieldOrDatumDef === "descending" ? !0 : void 0;
    return scaleType;
  }, zero:({channel, fieldOrDatumDef, domain, markDef, scaleType, config, hasSecondaryRangeChannel}) => {
    a: {
      if (config = config.scale, domain && domain !== "unaggregated" && hasContinuousDomain(scaleType)) {
        if ((0,require$vega_util.isArray)(domain) && (channel = domain[0], domain = domain[domain.length - 1], (0,require$vega_util.isNumber)(channel) && channel <= 0 && (0,require$vega_util.isNumber)(domain) && domain >= 0)) {
          domain = !0;
          break a;
        }
        domain = !1;
        ...
        if (channel !== "size" || fieldOrDatumDef.type !== "quantitative" || CONTINUOUS_TO_DISCRETE_SCALES.has(scaleType)) {
          if (isFieldDef(fieldOrDatumDef) && fieldOrDatumDef.bin || !contains([...POSITION_SCALE_CHANNELS, ...POLAR_POSITION_SCALE_CHANNELS], channel)) {
            ...
            domain = contains(["bar", "area", "line", "trail"], type) && (orient === "horizontal" && channel === "y" || orient === "vertical" && channel === "x") ? !1 : contains(["bar", "area"], type) && !hasSecondaryRangeChannel ? !0 : config?.zero;
          }
        } else {
          domain = !0;
        }
  ...
  class Model {
    ...
    constructor(spec, type, parent, parentGivenName, config, resolve, view) {
      ...
      if (type === "layer" || type === "unit") {
        ...
        for (JSCompiler_temp of COMPOSITION_LAYOUT_PROPERTIES) {
          spec[JSCompiler_temp] !== void 0 && (JSCompiler_temp === "spacing" ? (type = spec[JSCompiler_temp], parentGivenName[JSCompiler_temp] = (0,require$vega_util.isNumber)(type) ? type : {row:type.row ?? spacingConfig, column:type.column ?? spacingConfig}) : parentGivenName[JSCompiler_temp] = spec[JSCompiler_temp]);
        }
                  ...
                  if (facetFieldDef || hasAxes) {
                    ...
                    if (JSCompiler_temp.facetFieldDef) {
                      JSCompiler_temp = {data:this.getName(`${channel$jscomp$0}_domain`)};
                      {
                        ...
                        var JSCompiler_inline_result$jscomp$0 = isSortField(sort) ? {field:vgField(sort, {expr:"datum"}), order:sort.order ?? "ascending"} : (0,require$vega_util.isArray)(sort) ? {field:sortArrayIndexField(JSCompiler_inline_result$jscomp$0, channel$jscomp$0, {expr:"datum"}), order:"ascending"} : {field:vgField(JSCompiler_inline_result$jscomp$0, {expr:"datum"}), order:sort ?? "ascending"};
                      }
    ...
    scaleName(originalScaleName, parse) {
      ...
      if ((0,require$vega_util.hasOwnProperty)(CHANNEL_INDEX, originalScaleName) && isScaleChannel(originalScaleName) && this.component.scales[originalScaleName] || this.scaleNameMap.has(this.getName(originalScaleName))) {
  ...
  class ModelWithField extends Model {
    vgField(channel, opt = {}) {
      if (channel = this.fieldDef(channel)) {
        return vgField(channel, opt);
      }
    }
  ...
  class GeoJSONNode extends DataFlowNode {
    ...
    dependentFields() {
      const fields = (this.fields ?? []).filter(require$vega_util.isString);
  ...
  class GeoPointNode extends DataFlowNode {
    ...
    dependentFields() {
      return new Set(this.fields.filter(require$vega_util.isString));
    }
    producedFields() {
  ...
  class LookupNode extends DataFlowNode {
    ...
    producedFields() {
      return new Set(this.transform.as ? (0,require$vega_util.array)(this.transform.as) : this.transform.from.fields);
    }
    hash() {
    ...
    assemble() {
      if (this.transform.from.fields) {
        var foreign = {values:this.transform.from.fields, ...(this.transform.as ? {as:(0,require$vega_util.array)(this.transform.as)} : {})};
      } else {
        foreign = this.transform.as, (0,require$vega_util.isString)(foreign) || (warn('If "from.fields" is not specified, "as" has to be a string that specifies the key to be used for the data from the secondary source.'), foreign = "_lookup"), foreign = {as:[foreign]};
      }
  ...
  class FacetModel extends ModelWithField {
    ...
    parseSelections() {
      ...
      vals(this.component.selection).some(selCmpt => isTimerSelection(selCmpt)) && current.error("Animation involving facet, layer, or concat is currently unsupported.");
    }
    parseMarkGroup() {
    ...
    parseAxesAndHeaders() {
      ...
      for (const channel of FACET_CHANNELS) {
        ...
        if (this.channelHasField(channel)) {
          ...
          child.component.layoutHeaders[channel].title && (titleConfig = (0,require$vega_util.isArray)(titleConfig) ? titleConfig.join(", ") : titleConfig, titleConfig += ` / ${child.component.layoutHeaders[channel].title}`, child.component.layoutHeaders[channel].title = null);
      ...
      for (const channel of FACET_CHANNELS) {
        for (const headerType of HEADER_TYPES) {
          ...
          if (facetFieldDef && (facetFieldDef = getHeaderProperty("titleOrient", facetFieldDef.header, this.config, channel), ["right", "bottom"].includes(facetFieldDef))) {
            ...
            let $jscomp$logical$assign$tmpm285488632$24;
            ($jscomp$logical$assign$tmpm285488632$24 = layoutMixins).titleAnchor ?? ($jscomp$logical$assign$tmpm285488632$24.titleAnchor = {});
          ...
          if (headerComponent?.[0]) {
            ...
            if (channel !== "facet" && !this.child.component.layoutSize.get(headerComponent)) {
              let $jscomp$logical$assign$tmpm285488632$25, $jscomp$logical$assign$tmpindexm285488632$25;
              ($jscomp$logical$assign$tmpm285488632$25 = layoutMixins)[$jscomp$logical$assign$tmpindexm285488632$25 = facetFieldDef] ?? ($jscomp$logical$assign$tmpm285488632$25[$jscomp$logical$assign$tmpindexm285488632$25] = {});
              layoutMixins[facetFieldDef][channel] = 0.5;
            }
            if (layoutHeaderComponent.title) {
              let $jscomp$logical$assign$tmpm285488632$26;
              ($jscomp$logical$assign$tmpm285488632$26 = layoutMixins).offset ?? ($jscomp$logical$assign$tmpm285488632$26.offset = {});
      ...
      for (var channel of FACET_CHANNELS) {
        ...
        if (fieldDef) {
          ...
          if (isSortField(sort)) {
            ...
            (0,require$vega_util.isArray)(sort) && (fieldDef = sortArrayIndexField(fieldDef, channel), fields.push(fieldDef), ops.push("max"), as.push(fieldDef));
          }
        }
      }
      channel = !!row && !!column;
    ...
    facetSortFields(channel) {
      var {facet} = this;
      return (facet = facet[channel]) ? isSortField(facet.sort) ? [facetSortFieldName(facet, facet.sort, {expr:"datum"})] : (0,require$vega_util.isArray)(facet.sort) ? [sortArrayIndexField(facet, channel, {expr:"datum"})] : [vgField(facet, {expr:"datum"})] : [];
    }
    facetSortOrder(channel) {
      const {facet} = this;
      return (channel = facet[channel]) ? ({sort:channel} = channel, [(isSortField(channel) ? channel.order : !(0,require$vega_util.isArray)(channel) && channel) || "ascending"]) : [];
    }
    assembleLabelTitle() {
  ...
  class AxisComponent extends Split {
    ...
    implicit;
    mainExtracted;
    constructor(explicit = {}, implicit = {}, mainExtracted = !1) {
      super();
      this.explicit = explicit;
      this.implicit = implicit;
  ...
  class UnitModel extends ModelWithField {
    ...
    constructor(spec, parent, parentGivenName, parentGivenSize = {}, config) {
      ...
      parent = isMarkDef(spec.mark) ? {...spec.mark} : {type:spec.mark};
      parentGivenName = parent.type;
      parent.filled === void 0 && (parent.filled = defaultFilled(parent, config, {graticule:spec.data && hasProperty(spec.data, "graticule")}));
      const encoding = this.encoding = initEncoding(spec.encoding || {}, parentGivenName, parent.filled, config);
      this.markDef = initMarkdef(parent, encoding, config);
      this.size = initLayoutSize({encoding, size:isFrameMixins(spec) ? {...parentGivenSize, ...(spec.width !== void 0 ? {width:spec.width} : {}), ...(spec.height !== void 0 ? {height:spec.height} : {})} : parentGivenSize});
      this.stack = stack(this.markDef, encoding);
      this.specifiedScales = this.initScales(parentGivenName, encoding);
    ...
    initScale(scale) {
      ...
      (0,require$vega_util.isArray)(domain) && (scale.domain = domain.map(signalRefOrValue));
      (0,require$vega_util.isArray)(range) && (scale.range = range.map(signalRefOrValue));
      return scale;
    }
    initAxes(encoding) {
    ...
    alignStackOrderWithColorDomain() {
      ...
      var colorField = fill || color, colorEncoding = isFieldDef(colorField) ? colorField : void 0;
      colorField = colorEncoding?.field;
      var colorEncodingType = colorEncoding?.type;
      const domain = colorEncoding?.scale?.domain;
      colorEncoding = xOffset || yOffset;
      const offsetEncoding = isFieldDef(colorEncoding) ? colorEncoding : void 0;
      colorEncoding = `_${colorField}_sort_index`;
      !order && Array.isArray(domain) && typeof colorField === "string" && colorEncodingType === "nominal" && (offsetEncoding && !offsetEncoding.sort ? offsetEncoding.sort = domain : this.stack && (colorField = `indexof(${(0,require$vega_util.stringValue)(domain)}, datum['${colorField}'])`, colorEncodingType = this.markDef?.orient === "horizontal" ? "ascending" : "descending", this.transforms.push({calculate:colorField, as:colorEncoding}), this.encoding.order = {field:colorEncoding, type:"quantitative", 
      sort:colorEncodingType}));
    }
    parseData() {
      this.component.data = parseData(this);
    }
      ...
      var JSCompiler_temp_const = this.component;
      {
        ...
        if (selDefs && selDefs.length) {
          ...
          for (const def of selDefs) {
            ...
            var selDef = def.select, type = (0,require$vega_util.isString)(selDef) ? selDef : selDef.type;
            selDef = (0,require$vega_util.isObject)(selDef) ? duplicate(selDef) : {type};
            ...
            type = selCmpts[selDefs] = {...selDef, name:selDefs, type, init:def.value, bind:def.bind, events:(0,require$vega_util.isString)(selDef.on) ? (0,require$vega_event_selector.parseSelector)(selDef.on, "scope") : (0,require$vega_util.array)(duplicate(selDef.on))};
    ...
    assembleSignals() {
      ...
      for (const selCmpt of vals(this.component.selection ?? {})) {
        ...
        JSCompiler_inline_result.push({name:name + "_modify", on:[{events:{signal:selCmpt.name + "_tuple"}, update:`modify(${(0,require$vega_util.stringValue)(selCmpt.name + "_store")}, ${modifyExpr})`}]});
      }
  ...
  class LayerModel extends Model {
    ...
    assembleGroupStyle() {
      ...
      for (const child of this.children) {
        for (const style of (0,require$vega_util.array)(child.assembleGroupStyle())) {
...
//# sourceMappingURL=module$node_modules$vega_lite$build$index.js.map
