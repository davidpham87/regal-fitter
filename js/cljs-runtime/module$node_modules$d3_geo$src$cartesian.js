shadow$provide.module$node_modules$d3_geo$src$cartesian = function(require, module, exports) {
  ...
  function cartesian(spherical) {
    ...
    var cosPhi = (0,require$_DOT__SLASH_math_DOT_js.cos)(spherical);
  ...
  function cartesianNormalizeInPlace(d) {
    var l = (0,require$_DOT__SLASH_math_DOT_js.sqrt)(d[0] * d[0] + d[1] * d[1] + d[2] * d[2]);
    d[0] /= l;
    d[1] /= l;
    d[2] /= l;
  }
...
//# sourceMappingURL=module$node_modules$d3_geo$src$cartesian.js.map
