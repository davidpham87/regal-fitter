...
return cljs.core.boolean$((function (){var or__5162__auto__ = cljs.core.some(cljs.core.some_fn.cljs$core$IFn$_invoke$arity$3(cljs.core.nil_QMARK_,meta_merge.core.displace_QMARK_,meta_merge.core.replace_QMARK_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [left,right], null));
...
if(cljs.core.truth_((function (){var and__5160__auto__ = meta_merge.core.displace_QMARK_(left);
...
if(cljs.core.truth_((function (){var and__5160__auto__ = meta_merge.core.replace_QMARK_(left);
if(cljs.core.truth_(and__5160__auto__)){
...
if(cljs.core.truth_((function (){var or__5162__auto__ = meta_merge.core.displace_QMARK_(left);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return meta_merge.core.replace_QMARK_(right);
...
if(cljs.core.truth_((function (){var or__5162__auto__ = meta_merge.core.replace_QMARK_(left);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return meta_merge.core.displace_QMARK_(right);
...
var len__5897__auto___26809 = arguments.length;
var i__5898__auto___26810 = (0);
while(true){
if((i__5898__auto___26810 < len__5897__auto___26809)){
args_arr__5922__auto__.push((arguments[i__5898__auto___26810]));

var G__26811 = (i__5898__auto___26810 + (1));
i__5898__auto___26810 = G__26811;
continue;
} else {
}
break;
...
return meta_merge.core.meta_merge.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5923__auto__);
...
if(cljs.core.truth_((function (){var or__5162__auto__ = new cljs.core.Keyword(null,"prepend","prepend",342616040).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(left));
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
...
/** @this {Function} */
(meta_merge.core.meta_merge.cljs$lang$applyTo = (function (seq26716){
var G__26737 = cljs.core.first(seq26716);
var seq26716__$1 = cljs.core.next(seq26716);
var G__26738 = cljs.core.first(seq26716__$1);
var seq26716__$2 = cljs.core.next(seq26716__$1);
var self__5882__auto__ = this;
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26737,G__26738,seq26716__$2);
}));
