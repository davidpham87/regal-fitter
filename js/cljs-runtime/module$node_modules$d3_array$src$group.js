shadow$provide.module$node_modules$d3_array$src$group = function(require, module, exports) {
  ...
  module = require("module$node_modules$d3_array$src$identity");
  var default$$require$_DOT__SLASH_identity_DOT_js = require.esmDefault(module);
};
