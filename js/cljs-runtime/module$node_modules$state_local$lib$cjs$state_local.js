shadow$provide.module$node_modules$state_local$lib$cjs$state_local = function(require, module, exports) {
  ...
  function _objectSpread2(target) {
    for (var i = 1; i < arguments.length; i++) {
      ...
      i % 2 ? ownKeys(Object(source), !0).forEach(function(key) {
        ...
        key in target ? Object.defineProperty(target, key, {value, enumerable:!0, configurable:!0, writable:!0}) : target[key] = value;
  ...
  function curry(fn) {
    return function curried() {
      for (var _this = this, _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
  ...
  validators = {changes:function(initial, changes) {
    isObject(changes) || errorHandler("changeType");
    Object.keys(changes).some(function(field) {
      return !Object.prototype.hasOwnProperty.call(initial, field);
    ...
    Object.keys(initial).length || errorHandler("initialContent");
  }};
  module.exports = {create:function(initial) {
    var handler = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    validators.initial(initial);
    validators.handler(handler);
    var state = {current:initial}, didUpdate = curry(didStateUpdate)(state, handler), update = curry(updateState)(state), validate = curry(validators.changes)(initial), getChanges = curry(extractChanges)(state);
    return [function() {
