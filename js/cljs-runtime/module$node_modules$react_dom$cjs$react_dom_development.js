      ...
      batchedUpdates(function() {
        ...
        if ((eventSystemFlags & 7) === 0) {
          ...
          a: {
            ...
            if (SyntheticEventCtor = SyntheticEventCtor === "select" || SyntheticEventCtor === "input" && reactName.type === "file") {
              ...
              (SyntheticEventCtor = (SyntheticEventCtor = reactName.nodeName) && SyntheticEventCtor.toLowerCase() === "input" && (reactName.type === "checkbox" || reactName.type === "radio")) && (getTargetInstFunc = getTargetInstForClickEvent);
            }
          ...
          canUseCompositionEvent ? eventType = getCompositionEventType(domEventName) : isComposing ? isFallbackCompositionEnd(domEventName, nativeEvent) && (eventType = "onCompositionEnd") : isFallbackCompositionStart(domEventName, nativeEvent) && (eventType = "onCompositionStart");
          eventType && (useFallbackCompositionData && !isUsingKoreanIME(nativeEvent) && (isComposing || eventType !== "onCompositionStart" ? eventType === "onCompositionEnd" && isComposing && (fallbackData = getData()) : isComposing = initialize(nativeEventTarget)), handleEventFunc = accumulateTwoPhaseListeners(targetInst, eventType), handleEventFunc.length > 0 && (eventType = new SyntheticCompositionEvent(eventType, domEventName, null, nativeEvent, nativeEventTarget), dispatchQueue.push({event:eventType, 
