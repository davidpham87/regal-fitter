shadow$provide.module$node_modules$d3_geo$src$math = function(require, module, exports) {
  function acos(x) {
  ...
  var epsilon = 1e-6, epsilon2 = 1e-12, pi = Math.PI, halfPi = pi / 2, quarterPi = pi / 4, tau = pi * 2, degrees = 180 / pi, radians = pi / 180, abs = Math.abs, atan = Math.atan, atan2 = Math.atan2, cos = Math.cos, ceil = Math.ceil, exp = Math.exp, floor = Math.floor, hypot = Math.hypot, log = Math.log, pow = Math.pow, sin = Math.sin, sign = Math.sign || function(x) {
    return x > 0 ? 1 : x < 0 ? -1 : 0;
  }, sqrt = Math.sqrt, tan = Math.tan;
};

//# sourceMappingURL=module$node_modules$d3_geo$src$math.js.map
