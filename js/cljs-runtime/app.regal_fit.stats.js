...
var is_experimental_seq = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35293_SHARP_){
if((p1__35293_SHARP_ === (1))){
return 1.0;
} else {
return 0.0;
}
...
var prev = (function (){var or__5162__auto__ = cljs.core.last(accumulator);
 ...
 */
app.regal_fit.stats.update_logrank_stats = (function app$regal_fit$stats$update_logrank_stats(p__35297,index_list,n_exp_arr,n_control_arr,is_exp_arr){
var map__35298 = p__35297;
var map__35298__$1 = cljs.core.__destructure_map(map__35298);
var u = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35298__$1,new cljs.core.Keyword(null,"u","u",-1156634785));
var v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35298__$1,new cljs.core.Keyword(null,"v","v",21465059));
var log_hr_num = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35298__$1,new cljs.core.Keyword(null,"log-hr-num","log-hr-num",-863400848));
var log_hr_den = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35298__$1,new cljs.core.Keyword(null,"log-hr-den","log-hr-den",-376003383));
...
var events_exp = cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35294_SHARP_){
return (is_exp_arr[p1__35294_SHARP_]);
}),index_list));
...
var vec__35303 = app.regal_fit.stats.compute_risk_sets(groups_arr);
var n_exp_arr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35303,(0),null);
var n_control_arr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35303,(1),null);
var is_exp_arr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35303,(2),null);
...
var grouped_indices = cljs.core.partition_by.cljs$core$IFn$_invoke$arity$2((function (p1__35300_SHARP_){
return (times_arr[p1__35300_SHARP_]);
}),event_indices);
...
var results = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__35301_SHARP_,p2__35302_SHARP_){
return app.regal_fit.stats.update_logrank_stats(p1__35301_SHARP_,p2__35302_SHARP_,n_exp_arr,n_control_arr,is_exp_arr);
...
var relevant_events = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__35309){
var vec__35310 = p__35309;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35310,(0),null);
var ev = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35310,(1),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35310,(2),null);
var and__5160__auto__ = ev;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (multiplier,p__35317){
var vec__35318 = p__35317;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35318,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35318,(1),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35318,(2),null);
