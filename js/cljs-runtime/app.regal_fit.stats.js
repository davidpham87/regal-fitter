...
var is_experimental_seq = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28975_SHARP_){
if((p1__28975_SHARP_ === (1))){
return 1.0;
} else {
return 0.0;
}
 ...
 */
app.regal_fit.stats.update_logrank_stats = (function app$regal_fit$stats$update_logrank_stats(p__28980,index_list,n_exp_arr,n_control_arr,is_exp_arr){
var map__28981 = p__28980;
var map__28981__$1 = cljs.core.__destructure_map(map__28981);
var u = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28981__$1,new cljs.core.Keyword(null,"u","u",-1156634785));
var v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28981__$1,new cljs.core.Keyword(null,"v","v",21465059));
var log_hr_num = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28981__$1,new cljs.core.Keyword(null,"log-hr-num","log-hr-num",-863400848));
var log_hr_den = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28981__$1,new cljs.core.Keyword(null,"log-hr-den","log-hr-den",-376003383));
...
var events_exp = cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28979_SHARP_){
return (is_exp_arr[p1__28979_SHARP_]);
}),index_list));
...
var vec__28988 = app.regal_fit.stats.compute_risk_sets(groups_arr);
var n_exp_arr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28988,(0),null);
var n_control_arr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28988,(1),null);
var is_exp_arr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28988,(2),null);
...
var grouped_indices = cljs.core.partition_by.cljs$core$IFn$_invoke$arity$2((function (p1__28985_SHARP_){
return (times_arr[p1__28985_SHARP_]);
}),event_indices);
...
var results = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28986_SHARP_,p2__28987_SHARP_){
return app.regal_fit.stats.update_logrank_stats(p1__28986_SHARP_,p2__28987_SHARP_,n_exp_arr,n_control_arr,is_exp_arr);
...
var relevant_events = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__28995){
var vec__28996 = p__28995;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28996,(0),null);
var ev = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28996,(1),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28996,(2),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (multiplier,p__28999){
var vec__29000 = p__28999;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29000,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29000,(1),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29000,(2),null);
