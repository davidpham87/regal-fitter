...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,(function (p1__28586_SHARP_){
return reitit.frontend.query_param(q,p1__28586_SHARP_);
})),q.getKeys()));
});
/**
...
var new_query = ((cljs.core.fn_QMARK_(new_query_or_update_fn))?(function (){var G__28592 = reitit.frontend.query_params(uri);
return (new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1 ? new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1(G__28592) : new_query_or_update_fn.call(null,G__28592));
...
var temp__5825__auto__ = reitit.coercion.match__GT_path.cljs$core$IFn$_invoke$arity$2(match,query_params);
if(cljs.core.truth_(temp__5825__auto__)){
var path = temp__5825__auto__;
var G__28598 = path;
if(cljs.core.truth_((function (){var and__5160__auto__ = fragment;
...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28598)+"#"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(reitit.impl.form_encode(fragment)));
} else {
return G__28598;
}
} else {
...
(reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$3 = (function (router,path,p__28601){
var map__28602 = p__28601;
var map__28602__$1 = cljs.core.__destructure_map(map__28602);
var on_coercion_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28602__$1,new cljs.core.Keyword(null,"on-coercion-error","on-coercion-error",-970787));
var uri = goog.Uri.parse(path);
...
var parameters = (function (){var or__5162__auto__ = (coerce_BANG_.cljs$core$IFn$_invoke$arity$1 ? coerce_BANG_.cljs$core$IFn$_invoke$arity$1(match__$1) : coerce_BANG_.call(null,match__$1));
...
if(cljs.core.every_QMARK_((function (p1__28609_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__28609_SHARP_);
