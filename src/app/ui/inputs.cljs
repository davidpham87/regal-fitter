...
(def key->label
  {:n-total "Total Size (N)"
   ...
   :bat-med "BAT effective mOS"
   :unc-med "GPS Uncured Median (months)"
   :unc-shape "GPS Uncured Shape"
   :unc-scale "GPS Uncured Scale"
   :gps-med "GPS mOS (months)"
   :gps-shape "GPS Shape"
   :cure-frac "Cure Fraction"
   :leak-yr "GPS Leak Rate (yearly)"
   :p-success-overall "Overall Success Probability"
   :acceptance-rate "Acceptance Rate"
   :onset-cr2-bat-mos "Onset CR2 BAT mOS"
   :p-hr-below-threshold "P(HR < threshold)"
   :n-accepted "Accepted Combos (N)"
   :exp-ev-ia "Expected Events at IA"
   :mean-med-interim-analysis-bat "Mean BAT mOS at IA"
   :mean-n-interim-analysis-gps "Mean GPS Events at IA"
   :hr-final-low "Final HR Low CI"
   :p-no-readout "P(No Readout)"
   :mean-n-press-release-3-bat "Mean BAT Events at PR3"
   :mean-med-interim-analysis-gps "Mean GPS mOS at IA"
   :median-hr-ia "Median HR at IA"
   :mean-med-interim-analysis-pool "Mean Pooled mOS at IA"
   :mean-med-press-release-3-pool "Mean Pooled mOS at PR3"
   :mean-med-press-release-3-gps "Mean GPS mOS at PR3"
   :mean-med-update-gps "Mean GPS mOS at UPD"
   :n-pass-futility "Futility Passes"
   :hr-final-high "Final HR High CI"
   :mean-n-update-gps "Mean GPS Events at UPD"
   :mean-med-update-pool "Mean Pooled mOS at UPD"
   :median-z-ia "Median Z-score at IA"
   :mean-med-press-release-3-bat "Mean BAT mOS at PR3"
   :mean-n-update-bat "Mean BAT Events at UPD"
   :mean-med-update-bat "Mean BAT mOS at UPD"
   :n-pass-events "Event Passes"
   :median-t80-months "Median T80 (months)"
   :exp-ev-pr3 "Expected Events at PR3"
   :median-hr-final "Median Final HR"
   :mean-n-interim-analysis-bat "Mean BAT Events at IA"
   :exp-ev-upd "Expected Events at UPD"
   :p-reach80 "P(Reach 80)"
   :mean-n-press-release-3-gps "Mean GPS Events at PR3"
   :n-attempts "Attempts (N)"})
