          ...
          [:div.border.p-4.rounded-xl.bg-white.shadow-sm.h-full
           ...
           [:div.grid.grid-cols-1.gap-3.mt-2
            [inputs/field-wrapper :n-total
             [inputs/num-input props :n-total inputs/parse-int]]
            [inputs/field-wrapper :n-per-arm
             [inputs/num-input props :n-per-arm inputs/parse-int]]
            [inputs/field-wrapper :enroll-bands
             [inputs/vector-input props :enroll-bands]]
            [inputs/field-wrapper :enforce-no-80-by-today
             [inputs/checkbox-input props :enforce-no-80-by-today]]
            [inputs/field-wrapper :no-80-slack-months
             [inputs/num-input props :no-80-slack-months
              inputs/parse-double-safe]]]]
          [:div.border.p-4.rounded-xl.bg-white.shadow-sm.h-full
           [:h3.font-bold.text-lg.text-gray-800 "Event Timing"]
           [:div.grid.grid-cols-1.gap-3.mt-2
            [inputs/field-wrapper :t-ia
             [inputs/num-input props :t-ia inputs/parse-double-safe]]
            [inputs/field-wrapper :tol-ia
             [inputs/num-input props :tol-ia inputs/parse-double-safe]]
            [inputs/field-wrapper :t-upd
             [inputs/num-input props :t-upd inputs/parse-double-safe]]
            [inputs/field-wrapper :tol-upd
             [inputs/num-input props :tol-upd inputs/parse-double-safe]]
            [inputs/field-wrapper :t-pr3
             [inputs/num-input props :t-pr3 inputs/parse-double-safe]]
            [inputs/field-wrapper :tol-pr3
             [inputs/num-input props :tol-pr3 inputs/parse-double-safe]]
            [inputs/field-wrapper :use-pr3-anchor
             [inputs/checkbox-input props :use-pr3-anchor]]]]])])))
          ...
          [:div.border.p-4.rounded-xl.bg-white.shadow-sm.h-full
           ...
           [:div.grid.grid-cols-1.gap-3.mt-2
            [inputs/field-wrapper :bat-med-grid
             [inputs/grid-input props :bat-med-grid]]
            [inputs/field-wrapper :bat-shape-grid
             [inputs/grid-input props :bat-shape-grid]]
          ...
          [:div.border.p-4.rounded-xl.bg-white.shadow-sm.h-full
           ...
           [:div.grid.grid-cols-1.md:grid-cols-2.gap-4.mt-2
            [inputs/field-wrapper :n-sims-screen
             [inputs/num-input props :n-sims-screen inputs/parse-int]]
            [inputs/field-wrapper :n-sims-per-combo
             [inputs/num-input props :n-sims-per-combo inputs/parse-int]]
            [inputs/field-wrapper :n-ev-ia
             [inputs/num-input props :n-ev-ia inputs/parse-int]]
            [inputs/field-wrapper :n-ev-upd
             [inputs/num-input props :n-ev-upd inputs/parse-int]]
            [inputs/field-wrapper :n-ev-pr3
             [inputs/num-input props :n-ev-pr3 inputs/parse-int]]
            [inputs/field-wrapper :n-ev-final
             [inputs/num-input props :n-ev-final inputs/parse-int]]
            [inputs/field-wrapper :n-screen-min-pass
             [inputs/num-input props :n-screen-min-pass inputs/parse-int]]
            ...
            [inputs/field-wrapper :seed
             [inputs/num-input props :seed inputs/parse-int]]
            [inputs/field-wrapper :families
             [inputs/families-input props :families]]]]])])))
